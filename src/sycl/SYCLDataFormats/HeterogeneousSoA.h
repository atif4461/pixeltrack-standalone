 ...
 * to a Structure of Arrays (SoA) object, allowing for seamless switching between
 * device, host, and standard pointer management.
 *
 * @tparam T The type of the SoA object being managed
