...
template <typename T>
/**
 * @brief Class representing a heterogeneous Structure of Arrays (SoA)
 * 
 * This class provides a unified interface for managing different types of pointers 
 * to structures of arrays, allowing for seamless switching between device, host, 
 * and standard pointer management.
 * 
 * It includes functionality for constructing and destructing objects, moving and 
 * assigning them, as well as accessing the managed array through various operators.
