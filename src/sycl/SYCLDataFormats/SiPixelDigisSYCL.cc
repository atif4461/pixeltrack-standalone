 ...
 * for pixel digi data structures and copying host view to device memory
 ...
 * @param stream SYCL queue object used for asynchronous operation
 * @return Unique pointer to host memory containing pixel digi data
...
// The following comment is generated by an LLM. 
/**
 * @brief Copies raw ID array from device memory to host memory asynchronously
 * @param stream SYCL queue object used for asynchronous data transfer
 * @return Unique pointer to host memory containing copied raw ID array
