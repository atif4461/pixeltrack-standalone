...
/**
 * Class representing a Structure of Arrays view for tracking rec hits in 2D.
 * Provides access to various hit properties such as local and global coordinates,
 * errors, charges, cluster sizes, and detector indices.
 * Also provides access to supporting objects like average geometry and CPE parameters.
