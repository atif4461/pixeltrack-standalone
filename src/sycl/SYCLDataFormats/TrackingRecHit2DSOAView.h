...
/**
 * @brief Structure of Array view for tracking rec hits in 2D.
 *
 * This class provides a structure of array view for tracking rec hits in 2D,
 * including local and global coordinates, cluster properties, and supporting objects.
 *
 * It allows for efficient access and manipulation of hit data.
