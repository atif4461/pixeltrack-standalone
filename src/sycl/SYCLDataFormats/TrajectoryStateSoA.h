 ...
 * Parameters:
 * cp V3 const reference to center point
 * ccov M3 const reference to circle covariance
 * lp V2 const reference to line point
 * lcov M2 const reference to line covariance
