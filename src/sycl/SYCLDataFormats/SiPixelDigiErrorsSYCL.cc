...
/**
 * Constructor initializing member variables with provided parameters
 ...
 * @return HostDataError object containing copied pixel errors and unique pointer to host data buffer.
