...
/**
 * @class TrackingRecHit2DSYCL
 * @brief Class representing a 2D tracking rec hit on SYCL
 * @details This class initializes and manages the data structures for 2D tracking rec hits on SYCL devices
