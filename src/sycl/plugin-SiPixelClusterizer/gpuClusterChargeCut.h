...
/**
 * Brief description of the function clusterChargeCut
 *
 * This function performs cluster charge cutting on a set of pixels within a module.
 * It takes into account the module id, ADC values, module start indices, 
 * number of clusters per module, and cluster ids as input parameters.
 * The function modifies the input arrays to reflect the results of the charge cutting process.
 *
 ...
 * @param item SYCL item object representing the current work group
