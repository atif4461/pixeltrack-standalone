 ...
 *
 * @param fedId Federal ID to consider during error checking.
 * @param status Status code indicating the type of error encountered.
 ...
 *
 * @return An unsigned 8-bit integer representing the result of the check.
 */ 
  uint8_t checkROC(
 ...
 *
 * @param[in] fedId The FED ID.
 * @param[in] errWord The error word.
 * @param[in] errorType The type of error.
 * @param[in] cablingMap A pointer to the SiPixelFedCablingMapGPU object.
 * @param[in] debug Flag indicating whether to enable debugging output.
 *
