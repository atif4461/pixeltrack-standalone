 ...
 * @param[in] fedId        The FED ID to be used for initialization
 ...
 * @return DetIdGPU object containing raw id, roc in detector and module id
 ...
 * @param cablingMap The mapping of the SiPixelFedCablingMapGPU
 * @param debug Optional flag to enable debugging printouts
 * @return Error type as a byte value
 */  uint8_t checkROC(
 ...
 * @param[in] cablingMap A pointer to the SiPixelFedCablingMapGPU object providing cabling information.
 * @param[in] debug Optional flag indicating whether to enable debugging output.
 *
 * @return The raw ID of the error as a uint32_t value.
