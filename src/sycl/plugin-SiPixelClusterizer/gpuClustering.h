...
/**
 * Counts modules in a given array of IDs and updates module start indices accordingly.
 *
 * @param id input array of module IDs
 * @param moduleStart output array of module start indices
 * @param clusterId output array of cluster IDs
 * @param numElements number of elements in the input arrays
...
```cpp * @brief Function to find clusters of pixels in a module on the GPU.
 *
 * This function takes in various arrays of pixel data and module information,
 * and outputs the number of clusters found in each module and the cluster ID of each pixel.
 *
 * It uses parallel processing on the GPU to efficiently process large amounts of data.
 *
 * @param id Module ID of each pixel
 * @param x Local coordinates of each pixel
 * @param y Local coordinates of each pixel
 * @param moduleStart Index of the first pixel of each module
 * @param nClustersInModule Output: number of clusters found in each module
 * @param moduleId Output: module ID of each module
 * @param clusterId Output: cluster ID of each pixel
 * @param numElements Total number of elements to process
 * @param item SYCL item object for parallel processing
...
/**
 * @brief Function to find clusters of pixels in a module on the CPU.
 *
 * This function takes in input the module id, local coordinates, and start indices of each module,
 * and outputs the number of clusters found in each module, module ids, and cluster ids of each pixel.
 *
 * It uses a histogram-based approach to identify clusters and assigns a unique id to each cluster.
 *
 * @param id Module id of each pixel
 * @param x Local x-coordinates of each pixel
 * @param y Local y-coordinates of each pixel
 * @param moduleStart Index of the first pixel of each module
 * @param nClustersInModule Output: number of clusters found in each module
 * @param moduleId Output: module id of each module
 * @param clusterId Output: cluster id of each pixel
