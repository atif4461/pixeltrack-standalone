...
/**
 * Brief description: Function to transform global tensor to local coordinates
 *
 * Detailed description: This function transforms a global tensor into local coordinates
 *                     using rotation matrix. It takes a global tensor ge and returns 
 *                     the corresponding local tensor components lxx, lxy, lyy.
 *
 * Parameters:
