...
/**
 * @brief Sets the trailer data in the FED format
 * @param trailer Pointer to the trailer data buffer
 * @param lenght Length of the event data
 * @param crc CRC value of the event data
 * @param evtStatus Status of the event
 * @param ttsBits Time tag status bits
 * @param moreTrailers Flag indicating presence of additional trailers
 */
