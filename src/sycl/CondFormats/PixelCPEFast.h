...
/**
 * @brief Class representing the PixelCPEFast functionality
 *
 * This class provides methods for managing PixelCPEFast operations,
 * including initialization, data retrieval, and memory management.
 *
 * @author [Your Name]
