...
/**
 * Returns a pointer to the ParamsOnGPU object on the GPU for the current device.
 *
 * This function is asynchronous and uses a lambda function to perform the necessary
 * memory copies from the host to the device.
 *
 * @param stream The SYCL queue object representing the device to access.
 *
 * @return A pointer to the ParamsOnGPU object on the GPU.
 */ 
