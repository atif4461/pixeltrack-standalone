...
/**
 * Returns a pair containing the pedestal and gain values for a given module index, column, and row.
 *
 ...
 * @param isDeadColumn Output flag indicating whether the column is dead
 * @param isNoisyColumn Output flag indicating whether the column is noisy
