 ...
 *
 * @param r1 first point's radial coordinate
 * @param z1 first point's longitudinal coordinate
 * @param ri second point's radial coordinate
 * @param zi second point's longitudinal coordinate
 * @param ro origin's radial coordinate
 * @param zo origin's longitudinal coordinate
 * @param ptmin minimum transverse momentum
 * @param thetaCut maximum allowed angle difference
 ...
 * Class representing a quality value array.
 
class Quality {
};
 * Class representing a temporary tuple for n-tuplet construction.
