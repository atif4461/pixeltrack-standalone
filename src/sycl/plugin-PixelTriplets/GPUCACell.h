 ...
 * @param otherCell Cell to compare against
...
/**
 * Checks if two points are aligned within a certain tolerance.
 *
 * @param r1 first point radial coordinate
 * @param z1 first point longitudinal coordinate
 * @param ri second point radial coordinate
 * @param zi second point longitudinal coordinate
 * @param ro origin radial coordinate
 * @param zo origin longitudinal coordinate
 * @param ptmin minimum transverse momentum
 * @param thetaCut maximum allowed angle
...
/**
 * Checks if there is a hole between two modules in the detector geometry.
 *
...
*/ 
  ...
  template <int DEPTH>
/**
 * Class representing a recursive function to find n-tuplets in a cellular structure.
 
class FindNTuplets {
     * Finds n-tuplets in a given set of hits and cells.
   *
   * @param hh Input hits.
 ...
 * Class representing a GPUCACell object wrapper.
 
class GPUCACellWrapper {
};
 ...
 * Class representing a temporary tuple storage for n-tuplet construction.
...
template <>
/**
 * @brief Finds n-tuplets within a GPUCACell
 * 
