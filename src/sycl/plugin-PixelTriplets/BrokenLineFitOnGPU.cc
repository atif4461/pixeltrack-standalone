 ...
 *
 * This function launches a series of kernels to perform broken line fitting on the GPU.
 * It takes in several parameters including the HitsView object, number of hits in the fit,
 * maximum number of tuples, and the SYCL queue to launch the kernels on.
 *
