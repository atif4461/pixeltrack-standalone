...
/**
 * Initializes the outer hit of cells data structure for the GPU-based cellular automaton algorithm.
 *
 ...
 * @param[in] cellTracks vector of tracks in cells
 * @param[in] hhp pointer to tracking rec hit 2D SOA view
 * @param[in] isOuterHitOfCell outer hit of cell flag
 * @param[in] nActualPairs actual number of pairs
 * @param[in] ideal_cond ideal condition flag
 * @param[in] doClusterCut cluster cut flag
 * @param[in] doZ0Cut z0 cut flag
 * @param[in] doPtCut pt cut flag
