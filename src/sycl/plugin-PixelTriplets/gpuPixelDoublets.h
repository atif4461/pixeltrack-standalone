...
/**
 * Initializes the outer hit of cells data structure for GPU-based cellular automaton tracking algorithm
 ...
 * @param[in] doClusterCut flag indicating whether to apply cluster cut
 * @param[in] doZ0Cut flag indicating whether to apply z0 cut
 * @param[in] doPtCut flag indicating whether to apply pt cut
