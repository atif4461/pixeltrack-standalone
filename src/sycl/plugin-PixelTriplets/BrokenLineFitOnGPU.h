 ...
 * It iterates over the local range of the work group and processes the hits within that range.
 *
 * @param foundNtuplets Pointer to the tuple container.
 * @param tupleMultiplicity Pointer to the tuple multiplicity array.
 * @param hhp Pointer to the hits on GPU object.
 * @param phits Pointer to the hits array.
 * @param phits_ge Pointer to the geometric error array.
 * @param pfast_fit Pointer to the fast fit array.
 ...
 * and returns the results in the output SoA structure
 *
 * @param tupleMultiplicity Tuple multiplicity array
 * @param B Magnetic field strength
 * @param results Output SoA structure for storing the fit results
 ...
 * @param nHits Number of hits
 * @param offset Offset for the tuple indices
