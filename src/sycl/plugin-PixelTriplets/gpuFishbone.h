...
/**
 * @brief Function to perform hit processing on GPU
 * 
 * This function processes hits from the GPUCACell and applies various checks 
 * such as checking for doublets and killing farthest hits.
 * 
 * @param hhp pointer to the GPUCACell Hits object
 * @param cells array of GPUCACell objects
 * @param nCells array of number of cells
 * @param isOuterHitOfCell array indicating outer hit status of cells
 * @param nHits total number of hits
 * @param checkTrack flag to enable track checking
 * @param item sycl item object for parallelization
