 ...
 * @param prefix optional string to be prefixed to each output line
...
/**
 * Brief description: Loads covariance into a 2D matrix format
 * Detailed description: This function takes a 6xN float matrix and an NxN diagonal matrix
 *                 as input and loads the covariance from the first matrix into the second
 * Parameters:
 ...
 *
 * Detailed description: This function takes an input matrix ge and loads its elements into the output matrix hits_cov.
 * The loading process involves mapping the indices of ge to the corresponding positions in hits_cov.
 *
 * Parameters:
 *   ge - Input matrix containing covariance elements.
 *   hits_cov - Output matrix where the loaded covariance elements will be stored.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * TransformToPerigeePlane function transforms input parameters to perigee plane
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
