 ...
 * performs calculations to find valid doublets and stores them in the cells array.
 *
 * @param layerPairs Array of layer pairs.
 * @param nPairs Number of layer pairs.
 * @param cells Array to store generated doublets.
 * @param nCells Pointer to store the total number of doublets.
 * @param cellNeighbors Neighbor information for cells.
 * @param cellTracks Track information for cells.
 * @param hh Tracking rec hit 2D SOA view.
 * @param isOuterHitOfCell Information about outer hits for each cell.
 ...
 * @param maxr Maximum radius values for each layer pair.
 * @param idealCond Flag indicating ideal conditions.
 * @param doClusterCut Flag to apply cluster cut.
 * @param doZ0Cut Flag to apply z0 cut.
 * @param doPtCut Flag to apply pt cut.
