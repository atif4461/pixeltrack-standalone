...
/**
 * Outputs the contents of the object to a stream for debugging purposes.
 *
...
/**
 * Outputs the contents of a SimpleAtomicHisto object to an output stream
 *
 * @param os Output stream to write to
 * @param h SimpleAtomicHisto object being written
