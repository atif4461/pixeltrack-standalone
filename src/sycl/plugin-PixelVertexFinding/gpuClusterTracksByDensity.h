 ...
 *
 * @param[in] pdata     pointer to vertex data
 * @param[in,out] pws    pointer to workspace
 * @param[in] minT      minimum number of neighbors to be seed
 * @param[in] eps      maximum absolute distance to cluster
 * @param[in] errmax   maximum error to be seed
 * @param[in] chi2max  maximum normalized distance to cluster
 * @param[in] item     SYCL item
