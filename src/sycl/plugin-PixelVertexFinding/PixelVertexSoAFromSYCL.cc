...
/**
 * Acquires event data from SYCL and transfers it to host memory asynchronously.
 * @param[in] iEvent reference to the event object containing input data
 * @param[in] iSetup reference to the event setup object
...
// The following comment is generated by an LLM. 
/**
 * Produces a heterogeneous vertex from an SoA object and stores it in the event
 */ 
