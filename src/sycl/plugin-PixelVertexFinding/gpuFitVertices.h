...
/**
 * @brief Fits vertices using the provided data and workspace.
 * 
 * This function takes in ZVertices and WorkSpace pointers, along with a maximum chi-squared value for outlier rejection,
 * and a SYCL item object. It performs various operations such as zeroing arrays, computing cluster locations,
 * and calculating chi-squared values.
 * 
 * @param pdata Pointer to ZVertices data
 * @param pws Pointer to WorkSpace data
 * @param chi2Max Maximum chi-squared value for outlier rejection
