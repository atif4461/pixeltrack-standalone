...
/**
 * @brief Class representing a function to split vertices
 *
 * This class contains a method that splits vertices based on certain conditions
 * and updates the workspace accordingly.
