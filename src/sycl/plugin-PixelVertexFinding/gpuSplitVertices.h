...
### Class ZVertices * @brief Represents a collection of vertices with associated data.
 
 

### Class WorkSpace * @brief Provides workspace for tracking-related computations.
 

### Class CablingWrapper * @brief Manages GPU memory for cabling maps.
