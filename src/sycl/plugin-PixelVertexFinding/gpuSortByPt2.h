...
/**
 * Sorts vertices by their transverse momentum squared.
 *
 * This function sorts the vertices based on the sum of the transverse momenta squared of the tracks belonging to each vertex.
 *
...
/**
 * @brief Sorts vertices by their transverse momentum squared.
 *
 * This function sorts the vertices based on the sum of the transverse momenta squared of the tracks belonging to each vertex.
 *
 * @param pdata Pointer to the ZVertices object containing the vertex data.
 * @param pws Pointer to the WorkSpace object containing workspace data.
