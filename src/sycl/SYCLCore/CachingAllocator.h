 ...
 * It iterates over the cache, removes each block, and updates the tracking metrics.
 * If debugging is enabled, it also prints detailed information about the freed resources.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
    void freeAllCached() {
      std::scoped_lock lock(mutex_);
 ...
 * depending on the current context, utilizing SYCL queues for management.
 *
 * @param bytes The number of bytes required for the buffer allocation.
 * @param queue The SYCL queue object associated with the allocation operation.
