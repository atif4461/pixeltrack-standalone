 ...
 * Struct representing GPU data storage per device.
  
 * Class providing synchronization mechanism for accessing GPU data.
  
 * Function template implementing asynchronous data retrieval for current device.
  
 * Class encapsulating event setup data and its associated metadata.
  
 * Class handling concurrent access to shared resources.
  
 * Exception class for asserting invalid state during data transfer.
  
 * Class managing barriers for synchronizing execution across queues.
  
 * Interface for interacting with SYCL queues and events.
  
 * Class responsible for exchanging and checking flags for data availability.
  
 * Template class for storing and retrieving data in a thread-safe manner.
