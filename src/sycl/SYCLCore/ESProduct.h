 ...
 * Member function to check if the data has already been filled.
 * @return True if the data is available, false otherwise.
  
 * Member function to fill the data for the current device.
 * @param data The data to be filled.
 * @param stream The SYCL queue associated with the device.
  
 * Member variable to store the mutex for thread safety.
  
 * Member variable to store the event marking the completion of data transfer.
  
 * Member variable to store the flag indicating if the data is being filled.
