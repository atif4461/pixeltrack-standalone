...
/**
 * Enqueues a callback to wait on the specified stream and notifies when waiting is done
...
// The following comment is generated by an LLM. 
/**
 * Throws an exception when insertNextTask is called without proper construction of ContextState 
