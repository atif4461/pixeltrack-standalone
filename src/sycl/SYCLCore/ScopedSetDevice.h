...
namespace cms {
  namespace sycltools {
/**
 * @brief A helper class to manage the scope of a SYCL device.
 *
 * This class stores the original device and optionally sets a new current device.
 * When the object is destroyed, it restores the original device.
