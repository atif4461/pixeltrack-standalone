 ...
 * @brief A class used to manage the scope of a SYCL device setting.
 *
 * This class provides a way to store the original device and optionally set a new current device,
 * ensuring that the original device is restored when the object is destroyed.
