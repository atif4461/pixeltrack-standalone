...
namespace cms::sycltools {
  ...
  namespace detail {
/**
 * Allocate host allocators for multiple platforms.
 *
 * This function creates an array of caching allocators, one for each platform,
 * and returns a unique pointer to manage their lifetime.
