...
namespace cms::sycltools {
  ...
  namespace detail {
/**
 * Allocates an array of device allocators and returns a unique pointer to it.
 *
 * The allocator objects are constructed in the allocated storage and a custom
 * deleter is used to destroy them when the unique pointer goes out of scope.
