 ...
 * The HostProduct class provides a wrapper around unique pointers 
 * to manage resources on the host It offers constructors 
 * and operators to facilitate interaction with the wrapped resource
