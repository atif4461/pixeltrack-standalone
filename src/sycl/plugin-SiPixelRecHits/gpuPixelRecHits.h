 ...
 * @brief Represents a 2D hit in the tracker with structure of arrays
  
 * @class SiPixelDigisSYCL
 * @brief Provides a SYCL device view for silicon pixel digis
 
 * @class SiPixelClustersSYCL
 * @brief Provides a SYCL device view for silicon pixel clusters
 
 * @class pixelCPEforGPU
 * @brief Provides parameters and functionality for pixel CPE on GPU
 
 * @class BeamSpotPOD
 * @brief Represents a beam spot with plane of dominance
