 ...
 * @class BeamSpotPOD
 * @brief Represents the beam spot position and direction
 
 * @class SiPixelDigisSYCL
 * @brief Handles silicon pixel digis data on SYCL devices
 
 * @class SiPixelClustersSYCL
 * @brief Manages silicon pixel cluster data on SYCL devices
