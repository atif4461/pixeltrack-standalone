 ...
 * @param digis_d SiPixelDigisSYCL object containing digitized data
 * @param clusters_d SiPixelClustersSYCL object containing cluster data
 * @param bs_d BeamSpotSYCL object containing beam spot data
 * @param cpeParams pointer to pixelCPEforGPU parameters
 * @param stream sycl queue for asynchronous execution
