...
/**
 * Sets the start of the hits layer based on the module start and geometry parameters.
 * @param[in] hitsModuleStart array of module starts
 * @param[in] cpeParams constant pointer to params on GPU
 * @param[out] hitsLayerStart array to store layer starts
...
// The following comment is generated by an LLM. 
/**
 * @brief Makes tracking rec hits asynchronously.
 *
 * @param[in] digis_d              The input digitization data.
 * @param[in] clusters_d           The input cluster data.
 * @param[in] bs_d                 The beam spot data.
 * @param[in] cpeParams             The parameters for the pixel CPE.
 * @param[out] stream              The SYCL queue to execute on.
 *
 * @return A collection of 2D tracking rec hits.
