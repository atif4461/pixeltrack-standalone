 ...
 * @param[in] iSetup The event setup associated with the input event.
 * @param[in,out] waitingTaskHolder A holder for tasks waiting for the acquisition to complete.
