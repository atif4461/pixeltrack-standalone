...
1. `int main(int argc, char **argv)` * @brief Main program entry point.
 *
...
2. `auto generateClusters = [&](int kn)` * @brief Generates clusters of data points.
 *
 * @param kn Input parameter controlling cluster generation.
 

3. `countModules(d_id_get, d_moduleStart_get, d_clus_get, n, item)` * @brief Kernel function to count modules.
 *
 * @param d_id_get Device memory access for IDs.
 * @param d_moduleStart_get Device memory access for module start indices.
 * @param d_clus_get Device memory access for cluster assignments.
 * @param n Total number of elements.
 * @param item Work-item object for parallel execution.
 

4. `findClusCPU(d_id_get, d_x_get, d_y_get, d_moduleStart_get, d_clusInModule_get, d_moduleId_get, d_clus_get, n, item)` * @brief CPU-based kernel function to find clusters.
 *
 * @param d_id_get Device memory access for IDs.
 * @param d_x_get Device memory access for X coordinates.
 * @param d_y_get Device memory access for Y coordinates.
 * @param d_moduleStart_get Device memory access for module start indices.
 * @param d_clusInModule_get Device memory access for cluster counts per module.
 * @param d_moduleId_get Device memory access for module IDs.
 * @param d_clus_get Device memory access for cluster assignments.
 * @param n Total number of elements.
 * @param item Work-item object for parallel execution.
 

5. `findClusGPU(d_id_get, d_x_get, d_y_get, d_moduleStart_get, d_clusInModule_get, d_moduleId_get, d_clus_get, n, item)` * @brief GPU-based kernel function to find clusters.
 *
 * @param d_id_get Device memory access for IDs.
 * @param d_x_get Device memory access for X coordinates.
 * @param d_y_get Device memory access for Y coordinates.
...
6. `clusterChargeCut(d_id_get, d_adc_get, d_moduleStart_get, d_clusInModule_get, d_moduleId_get, d_clus_get, n, item)` * @brief Kernel function to apply charge cuts to clusters.
 *
 * @param d_id_get Device memory access for IDs.
 * @param d_adc_get Device memory access for ADC values.
 * @param d_moduleStart_get Device memory access for module start indices.
 * @param d_clusInModule_get Device memory access for cluster counts per module.
 * @param d_moduleId_get Device memory access for module IDs.
 * @param d_clus_get Device memory access for cluster assignments.
