 ...
 *
 * @param kn Input parameter to control cluster generation.
 
auto generateClusters = [&](int kn) 
 * @brief Kernel function to count modules.
 *
 * @param d_id Device memory pointer for ids.
 * @param d_moduleStart Device memory pointer for module starts.
 * @param d_clus Device memory pointer for cluster information.
 * @param n Number of elements.
 * @param item ND item object for parallel execution.
 
void countModules(d_id_get, d_moduleStart_get, d_clus_get, n, item)
 * @brief Kernel function to find clusters on CPU.
 *
 * @param d_id Device memory pointer for ids.
 * @param d_x Device memory pointer for x coordinates.
 * @param d_y Device memory pointer for y coordinates.
 * @param d_moduleStart Device memory pointer for module starts.
 * @param d_clusInModule Device memory pointer for cluster information per module.
 * @param d_moduleId Device memory pointer for module ids.
 * @param d_clus Device memory pointer for cluster information.
 * @param n Number of elements.
 * @param item ND item object for parallel execution.
 
void findClusCPU(d_id_get, d_x_get, d_y_get, d_moduleStart_get, d_clusInModule_get, d_moduleId_get, d_clus_get, n, item)
 * @brief Kernel function to find clusters on GPU.
 *
 * @param d_id Device memory pointer for ids.
 * @param d_x Device memory pointer for x coordinates.
 * @param d_y Device memory pointer for y coordinates.
...
void findClusGPU(d_id_get, d_x_get, d_y_get, d_moduleStart_get, d_clusInModule_get, d_moduleId_get, d_clus_get, n, item)
 * @brief Kernel function to apply charge cut.
 *
 * @param d_id Device memory pointer for ids.
 * @param d_adc Device memory pointer for adc values.
 * @param d_moduleStart Device memory pointer for module starts.
 * @param d_clusInModule Device memory pointer for cluster information per module.
 * @param d_moduleId Device memory pointer for module ids.
 * @param d_clus Device memory pointer for cluster information.
...
void clusterChargeCut(d_id_get, d_adc_get, d_moduleStart_get, d_clusInModule_get, d_moduleId_get, d_clus_get, n, item)*/ 
int main(int argc, char **argv) {
