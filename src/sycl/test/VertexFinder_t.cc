 ...
 *
 * @details This function is not explicitly defined in this snippet but it's called.
 
  * @brief Choose a SYCL device from the list of enumerated devices.
 *
 * @param index Index of the device to choose.
 * @return The chosen SYCL device.
 
  * @brief Create a unique pointer to an array of ZVertices on the device.
 *
 * @tparam T Type of elements in the array.
 * @param n Size of the array.
 * @param q Queue associated with the device memory allocation.
 * @return Unique pointer to the allocated array.
 
  * @brief Submit a command group to initialize vertex finder data structures.
 *
 * @param cgh Command group handler.
  * @brief Kernel to initialize vertex finder data structures.
 *
 * @param soa_kernel Pointer to SOA data structure.
 * @param ws_kernel Pointer to workspace data structure.
 ...
 * @param ws_kernel Pointer to workspace data structure.
  ...
  * @brief Find vertices using the one kernel approach.
 *
 * @param soa_kernel Pointer to SOA data structure.
 * @param ws_kernel Pointer to workspace data structure.
 ...
 * @param chi2max_kernel Maximum allowed Chi-squared value.
  ...
  * @brief Fit vertices to found vertex candidates.
 *
 * @param soa_kernel Pointer to SOA data structure.
 * @param ws_kernel Pointer to workspace data structure.
 * @param maxIterations Maximum number of iterations.
  * @brief Split merged vertices into separate ones.
 *
 * @param soa_kernel Pointer to SOA data structure.
 * @param ws_kernel Pointer to workspace data structure.
 * @param chi2Max Maximum allowed Chi-squared value for splitting.
  * @brief Sort vertices by their transverse momentum.
 *
 * @param soa_kernel Pointer to SOA data structure.
 * @param ws_kernel Pointer to workspace data structure.
 */ 
