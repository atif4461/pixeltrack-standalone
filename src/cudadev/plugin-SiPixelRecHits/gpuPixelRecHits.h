 ...
 * @class BeamSpotPOD
 * @brief Represents a beam spot with plane of incidence direction.
 
 * @class SiPixelDigisCUDA
 * @brief Handles silicon pixel digis on CUDA devices.
 
 * @class SiPixelClustersCUDA
 * @brief Manages silicon pixel clusters on CUDA devices.
