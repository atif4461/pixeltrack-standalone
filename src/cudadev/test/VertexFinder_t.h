...
#ifdef __CUDACC__
/**
 * Brief description of the kernel function for finding vertices.
 *
 * This function performs a series of operations to identify vertices in a dataset.
 * It takes into account various parameters such as minimum number of neighbors,
 ...
 * @brief A class representing a GPU-based vertex finder.
  
 * @class WorkSpace
 * @brief A class representing a workspace for vertex finding.
 
 * @class ZVertices
 * @brief A class representing vertices along the z-axis.
 
 * @class Event
 * @brief A class representing an event with associated data.
 
 * @class ClusterGenerator
 * @brief A class generating clusters for testing purposes.
