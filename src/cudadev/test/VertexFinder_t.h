 ...
 * Prints the number of tracks, final vertices and intermediate vertices
 * Parameters:
...
/**
 * @brief The gpuVertexFinder class is responsible for finding vertices in a set of tracks.
 
class gpuVertexFinder {
  
     * @brief Structure to hold Z-vertices.
   
  struct ZVertices {
    
  };

     * @brief Structure to hold workspace data.
   
  struct WorkSpace {
    
  };
};
 * @brief The ClusterGenerator class generates clusters of tracks.
 
class ClusterGenerator {
  
     * @brief Constructor for the ClusterGenerator class.
   * @param nav Number of average tracks.
   * @param arg Second argument for the constructor.
   
  ClusterGenerator(int nav, int arg);
};
 * @brief The Event class represents an event with associated tracks and vertices.
 
class Event {
  
     * @brief Vector of Z-vertices.
   
  std::vector<float> zvert;
  
     * @brief Vector of Z-tracks.
