 ...
 * @brief A wrapper class for managing SiPixelFedCablingMapGPU objects on the GPU.
 
class CablingWrapper {
  public:
         * @brief Constructor for CablingWrapper.
     * @param cablingMap The SiPixelFedCablingMapGPU object to be managed.
     
    explicit CablingWrapper(SiPixelFedCablingMapGPU const& cablingMap);

         * @brief Destructor for CablingWrapper.
     
    ~CablingWrapper();

         * @brief Get the SiPixelFedCablingMapGPU object asynchronously.
     * @param cudaStream The CUDA stream to use.
     * @return A pointer to the SiPixelFedCablingMapGPU object.
     
    const SiPixelFedCablingMapGPU* getAsync(cudaStream_t cudaStream) const;

         * @brief Get the SiPixelFedCablingMapGPU object.
     * @return A pointer to the SiPixelFedCablingMapGPU object.
