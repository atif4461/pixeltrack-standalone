 ...
 * @param double minimum value of the histogram range
 * @param double maximum value of the histogram range
  * Fills the histogram at the specified location
 * @param double value to fill in the histogram
  * Outputs the contents of the histogram as a string
 * @return stdstring representation of the histogram
 */int main() {
