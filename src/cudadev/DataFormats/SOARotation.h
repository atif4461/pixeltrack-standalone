 ...
 *
 * Detailed description: This function transforms a global tensor to local
 * coordinates using rotation matrix. It takes a global tensor and returns
 * the corresponding local xx, xy, yy components.
 *
 * Parameters:
 *   ge - Global tensor
