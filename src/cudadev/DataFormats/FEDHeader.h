...
/**
 * @class FEDHeader
 * @brief Represents a Front End Data Header containing metadata about an event
 * @details Provides accessors for various event properties such as trigger type, level-1 ID, 
 *         bunch crossing ID, source ID, version, and more headers flag
