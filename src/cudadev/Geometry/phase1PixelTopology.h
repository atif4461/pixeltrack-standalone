 ...
 *
 * @tparam Function Type of the mapping function.
 * @tparam Indices Parameter pack of indices.
 * @param f Mapping function to apply to each index.
 * @return Array containing results of applying the mapping function to each index.
...
/**
 * Calculates the maximum stride value for modules in a layer.
 *
 * This function iteratively checks for the largest power of 2 that divides all layer start values,
 * returning the largest such value found.
 *
 * @return The maximum module stride value.* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @brief Finds the layer corresponding to a detector ID
 * @param detId Detector ID to search for
 * @return Layer number associated with the detector ID
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @brief Finds the layer from a compact detector ID
...
/**
 * Validates the layer indices of modules within their respective layers.
 *
...
/**
 * Calculates the ROC Y value from a given pixel Y coordinate.
 *
...
/**
 * Checks if a pixel is at the top or bottom edge of a ROC.
 *
 * @param py Y coordinate of the pixel
 * @return true if pixel is at the top or bottom edge, false otherwise
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
