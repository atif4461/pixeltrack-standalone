...
#else
/**
 * @brief Allocates memory on the GPU for intermediate results during track reconstruction.
 *
 * This function allocates memory for various data structures required for track reconstruction,
 * including cell neighbors, cell tracks, hit-to-tuple mapping, tuple multiplicity, and atomic pair counters.
 *
 * @param nHits The number of hits to be processed.
 * @param stream The CUDA stream on which the allocations should be performed.
