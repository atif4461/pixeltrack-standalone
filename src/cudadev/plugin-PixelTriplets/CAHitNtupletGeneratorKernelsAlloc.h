...
#else
/**
 * @brief Class representing the CPU-side generator of hit ntuples for the CA algorithm.
 *
 * This class is responsible for allocating memory on the GPU for intermediate results,
 * including cell neighbors, cell tracks, hit-to-tuple associations, and tuple multiplicities.
 * It also initializes the allocated memory with default values.
