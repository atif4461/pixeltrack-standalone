 ...
 *
 * @param[in] length_values Input values representing detector lengths.
 ...
 * @param ret Output matrix containing the computed scattering covariance.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * @param B parameter for limiting pt
 ...
 *
 * @param p2D Input 2D points in polar coordinates
 * @param cov_rad Covariance matrix in radial coordinates
 * @param rad Radii of the input points
...
*/
  template <typename M2xN, int N>
/**
 * Calculates the covariance matrix from Cartesian coordinates to radial coordinates.
 *
 * @param p2D input 2xN matrix
 * @param cov_cart input NxN covariance matrix in cartesian coordinates
 ...
 * @return output covariance matrix in radial direction
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * @param p2D 2D coordinates of the line segment endpoints
 * @param par_uvr 3D vector representing the point to calculate charge for
 * @return Charge of the point, either -1 or 1
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Brief description of fastFit function
 *
 * This function performs a fast fit calculation on a set of hits.
 *
 * It calculates the circle fit and line fit parameters.
 *
 * @param hits input matrix containing hit data
 * @param result output vector containing fit results
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
class CircleFit {
  /// Member variable descriptions
     * @var par Description of par
   
  Vector3d par;

     * @var qCharge Description of qCharge
   
  double qCharge;

     * @var chi2 Description of chi2
   
  double chi2;

     * @var cov Description of cov
...
struct LineFit {
  ...
  /// Covariance matrix of the line fit parameters
 ...
 * @param bField Magnetic field strength.
 * @param error Flag to include error calculation.
 *
 * @return Result of the line fit.
...
*/
  ...
  template <int N>
/**
 * Class representing a helical fit to a set of 3D space points.
  
class HelixFit {
  
     * Constructor for HelixFit class.
   *
   * @param hits input 3D space points
   * @param hits_ge input geometric parameters
   * @param bField magnetic field strength
   * @param error flag indicating whether to calculate errors
   
  
     * Member variable storing fitted parameters.
   
  
     * Member variable storing covariance matrix of fitted parameters.
   
  
     * Member variable storing charge of the particle.
   
  
     * Member variable storing chi-squared value of the circular fit.
   
  
     * Member variable storing chi-squared value of the linear fit.
