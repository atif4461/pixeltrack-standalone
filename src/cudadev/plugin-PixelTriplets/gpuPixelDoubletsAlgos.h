 ...
 * cell neighbors, cell tracks, tracking rec hits, and more. It then uses these
 ...
 * @param nCells Pointer to store total number of doublets
 * @param cellNeighbors Cell neighbors
 * @param cellTracks Cell tracks
 * @param hh Tracking rec hits
