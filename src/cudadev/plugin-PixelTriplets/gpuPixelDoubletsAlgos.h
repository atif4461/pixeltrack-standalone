 ...
 * cell neighbors, cell tracks, tracking rec hits, and more. It uses these inputs 
 * to calculate and store doublets in the 'cells' array.
 *
 ...
 * @param hh Tracking rec hits data.
 * @param isOuterHitOfCell Data to mark outer hits of cells.
