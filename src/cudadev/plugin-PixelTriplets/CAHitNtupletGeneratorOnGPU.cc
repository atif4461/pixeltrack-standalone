 ...
 * allocates memory for counters based on GPU usage
 */ 
 ...
 * @brief Releases resources allocated on GPU or CPU depending on configuration
 */ 
 ...
 * @param hits_d Tracking Rec Hit 2D CUDA object containing hit data.
 ...
 * @param hits_d Tracking Rec Hit 2D data structure containing hit information
 * @param bfield Magnetic field strength used for fitting helices
