 ...
 * @param onGPU flag indicating whether processing is done on GPU
 * @param minHitsPerNtuplet minimum hits per ntuplet
 * @param maxNumberOfDoublets maximum number of doublets
 * @param minHitsForSharingCuts minimum hits for sharing cuts
 * @param useRiemannFit flag indicating whether Riemann fit is used
 * @param fit5as4 flag indicating whether 5as4 fit is used
 * @param includeJumpingForwardDoublets flag indicating whether jumping forward doublets are included
 * @param earlyFishbone flag indicating whether early fishbone is used
 * @param lateFishbone flag indicating whether late fishbone is used
 * @param idealConditions flag indicating whether ideal conditions are used
 * @param doStats flag indicating whether statistics are done
 * @param doClusterCut flag indicating whether cluster cut is done
 * @param doZ0Cut flag indicating whether z0 cut is done
 * @param doPtCut flag indicating whether pt cut is done
 * @param doSharedHitCut flag indicating whether shared hit cut is done
 * @param ptmin minimum pt value
 * @param CAThetaCutBarrel cat theta cut barrel value
 * @param CAThetaCutForward cat theta cut forward value
 * @param hardCurvCut hard curvature cut value
 * @param dcaCutInnerTriplet dca cut inner triplet value
 * @param dcaCutOuterTriplet dca cut outer triplet value
