...
/**
 * Brief description: Prepares broken line data for further processing.
 * 
 * Detailed description: This function takes in hit data, a fast fit, and a magnetic field strength,
 * and prepares the broken line data by calculating various parameters such as charge, 
 * radii, transverse distances, total distance, and variance of beta.
 * 
 * Parameters:
 *   hits (M3xN): Hit data
 *   fast_fit (V4): Fast fit data
 *   bField (double): Magnetic field strength
 *   results (PreparedBrokenLineData<n>): Output prepared broken line data
...
*/ 
  ...
  */
  template <int n>
/**
 * Calculates the matrix C_u for the Riemann fit.
 *
 * @param weights   Weights vector
 * @param sTotal    Total s values vector
 * @param varBeta   Variance beta values vector
...
/**
 * Brief description: Fast fit function for calculating circle parameters from hit points.
 *
 * Detailed description: This function calculates the center and radius of a circle 
 * that best fits a set of 2D hit points. It uses geometric properties of circles 
 * and vectors to derive the circle parameters.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Function to perform a circle fit on a set of points in 3D space.
 * 
 * This function takes as input a set of 3D points, their associated geometric errors,
 * an initial estimate of the circle parameters, and returns the fitted circle parameters.
 * 
 * The function uses a weighted least squares approach to find the best fit circle.
 * 
 * @param hits A matrix containing the 3D coordinates of the points to be fitted.
 * @param hits_ge A matrix containing the geometric errors associated with each point.
 * @param fast_fit An initial estimate of the circle parameters.
 * @param bField The magnetic field strength.
 * @param data A struct containing additional data required for the fit.
 * @param circle_results A struct to store the results of the circle fit.
  
 * @brief Class representing a prepared broken line data structure.
 * 
 * This class contains data members and functions related to the preparation of broken line data.
 
  * @brief Class representing a Karimaki circle fit result structure.
 * 
 * This class contains data members to store the results of a Karimaki circle fit, including the charge,
 * circle parameters, covariance matrix, and chi-squared value.
  
 * @brief Class representing a Riemann fit structure.
 * 
 * This class contains functions and data members related to Riemann fits, including matrix operations and vector calculations.
  
 * @brief Class representing a translation operation on a Karimaki circle fit result.
 * 
 * This class contains a function to translate a Karimaki circle fit result by a specified amount.
  
 * @brief Class representing a matrix structure.
 * 
 * This class contains data members and functions related to matrix operations.
  
 * @brief Class representing a vector structure.
 * 
 * This class contains data members and functions related to vector operations.
  
 * @brief Class representing a mathematical operation structure.
 * 
 * This class contains functions related to various mathematical operations, such as square root and squared norm calculations.
  
 * @brief Class representing a scattering operation structure.
 * 
 * This class contains a function to calculate multiple scattering effects.
  
 * @brief Class representing a Cholesky inversion structure.
 * 
 * This class contains a function to perform Cholesky inversion on a matrix.
  
 * @brief Class representing a Cabling wrapper structure.
 * 
 * This class contains functions and data members related to managing cabling data on GPUs.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Function to perform a line fit on a set of points in 3D space.
 *
 * This function takes in a set of hits in global coordinates, a fast fit result,
 * the magnetic field strength, prepared broken line data, and returns the
 * results of the line fit in the form of a RiemannFit LineFit object.
 *
 * @param hits_ge Set of hits in global coordinates.
 * @param fast_fit Fast fit result.
 * @param bField Magnetic field strength.
 * @param data Prepared broken line data.
 * @param line_results Results of the line fit.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @class HelixFit 
 * @brief Fits a helix to a set of 3D points in a magnetic field
  
 * @class Vector4d 
 * @brief Represents a 4D vector
 
 * @class Matrix3xNd 
 * @brief Represents a 3xN dimensional matrix
 ...
 * @class Matrix3d 
 * @brief Represents a 3x3 dimensional matrix
 
 * @class MatrixXd 
 * @brief Represents a dynamic dimensional matrix
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
