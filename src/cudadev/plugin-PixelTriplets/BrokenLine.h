...
/**
 * @brief Prepares broken line data for further processing.
 * 
 * This function takes in hit data, a fast fit result, and a magnetic field strength,
 * and produces prepared broken line data including charge, radii, transverse distances,
 * total distance along the helix, and variance of beta.
 * 
...
*/ 
  ...
  */
  template <int n>
/**
 * Calculates the matrix C_u for the Riemann fit algorithm.
 *
 * @param weights   vector of weights
 * @param sTotal    vector of total values
 * @param varBeta   vector of variance beta values
...
/**
 * Brief description: Performs a fast fit calculation on a set of hits.
 *
 * Detailed description: This function takes a set of hits as input and calculates the result of a fast fit algorithm.
 * The algorithm uses various vector calculations to determine the best fit.
 *
 * Parameters:
 *   hits - A matrix containing the hit data.
 *   result - A vector to store the result of the fast fit calculation.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Function to perform a circle fit on a set of hits.
 * 
 * This function takes in a set of hits, their geometric uncertainties, 
 * an initial estimate of the circle parameters, and the magnetic field strength.
 * It returns a struct containing the fitted circle parameters and their covariance matrix.
 * 
 * @param hits A matrix of hits with shape 3xN where N is the number of hits.
 * @param hits_ge A matrix of geometric uncertainties of the hits with shape 6xN.
 * @param fast_fit An initial estimate of the circle parameters as a vector of length 4.
 * @param bField The strength of the magnetic field.
 * @param data A struct containing prepared broken line data.
 ...
 *
 * This function takes as input a set of hits in global coordinates, a fast fit result,
 * the magnetic field strength, prepared broken line data, and returns the line fit results.
 *
 * The function uses a weighted least squares approach to find the best fit line.
 *
 * @param hits_ge Set of hits in global coordinates.
 * @param fast_fit Fast fit result.
 * @param bField Magnetic field strength.
 * @param data Prepared broken line data.
 * @param line_results Line fit results.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @class HelixFit 
 * @brief Fits a helix to a set of 3D points
 ...
 * @brief Fits a circle using Karimaki algorithm
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
