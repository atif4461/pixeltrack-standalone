...
/**
 * Returns a pointer to the ParamsOnGPU structure on the GPU for the current device asynchronously.
 *
 * @param cudaStream The CUDA stream to use for asynchronous operations.
 * @return A pointer to the ParamsOnGPU structure on the GPU.
 */ 
 ...
 * Releases GPU memory allocated for parameters
 */ 
