...
namespace cms {
  namespace cuda {
    ...
    template <typename Assoc>
/**
 * Brief description of the function zeroAndInit
 *
 * Detailed description of the function zeroAndInit which takes OneToManyAssociationView as input
 * and initializes its associated storage
 *
 * @param view OneToManyAssociationView to initialize
...
*/ 
    ...
    template <typename Assoc>
/**
 * Launches zero initialization on the specified association object
 * 
 * @param h Association object pointer
...
*/ 
    ...
    template <typename Assoc>
/**
 * Launch finalize function for Assoc data structure
 *
