 ...
 *
 * This function initializes an OneToManyAssocView object,
 * setting its associated storage to zero and initializing
 * its internal state.
 *
 * @param view the OneToManyAssocView object to initialize
...
*/ 
    ...
    template <typename Assoc>
/**
 * Launches zero initialization on the specified association object handle.
 *
 * @param h Association object handle
...
*/ 
    ...
    template <typename Assoc>
/**
 * Launches a kernel to zero out an OneToManyAssocView on the GPU.
 *
 * @param view The OneToManyAssocView to be zeroed.
...
*/ 
    ...
    template <typename Assoc>
/**
 * Launch finalize function for Assoc object
 *
 * @param h pointer to Assoc object
