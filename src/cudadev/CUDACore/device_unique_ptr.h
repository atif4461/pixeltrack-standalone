 ...
 * It uses a DeviceDeleter to manage the lifetime of the allocated memory.
 *
 ...
 *
 * @tparam T The type of the device object.
 *
 * @param stream The CUDA stream associated with the device memory allocation.
 *
...
*/ 
    ...
    template <typename T>
/**
 * @brief Creates an unbounded array of uninitialized devices with the specified type and size.
 *
 * @tparam T The type of elements in the array.
