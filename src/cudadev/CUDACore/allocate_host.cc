...
/**
 * Allocates host memory of specified size in bytes using either caching or 
 * noncaching method depending on allocator policy and returns pointer to it */  void *allocate_host(size_t nbytes, cudaStream_t stream) {
    void *ptr = nullptr;
