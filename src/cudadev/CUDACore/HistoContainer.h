 ...
 *
 * This function fills multiple histograms from a given vector of values and offsets.
 *
 * @param h Pointer to the histogram array to be filled.
 * @param nh Number of histograms to fill.
 * @param v Vector of values to fill the histograms with.
 * @param offsets Offsets into the value vector for each histogram.
 * @param totSize Total size of the memory block for the histograms.
 * @param nthreads Number of threads to use for filling the histograms.
 * @param mem Memory block for the histograms.
