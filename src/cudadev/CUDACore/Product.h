...
/**
 * @class Product
 * @brief Represents a product entity with associated metadata
 * @details This class provides a constructor for creating products and manages the product's data
