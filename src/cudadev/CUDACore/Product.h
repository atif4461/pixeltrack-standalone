 ...
 * It provides constructors for creating products with different parameters.
 * The class has deleted copy constructor and assignment operator to prevent copying.
 * Move constructor and move assignment operator are defaulted.
 *
 * @tparam T Type of the data stored in the product
