 ...
 * Detailed description This class represents a vector with a predefined maximum size It provides an unsafe push back operation that does not check for overflow 
