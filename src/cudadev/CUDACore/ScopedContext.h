 ...
 *
 * @param data The product containing the data to be retrieved
 ...
 * This class provides functionality to push next task 
 * It takes a function and context state as input parameters
 * It replaces waiting task holder with new task 
  
 * Brief description of WaitingTaskWithArenaHolder struct 
   * Detailed description of WaitingTaskWithArenaHolder struct 
 * This struct holds waiting tasks alongwith arena 
 * It provides functionality to manage waiting tasks 
 
 * Brief description of ContextState class 
   * Detailed description of ContextState class 
 * This class represents state of context 
 * It provides information about current context 
 
 * Brief description of ScopedContextTask class 
   * Detailed description of ScopedContextTask class 
 * This class represents scoped context task 
 * It provides functionality to execute tasks within scope 
  
 * Brief description of F type 
   * Detailed description of F type 
 * This type represents a callable object 
 * It provides functionality to invoke functions 
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
