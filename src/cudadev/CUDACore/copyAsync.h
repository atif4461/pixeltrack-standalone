...
*/ 
    ...
    template <typename T>
/**
 * Copies data asynchronously from a device unique pointer to a host unique pointer.
 *
 * @param dst   Destination host unique pointer.
 * @param src   Source device unique pointer.
 * @param stream CUDA stream for asynchronous operation.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * @param dst destination array on the device
 * @param src source vector on the host
 ...
 * Copies data asynchronously from host to device.
 *
 * @param dst destination array on device
 * @param src source vector on host
 * @param stream CUDA stream for asynchronous operation
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
