 ...
 * and releases their memory and associated events. It also updates internal tracking metrics.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
 ...
 *
 * This function releases all cached memory blocks, freeing their associated memory
 * and destroying any related events. It also updates internal tracking metrics,
 * including the number of available and live blocks, as well as the total amount
 * of cached and live bytes per device.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
  void freeAllCached() {
    std::scoped_lock lock(mutex_);
