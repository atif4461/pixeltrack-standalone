...
namespace allocator {
/**
 * Calculates the power of an integer using exponentiation by squaring method
...
/**
 * Comparison function for pointers in different blocks.
 *
 * This function compares two block descriptors based on their pointer values.
 *
 * @param a First block descriptor to compare.
 * @param b Second block descriptor to compare.
 * @return True if the first block's pointer is less than the second block's pointer, false otherwise.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Attempts to reuse a cached block of memory that matches the specified search key.
 *
 * @param searchKey The descriptor of the block to search for.
 * @return A pointer to the reused block of memory, or nullptr if no matching block was found.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * and destroying any related events. It also updates the cache statistics accordingly.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
  void freeAllCached() {
    std::scoped_lock lock(mutex_);
