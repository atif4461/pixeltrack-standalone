 ...
 *
 * @param id          Array of module IDs
 * @param moduleStart Array of module start indices
 * @param clusterId   Array of cluster IDs
...
/**
 * @brief Function to find clusters in a module
 *
 ...
 *
 * It uses CUDA kernels to perform parallel computations on the GPU.
 *
