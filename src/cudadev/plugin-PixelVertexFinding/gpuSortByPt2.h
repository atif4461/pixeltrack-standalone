 ...
 *
 * This function sorts the vertices based on their transverse momentum squared values.
 * It uses a combination of shared memory and atomic operations to achieve high performance.
 *
