 ...
 * This kernel function iterates over all vertices and checks if they need to be split into two separate vertices.
 * It uses various arrays such as zv, wv, chi2, nn, iv, and shared memory arrays like it, zz, newV, and ww to keep track of indices, z positions, 
 * classification of tracks, and weights respectively.
 * If a vertex needs to be split, it calculates the new z position of the two potential vertices and assigns them accordingly.
 * The splitting process involves iterative calculations until convergence or a maximum number of iterations is reached.
 * After splitting, it updates the necessary arrays and checks the quality of the split vertices.
