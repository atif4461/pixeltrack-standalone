...
/**
 * @brief Class representing ZVertices data structure
 
 
 * @brief Class representing WorkSpace data structure
  
  * @brief Class providing methods for fitting vertices
 * @details This class contains functionality for computing cluster locations, 
 *          handling outliers, and calculating chi-squared values.
 ...
 * Parameters:
 *   pdata ZVertices pointer to vertex data
 *   pws WorkSpace pointer to workspace
 *   chi2Max float maximum chi squared value for outlier rejection
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
