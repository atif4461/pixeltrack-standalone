...
/**
 * @brief Kernel function to cluster tracks by density
 * @param pdata Pointer to vertex data
 * @param pws Pointer to workspace
 * @param minT Minimum number of neighbors to be seed
 * @param eps Maximum absolute distance to cluster
 * @param errmax Maximum error to be seed
