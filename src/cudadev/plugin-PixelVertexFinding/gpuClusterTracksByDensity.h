 ...
 *
 * This kernel function clusters tracks by density
 *
 * Parameters:
 *   pdata       Pointer to vertex data structure
 *   pws        Pointer to workspace data structure
 *   minT       Minimum number of neighbors required to be seed
 *   eps        Maximum absolute distance to cluster
 *   errmax     Maximum error allowed to be seed
