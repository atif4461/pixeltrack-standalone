...
namespace edm {
/**
 * Brief description: Manages a list of tasks that are waiting for a resource to become available.
 *
 * Detailed description: 
 * This class provides a mechanism for managing tasks that depend on a shared resource.
 * Tasks can be added to the list while the resource is busy, and they will be executed once the resource becomes available.
 * The class also allows for handling exceptions that occur during task execution and provides methods for resetting the state of the task list.
