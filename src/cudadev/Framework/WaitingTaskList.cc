...
/**
 * Creates a new wait node for the task list.
 *
 * @param[in] iGroup   the task group associated with the node
 * @param[in] iTask   the waiting task associated with the node
...
/**
 * Adds a waiting task holder to the list if waiting has not been completed,
 * otherwise notifies the task that waiting has already finished with an exception.
 * @param iTask the task holder to be added to the list
 */
// The above comment was written by an LLM. 
 ...
 *
 * @param[in] group The task group associated with the task.
 * @param[in] task The task to be added to the waiting task list.
 */
// The above comment was written by an LLM. 
 ...
 * @param iExcept exception pointer indicating the cause of failure
 */
// The above comment was written by an LLM. 
