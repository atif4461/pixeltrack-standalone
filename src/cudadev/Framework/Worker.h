 ...
 * Class representing an asynchronous worker 
   * Class providing functionality for handling waiting tasks 
  * Class responsible for managing producers and acquiring data 
  * Class encapsulating a waiting task holder 
  * Class holding a waiting task with arena 
