...
/**
 * @class BeamSpotCUDA
 * @brief Manages beam spot data on a CUDA device
 * @details Provides constructors for allocating device memory and accessing the data
 * @note Non-copiable and movable class
