 ...
 * @brief Structure of arrays for track fitting on heterogeneous architectures
 *
 * This class provides a structure of arrays for track fitting on heterogeneous architectures,
 * combining different data types and sizes into a single entity.
