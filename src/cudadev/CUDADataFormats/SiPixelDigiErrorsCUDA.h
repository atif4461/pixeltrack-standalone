...
/**
 * @brief Class representing silicon pixel digitization errors on CUDA devices.
 *
 * This class provides functionality for handling silicon pixel digitization errors
 * on NVIDIA CUDA devices. It includes methods for accessing error data,
