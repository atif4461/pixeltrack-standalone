 ...
 * @brief Manages CUDA memory and provides access to silicon pixel cluster data
  
 * @class DeviceConstView
 * @brief Provides constant view of device memory for silicon pixel cluster data
