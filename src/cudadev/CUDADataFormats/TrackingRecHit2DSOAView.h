 ...
 * @brief A class representing a 2D tracking rec hit with structure of arrays (SoA) view.
 * @details This class provides an interface to access various properties of a 2D tracking rec hit,
