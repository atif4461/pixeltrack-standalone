 ...
 * @brief A class representing a 2D SOA view of tracking rec hits.
 *
 * This class provides an interface to access various properties of tracking rec hits,
 * including local and global coordinates, cluster properties, and supporting objects.
 *
 * It also includes methods to retrieve specific data members, such as hit counts, layer starts,
 * and phi binners.
