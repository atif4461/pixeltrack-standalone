 ...
 * @brief A class representing a 2D tracking rec hit with structure-of-arrays (SoA) memory layout.
 *
 * This class provides an interface to access various properties of a 2D tracking rec hit,
 * including local and global coordinates, cluster properties, and supporting objects.
 *
 * The class uses CUDA-specific functionality and is intended for use on NVIDIA GPUs.
