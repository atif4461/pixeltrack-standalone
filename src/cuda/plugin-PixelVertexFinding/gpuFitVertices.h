...
/**
 * @brief Function to fit vertices 
 * @param pdata pointer to ZVertices structure containing vertex data
 * @param pws pointer to WorkSpace structure containing workspace data
...
/**
 * Brief description of function to perform vertex fitting operation on GPU
 * 
 * Detailed description of function to invoke vertex fitting algorithm 
 * with specified maximum chi squared value for outlier rejection
 *
 * Parameters:
