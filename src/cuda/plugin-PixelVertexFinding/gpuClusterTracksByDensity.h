...
/**
 * Brief description: Kernel function to cluster tracks by density
 *
 * Detailed description: This kernel function clusters tracks by density using the specified parameters
 *                     including minimum number of neighbors, maximum absolute distance, maximum error, 
 *                     and maximum normalized distance.
 *
 * Parameters:
 *   pdata - pointer to vertex data
 *   pws - pointer to workspace data
 *   minT - minimum number of neighbors required to form a seed
 *   eps - maximum absolute distance to consider two points as part of the same cluster
 *   errmax - maximum error allowed for a point to be considered as part of a seed
 *   chi2max - maximum normalized distance for a point to be considered as part of a cluster
