 ...
 * @param[in] iEvent The event object containing the data to be acquired.
 * @param[in] iSetup The event setup object providing additional configuration.
 ...
 * @param iSetup The EventSetup object providing configuration data
 */
// The above comment was written by an LLM. 
