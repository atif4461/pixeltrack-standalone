...
/**
 * Produces SiPixelFedIds and SiPixelFedCablingMapGPUWrapper objects from binary files
 * and stores them in the EventSetup for later use.
 *
 * @param eventSetup reference to the EventSetup object where produced data will be stored
