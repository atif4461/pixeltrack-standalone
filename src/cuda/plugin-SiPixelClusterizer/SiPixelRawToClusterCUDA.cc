...
/**
 * Constructor for the class initializing necessary tokens and flags
 * @param reg EDM product registry object reference
 */ 
 ...
 * @param iSetup The event setup providing access to the SiPixelFedCablingMapGPUWrapper and SiPixelGainCalibrationForHLTGPU.
 * @param waitingTaskHolder A WaitingTaskWithArenaHolder object for managing asynchronous tasks.
 */ 
