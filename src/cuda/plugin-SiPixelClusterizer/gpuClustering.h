...
/**
 * Counts modules in an array of IDs and updates module start indices.
 *
 ...
 * @param numElements number of elements in input array
 ...
 *
 * This kernel function is responsible for finding clusters in a module.
 * It takes several parameters including module id, local coordinates,
 * module start index, number of clusters in each module, module id of each module,
 * cluster id of each pixel, and total number of elements.
 *
 * The function uses a histogram to count the number of pixels in each column,
 * and then finds the nearest neighbors for each pixel. It iteratively updates
 * the cluster ids until convergence.
 *
