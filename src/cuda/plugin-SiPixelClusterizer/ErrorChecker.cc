 ...
 * @param[out] errors reference to the container storing error information
 ...
 * @param[out] errorsInEvent flag indicating whether errors were found in the event
 * @param[in] fedId identifier of the federated unit that produced the data
 * @param[in] header raw header data to be checked
