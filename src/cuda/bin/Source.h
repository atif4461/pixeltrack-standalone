 ...
 *
 * This class provides an interface for producing events and managing the processing workflow.
 * It allows for configuration, starting and stopping of the processing, as well as querying the number of processed events.
