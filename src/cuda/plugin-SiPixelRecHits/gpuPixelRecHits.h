 ...
 * @brief Class providing Si pixel digitization functionality on CUDA devices.
 
 
  * @class SiPixelClustersCUDA
 * @brief Class handling Si pixel cluster data on CUDA devices.
 
 
  * @class TrackingRecHit2DSOAView
 * @brief Class representing tracking rec hit 2D SOA view data structure.
