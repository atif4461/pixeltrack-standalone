...
/**
 * Constructor initializing the object with necessary product registrations
 */ 
 ...
 * @param iEvent the event containing the data to be processed
 * @param es the event setup providing access to the detector conditions
 */ 
