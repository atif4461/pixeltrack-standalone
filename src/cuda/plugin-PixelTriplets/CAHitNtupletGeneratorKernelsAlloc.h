 ...
 * processing on the GPU, including cell neighbors, cell tracks, hit to tuple 
 * mapping, tuple multiplicity, and storage for atomic pair counters.
 *
 * @param stream The CUDA stream on which to perform the allocations.
