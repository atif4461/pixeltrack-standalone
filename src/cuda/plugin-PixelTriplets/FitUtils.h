 ...
 * The input matrix ge has a format where each column represents a set of
 * covariance values for a particular hit or point. The output matrix hits_cov
 * stores these covariance values in a different arrangement.
 *
 * Parameters:
