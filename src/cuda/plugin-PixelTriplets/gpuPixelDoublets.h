 ...
 *
 * @param isOuterHitOfCell array of outer hits of cells to initialize
 * @param nHits total number of hits to process
 * @param cellNeighbors vector of cell neighbors
 * @param cellNeighborsContainer container for cell neighbors
 * @param cellTracks vector of cell tracks
 * @param cellTracksContainer container for cell tracks
 ...
 * @param[in] hhp pointer to TrackingRecHit2DSOAView object
 * @param[in] isOuterHitOfCell pointer to OuterHitOfCell object
