 ...
 * @param hv              The input HitsView object containing hit data.
 * @param hitsInFit       The number of hits used in the fit.
 * @param maxNumberOfTuples The maximum number of tuples to process concurrently.
