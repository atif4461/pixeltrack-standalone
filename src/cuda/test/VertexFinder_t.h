...
/**
 * @brief The gpuVertexFinder class is responsible for finding vertices in a graph.
 
class gpuVertexFinder {
  
};
 * @brief The ZVertices struct represents a set of vertices in 3D space.
 
struct ZVertices {
  
};
 * @brief The WorkSpace struct represents a workspace for vertex finding algorithms.
 
struct WorkSpace {
  
};
 * @brief The Event class represents an event with associated data.
 
class Event {
  
};
 * @brief The ClusterGenerator class generates clusters of points in 3D space.
 
class ClusterGenerator {
  
};
 * @brief The CablingWrapper class wraps around a cabling map object.
