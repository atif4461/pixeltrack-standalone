...
/**
 * @class Product
 * @brief Represents a product entity with associated data and context information
  
 * @class ProductBase
 * @brief Base class for Product providing common functionality
 
 * @class impl ScopedContextGetterBase
 * @brief Helper class for managing scoped context
 
 * @class ScopedContextProduce
 * @brief Class responsible for producing scoped context
 
 * @class edm Wrapper
 * @brief Template class for wrapping EDM products
