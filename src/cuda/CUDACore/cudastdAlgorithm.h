...
/**
 * Finds the lowest iterator pointing to an element that is not less than a given value.
 *
 ...
 * @return Lowest iterator pointing to an element that is not less than the given value.
...
*/ 
  ...
  template <typename RandomIt, typename T, typename Compare = less<T>>
/**
 * Searches for the upper bound of a value within a range.
 *
