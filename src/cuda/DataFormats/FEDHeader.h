 ...
 * @details Provides access to various attributes of the FED header such as 
 *          trigger type, level-1 event number, bunch crossing number, 
 *          source ID, version, and more headers flag
