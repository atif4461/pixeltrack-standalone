 ...
 * If waiting has been completed and an exception occurred, notifies the task holder about the exception.
 ...
 * if their reference count reaches zero or notifies them 
 * of dependent task failure if an exception occurred.
