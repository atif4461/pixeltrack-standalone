...
/**
 * Creates a new wait node with the specified task group and task.
 *
 * @param[in] iGroup  the task group associated with the wait node
 * @param[in] iTask  the task associated with the wait node
 ...
 * otherwise notifies the task that waiting has finished with an exception.
 *
 * @param iTask the task to be added to the list
 */
// The above comment was written by an LLM. 
 ...
 *
 * @param[in] group   The task group that the task belongs to.
...
/**
 * Sets all tasks in the waiting list as failed due to an exception.
 *
 * @param iExcept the exception that caused the failure
 */
// The above comment was written by an LLM. 
...
/**
 * Announces all waiting tasks by executing them or handling exceptions.
 */
// The above comment was written by an LLM. 
