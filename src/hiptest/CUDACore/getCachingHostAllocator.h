...
/**
 * Returns a caching host allocator instance.
 *
 * This function provides access to a caching host allocator object,
 * which manages memory allocation and deallocation on the host.
 * The allocator's settings, such as bin growth, minimum and maximum bin sizes,
 * and minimum cached bytes, are printed to the console if debugging is enabled.
 *
