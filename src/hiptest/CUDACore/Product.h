...
/**
 * @class Product
 * @brief Represents a product entity with associated data
 * @details This class provides a constructor for initializing the product with device, stream, event, and data.
 * It also declares friendships with other classes for accessing its private members.
