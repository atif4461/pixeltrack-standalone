 ...
 * This class represents a container for storing pixel digi errors in a Kokkos environment 
 * It provides functionality for managing and accessing pixel error data 
 * The class includes members for storing error data and formatting errors 
