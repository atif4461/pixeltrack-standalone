 ...
 * @brief Provides a view of tracking rec hits in 2D space with SoA storage
 *
 * This class offers an interface to access and manipulate tracking rec hit data in 2D space,
 * utilizing SoA (Structure of Arrays) storage for efficient memory management.
 * It includes various getter methods for retrieving different types of data such as local and global coordinates,
 * cluster properties, and supporting objects.
