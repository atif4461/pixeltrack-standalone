 ...
 *
 * This class offers an interface to access and manipulate 2D tracking rec hit data stored in SoA format.
 * It includes various getter methods for retrieving different types of data such as local coordinates,
 * global coordinates, cluster properties, and supporting objects.
