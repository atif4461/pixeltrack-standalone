 ...
 * @brief Provides access to tracking rec hit data in a GPU-friendly format
 *
 * This class offers an interface to access tracking rec hit data, including local and global coordinates,
 * cluster properties, and supporting objects, all optimized for GPU usage.
