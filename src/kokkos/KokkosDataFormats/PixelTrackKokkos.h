 ...
 *
 * This class provides a structure of arrays (SoA) implementation for storing and managing tracking data.
 * It includes various components such as quality, chi2, trajectory states, and hit indices.
