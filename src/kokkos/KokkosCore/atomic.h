...
namespace cms::kokkos {
  template <typename T>
/**
 * @brief Performs an atomic fetch and add operation on the destination variable.
 *
 * @param dest Pointer to the destination variable.
 * @param val Value to be added atomically.
 * @return The original value of the destination variable before the addition.
 ...
 *
 * @param dest pointer to the destination variable
 * @param val value to add to the destination variable
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
  ...
  template <typename T>
/**
 * Performs an atomic subtraction operation on a variable.
 *
 * @param dest pointer to the destination variable
 * @param val value to subtract from the destination variable
 * @return the original value of the destination variable
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
*/ 
  ...
  template <typename T>
/**
 * Decrements the value at the specified destination atomically.
 *
 * @param dest pointer to the variable being decremented
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
  ...
  template <typename T>
/**
 * @brief Performs an atomic fetch and minimum operation on a variable.
 *
 * This function atomically retrieves the current value of the variable,
 * replaces it with the minimum of the current value and the given value,
 * and returns the original value.
 *
 * @param dest Pointer to the variable to operate on.
...
*/ 
  ...
  template <typename T>
/**
 * Performs an atomic minimum fetch operation on the specified destination variable.
 *
 * @param dest Pointer to the destination variable.
 * @param val Value to compare with the current value of the destination variable.
 * @return The previous value of the destination variable.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
  ...
  template <typename T>
/**
 * @brief Performs an atomic maximum fetch operation.
 *
 * @param dest Pointer to the destination value.
 * @param val Value to compare with the destination.
 * @return The result of the atomic maximum fetch operation.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
  ...
  template <typename T>
/**
 * Performs an atomic compare exchange operation on a variable.
 *
 * @param dest   pointer to the variable to perform the operation on
 * @param compare value to compare with the current value of dest
 * @param val     new value to store in dest if comparison succeeds
 * @return       the previous value of dest
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
