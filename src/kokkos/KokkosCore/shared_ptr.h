...
*/ 
  ...
  template <typename T, typename MemSpace, typename ExecSpace>
/**
 * @brief Enables creation of a shared pointer for arrays in a specific memory space.
 *
 ...
 *
 * @param src The source shared pointer to create a mirror for.
 * @param execSpace The execution space where the mirror will reside.
 *
