...
/**
 * @brief Function to generate doublets from histogram
 *
 * This function generates doublets from a histogram based on various conditions such as 
 * cluster cut, z0 cut, and pt cut. It uses Kokkos views and parallelization to achieve efficiency.
 *
 * @param layerPairs Array of layer pairs
 * @param nPairs Number of pairs
 * @param cells View of GPUCACell objects
 * @param nCells View of number of cells
 * @param cellNeighbors View of cell neighbors
 * @param cellTracks View of cell tracks
 * @param hh TrackingRecHit2DSOAView object
 * @param isOuterHitOfCell View of outer hits of cells
 * @param phicuts Array of phi cuts
 * @param minz Array of minimum z values
 * @param maxz Array of maximum z values
 * @param maxr Array of maximum r values
 * @param idealCond Flag for ideal condition
 * @param doClusterCut Flag for cluster cut
 * @param doZ0Cut Flag for z0 cut
 * @param doPtCut Flag for pt cut
 * @param maxNumOfDoublets Maximum number of doublets
 * @param stride Stride value
 * @param teamMember Team member object
  
 * @class CablingWrapper
 * @brief Class to manage cabling map
 *
 * This class manages the cabling map and provides methods to access and manipulate it.
 * It uses CUDA managed memory to optimize performance.
  
 * @class SiPixelFedCablingMapGPU
 * @brief Class representing SiPixelFedCablingMap on GPU
 *
 * This class represents the SiPixelFedCablingMap on the GPU and provides methods to access and manipulate it.
