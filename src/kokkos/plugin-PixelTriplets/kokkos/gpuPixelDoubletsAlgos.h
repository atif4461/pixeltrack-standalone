...
/**
 * @brief Function to generate doublets from histograms
 *
 * This function generates doublets from histograms based on various conditions such as 
 * cluster cut, z0 cut, and pt cut. It uses Kokkos views and parallelization to achieve efficiency.
 *
 * @param layerPairs Layer pairs for which doublets need to be generated
 * @param nPairs Number of layer pairs
 * @param cells View of GPUCACell objects to store the generated doublets
 * @param nCells View of number of cells
 * @param cellNeighbors View of cell neighbors
 * @param cellTracks View of cell tracks
 * @param hh TrackingRecHit2DSOAView object containing histogram data
 * @param isOuterHitOfCell View to store indices of outer hits of cells
 * @param phicuts Phi cuts for each layer pair
 * @param minz Minimum z values for each layer pair
 * @param maxz Maximum z values for each layer pair
 * @param maxr Maximum r values for each layer pair
 * @param idealCond Flag indicating whether ideal conditions are applied
 * @param doClusterCut Flag indicating whether cluster cut is applied
 * @param doZ0Cut Flag indicating whether z0 cut is applied
 * @param doPtCut Flag indicating whether pt cut is applied
 * @param maxNumOfDoublets Maximum number of doublets to generate
 * @param stride Stride for parallelization
 * @param teamMember Team member for parallelization
  
 * @class CablingWrapper
 * @brief Class to manage cabling map on GPU
 *
 * This class manages the cabling map on the GPU, providing functionality to allocate and deallocate memory.
  
 * @class SiPixelFedCablingMapGPU
 * @brief Class representing SiPixel Fed Cabling Map on GPU
 *
 * This class represents the SiPixel Fed Cabling Map on the GPU, encapsulating the necessary data structures and functionality.
