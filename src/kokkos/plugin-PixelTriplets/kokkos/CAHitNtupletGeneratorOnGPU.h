 ...
 * @brief Generator of hit n-tuplets on GPU
 * @details This class is responsible for generating hit n-tuplets on the GPU
 *         It provides methods for making tuples and launching kernels
