 ...
 * @param prefix Optional string to be prepended to each output line.
...
/**
 * Loads the 2D covariance matrix from the input 6xN float matrix.
 *
 * @param ge Input 6xN float matrix containing covariance information.
 * @param hits_cov Output 2D matrix to store the loaded covariance.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Brief description: Loads covariance matrix
 *
 * Detailed description: This function loads the covariance matrix from the input ge
 *                     into the output hits_cov. It follows specific indexing rules
 *                     to map the input data onto the output matrix.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * Detailed description: This function transforms the given input parameters 
 * to the perigee plane by applying necessary rotations and transformations.
 *
 * Parameters:
 *   ip  Input vector containing parameters to be transformed
 *   icov Input covariance matrix associated with the input parameters
 *   op  Output vector containing transformed parameters
 *   ocov Output covariance matrix associated with the transformed parameters
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
