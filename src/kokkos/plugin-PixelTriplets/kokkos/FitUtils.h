 ...
 * @param prefix optional string to prepend to each output line
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
    KOKKOS_INLINE_FUNCTION void printIt(C* m, const char* prefix = "") {
#ifdef RFIT_DEBUG
  ...
  */
    ...
    KOKKOS_INLINE_FUNCTION double cross2D(const Vector2d& a, const Vector2d& b) {
...
/**
 * Loads the 2D covariance matrix from a given input matrix.
 *
 * @param ge Input matrix containing covariance information.
 * @param hits_cov Output 2D covariance matrix.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
    KOKKOS_INLINE_FUNCTION void loadCovariance2D(M6xNf const& ge, M2Nd& hits_cov) {
      // Index numerology:
...
/**
 * Brief description: Loads covariance matrix from input ge into output hits_cov.
 *
 * Detailed description: This function takes a 6xN float matrix ge and a 3xN double matrix hits_cov,
 *                  and loads the covariance matrix from ge into hits_cov.
 *
 * Parameters:
 *   ge - Input 6xN float matrix containing covariance information.
 *   hits_cov - Output 3xN double matrix to store loaded covariance.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
    KOKKOS_INLINE_FUNCTION void loadCovariance(M6xNf const& ge, M3xNd& hits_cov) {
      // Index numerology:
      // i: index of the hits/point (0,..,3)
      // j: index of space component (x,y,z)
      // l: index of space components (x,y,z)
  ...
  */
    KOKKOS_INLINE_FUNCTION void par_uvrtopak(circle_fit& circle, const double B, const bool error) {
      Vector3d par_pak;
    ...
    be transformed and particle charge.
  */
    KOKKOS_INLINE_FUNCTION void fromCircleToPerigee(circle_fit& circle) {
      Vector3d par_pak;
      const double temp0 = circle.par.head(2).squaredNorm();
      const double temp1 = sqrt(temp0);
      par_pak << atan2(circle.q * circle.par(0), -circle.q * circle.par(1)), circle.q * (temp1 - circle.par(2)),
...
/**
 * Brief description: Transforms input parameters to perigee plane
 *
 * Detailed description: This function transforms the input parameters ip and icov to the perigee plane,
 *                          resulting in output parameters op and ocov. It uses trigonometric calculations
 *                          to compute the transformation matrix J, which is then applied to the input covariance
 *                          matrix icov to obtain the transformed covariance matrix ocov.
 *
 * Parameters:
 *   ip  - Input parameter vector
 *   icov - Input covariance matrix
 *   op  - Output parameter vector
 *   ocov - Output covariance matrix
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
