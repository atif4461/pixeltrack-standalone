 ...
 * @param[in] event reference to the Event object containing the input data
 * @param[in] setup reference to the EventSetup object providing configuration
 * @param[in,out] waitingTaskHolder WaitingTaskWithArenaHolder object for task management
 */ 
