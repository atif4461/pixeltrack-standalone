 ...
 * @param[in] iEvent the input event data
 * @param[in] iSetup the event setup data
 * @param[in,out] waitingTaskHolder the waiting task holder for asynchronous operations
