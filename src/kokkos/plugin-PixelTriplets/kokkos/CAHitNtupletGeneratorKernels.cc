 ...
 * @param[out] tracks_d Tracks data with hit and detector indices
 ...
 *
 * This function takes in a set of CPU hits, tracks on device memory, and an execution space.
 ...
 * @param tracks_d Tracks on device memory
