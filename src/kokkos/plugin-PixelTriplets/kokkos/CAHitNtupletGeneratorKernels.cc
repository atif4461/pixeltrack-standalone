 ...
 * @param[in] hv Hits view object
 * @param[out] tracks_d Shared pointer to track data structure
 ...
 *
 * This function takes in a set of hits on the CPU, tracks on the device, and an execution space.
 * It launches several kernels to perform tasks such as connecting hits, finding n-tuplets,
 * marking used cells, removing duplicates, counting multiplicities, and filling multiplicities.
 *
 * @param hh Hits on the CPU.
 * @param tracks_d Tracks on the device.
 ...
 *
 * @param[in] hh                Container of hits on CPU
 * @param[out] tracks_d         Shared pointer to tracks data structure on device memory space
...
// The following comment is generated by an LLM. 
/**
 * Prints counters from the provided shared pointer object
