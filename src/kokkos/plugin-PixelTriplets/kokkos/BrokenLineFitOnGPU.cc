...
/**
 * Launches broken line kernels on GPU for helix fit.
 *
 * @param[in] hv               Hits view object containing hit data
 * @param[in] hitsInFit         Number of hits in the fit
 * @param[in] maxNumberOfTuples Maximum number of tuples to process
