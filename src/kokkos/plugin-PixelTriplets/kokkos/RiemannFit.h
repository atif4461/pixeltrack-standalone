 ...
 *
 * @param cov_sz Pointer to the covariance matrices.
 * @param fast_fit Fast fit values.
 * @param s_arcs Arc lengths.
 * @param z_values Z-values.
 * @param theta Angle parameter.
 * @param B Magnetic field strength.
 * @param ret Output matrix containing the computed covariance.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * @param fast_fit input fit parameters
 * @param rad input radii
 * @param B input parameter
 * @return computed scattering covariance radial matrix
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * @return output 2Nx2N covariance matrix in Cartesian coordinates
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
*/
    template <typename M2xN, int N>
/**
 * Calculates the radial covariance of a 2D point given its cartesian coordinates and covariance matrix.
 *
 * @param p2D 2D point coordinates
 * @param cov_cart Cartesian covariance matrix
 * @param rad Radial vector
 * @return Radial covariance vector
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
*/
    template <typename M2xN, typename V4, int N>
/**
 * Calculates the radial component of a covariance matrix from cartesian coordinates.
 *
 * @param p2D input 2D points
...
/**
 * Calculates the charge of a point with respect to a line segment.
 *
 * @param p2D points defining the line segment
 * @param par_uvr point to check
 * @return charge of the point
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Brief description: Fits a circle to a set of 3D hits and calculates the radius and direction of the fitted circle.
 *
 * Detailed description: This function takes a set of 3D hits as input and returns a vector containing the center coordinates and radius of the fitted circle,
 * as well as the direction of the circle in the z-axis.
 *
 * Parameters:
 *   hits - A 3xN matrix where each column represents a 3D hit.
 *   result - A 4-element vector to store the results of the fit.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
private:
  Vector3d parameters_; ///< Parameters of the fitted circle.
  double charge_;     ///< Charge of the fitted circle.
  double chiSquared_; ///< Chi-squared value of the fitted circle.
  Matrix3d covarianceMatrix_; ///< Covariance matrix of the fitted circle.
}; 
 * @brief Function to perform a circle fit.
 * @param hits2D Hits in 2D.
 * @param hitsCov2D Covariances of hits in 2D.
 * @param fastFit Fast fit results.
 * @param rad Radii of the hits.
 * @param B Magnetic field strength.
 * @param error Flag to enable error propagation.
 * @return The result of the circle fit.
 
CircleFitResult circleFit(const M2xN& hits2D, const Matrix2Nd<N>& hitsCov2D, const V4& fastFit, const VectorNd<N>& rad, const double B, const bool error);* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 *
 * This function takes as input a set of points, their geometric uncertainties, a circle fit object, 
 * an initial guess for the line parameters, and a boolean flag indicating whether to compute errors.
 *
 * It returns a line_fit object containing the fitted parameters, their covariance matrix, and the Chi-squared value of the fit.
 *
 ...
 * @param fast_fit Initial guess for the line parameters.
 * @param B Magnetic field strength.
 * @param error Flag indicating whether to compute errors.
 * @return line_fit object containing the fitted parameters, their covariance matrix, and the Chi-squared value of the fit.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @class HelixFit 
 * @brief Performs a helical fit on a set of input data points
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
