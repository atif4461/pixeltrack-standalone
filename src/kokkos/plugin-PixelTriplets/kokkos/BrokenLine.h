 ...
 * and a magnetic field strength, and prepares the broken line data by calculating 
 * various parameters such as q, slope, radii, s, S, Z, and VarBeta.
 *
 * Parameters:
 *   hits (M3xN): Hit data
 *   fast_fit (V4): Fast fit result
 *   B (double): Magnetic field strength
