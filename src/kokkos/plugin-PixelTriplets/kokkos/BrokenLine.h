...
namespace KOKKOS_NAMESPACE {
  ...
  */
    using karimaki_circle_fit = KOKKOS_NAMESPACE::Rfit::circle_fit;
  ...
  */
    KOKKOS_INLINE_FUNCTION double MultScatt(
  ...
  */
    KOKKOS_INLINE_FUNCTION Rfit::Matrix2d RotationMatrix(double slope) {
      Rfit::Matrix2d Rot;
  ...
  */
    KOKKOS_INLINE_FUNCTION void TranslateKarimaki(karimaki_circle_fit& circle,
                                                  double x0,
                                                  double y0,
 ...
 * @param fast_fit Fast fit parameters
...
*/ 
    KOKKOS_INLINE_FUNCTION void prepareBrokenLineData(const M3xN& hits,
                                                      const V4& fast_fit,
                                                      const double B,
 ...
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    KOKKOS_INLINE_FUNCTION Rfit::MatrixNd<N> MatrixC_u(const Rfit::VectorNd<N>& w,
 ...
 *
 * Detailed description: This function implements a fast fitting algorithm to determine the parameters of a circle that best fits a set of 3D points. It uses geometric calculations to derive the center and radius of the circle.
 *
 * Parameters:
 ...
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    KOKKOS_INLINE_FUNCTION void BL_Fast_fit(const M3xN& hits, V4& result) {
...
/**
 * @brief Function to perform a circle fit using the Karimaki algorithm
 *
 * This function takes in various input parameters such as hits, geometric hits, 
 * fast fit results, magnetic field strength, prepared broken line data, and 
 * returns the circle fit results including the charge, parameters, covariance, 
 * and chi-squared value.
 *
 * @param hits Input hits
 * @param hits_ge Geometric hits
 ...
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    KOKKOS_INLINE_FUNCTION void BL_Circle_fit(const M3xN& hits,
                                              const M6xN& hits_ge,
                                              const V4& fast_fit,
                                              const double B,
...
/**
 * @brief Fits a broken line to a set of points in 3D space using a weighted least squares method.
 *
 ...
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    KOKKOS_INLINE_FUNCTION void BL_Line_fit(const M6xN& hits_ge,
                                            const V4& fast_fit,
                                            const double B,
 ...
 *
 * This function takes in a set of 3D points, their geometric errors, and a magnetic field strength,
 * and returns a helix fit object containing the parameters and covariance matrix of the fit.
 *
 * @param hits A 3xN matrix of 3D points
 * @param hits_ge A 6x4 matrix of geometric errors
 * @param B Magnetic field strength
 * @return A helix fit object
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
