...
/**
 * Brief description of the function fishbone
 *
 * Detailed description of the function fishbone
 ...
 * The function iterates over hits and cells, performing calculations and checks to identify and handle doublets
