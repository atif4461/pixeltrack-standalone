...
/**
 * Brief description of fishbone function
 *
 * Detailed description of fishbone function
 * This function appears to be part of a tracking algorithm in a particle physics context
 * It takes several parameters including hit data, cell data, and team member information
 * The function iterates over hits and cells, performing calculations and updating cell data
 * It uses Kokkos parallelization and CUDA-specific functionality
...
*/ 
    KOKKOS_INLINE_FUNCTION void fishbone(
        ...
        const Kokkos::View<uint32_t, KokkosDeviceMemSpace, RestrictUnmanaged>& nCells,  // not used
