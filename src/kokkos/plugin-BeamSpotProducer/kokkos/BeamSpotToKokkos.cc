...
/**
 * Produces a beam spot object and stores it in the event.
 *
 * @param iEvent the event to store the beam spot in
 * @param iSetup the event setup containing the raw beam spot data
 */ 
