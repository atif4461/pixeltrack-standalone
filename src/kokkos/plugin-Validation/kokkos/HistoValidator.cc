...
/**
 * Constructor initializing data members with tokens for consuming various products from the product registry
 */ 
 ...
 * specific to the current Kokkos execution space backend. 
 */ 
