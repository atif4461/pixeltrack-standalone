 ...
 *
 * This class serves as a foundation for tasks that require reference counting and execution.
 * It provides methods for incrementing and decrementing the reference count,
