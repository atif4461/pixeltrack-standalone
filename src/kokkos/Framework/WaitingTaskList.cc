...
/**
 * Creates a new wait node and assigns it to the task group and waiting task.
 *
 * @param iGroup   pointer to the task group
 * @param iTask   pointer to the waiting task
 ...
 * Handles potential concurrent modifications to the list.
 * Cleans up nodes as necessary.
 */
// The above comment was written by an LLM. 
