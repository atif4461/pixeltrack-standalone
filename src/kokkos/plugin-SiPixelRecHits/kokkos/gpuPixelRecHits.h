...
/**
 * @brief Function to calculate hits for pixelCPEforGPU
 *
 * This function takes various parameters such as cpeParams, bs, pdigis, numElements, 
 * pclusters, hits, and teamMember as input and calculates the hits for pixelCPEforGPU.
 *
 * @param cpeParams Parameters for pixelCPEforGPU
 * @param bs Beam spot parameters
 * @param pdigis Pixel digis
 * @param numElements Number of elements
 * @param pclusters Pixel clusters
 * @param hits Hits to be calculated
 * @param teamMember Team member for Kokkos parallelization
