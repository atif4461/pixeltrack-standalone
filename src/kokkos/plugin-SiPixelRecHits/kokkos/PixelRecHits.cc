...
/**
 * Creates tracking rec hits asynchronously using the provided digis, clusters, beam spot, and CPE parameters.
 *
 * @param digis_d SiPixelDigisKokkos object containing digitization data
 * @param clusters_d SiPixelClustersKokkos object containing cluster data
 * @param bs_d BeamSpotKokkos object containing beam spot data
 * @param cpeParams View of pixelCPEforGPU params on the GPU
 * @param execSpace Execution space for the operation
 * @return TrackingRecHit2DKokkos object containing the created hits
 */ 
