 ...
 *
 * @param[in] digis_d SiPixelDigis on the device
 * @param[in] clusters_d SiPixelClusters on the device
 * @param[in] bs_d Beam spot on the device
 * @param[in] cpeParams Parameters for pixel CPE on the GPU
 * @param[in] execSpace Execution space
 *
 * @return TrackingRecHit2D on the device
