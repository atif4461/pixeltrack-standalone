...
/**
 * @class SiPixelRawDataError
 * @brief Represents an error in the raw data of a silicon pixel detector
 * @details This class encapsulates the error information, including the error word, type, and federal ID,
 *          and provides methods to access and manipulate this data.
