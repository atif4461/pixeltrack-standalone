...
/**
 * @class FEDRawData
 * @brief A class representing raw data from a Front End Device (FED).
 *
 * This class provides an interface to store and manipulate raw data from a FED.
 * It includes methods for accessing and modifying the data buffer, as well as
 * resizing the buffer to accommodate different sizes of data.
