 ...
 * @param[out] hits_ge Covariance matrix associated with hits.
 ...
 * @param[in] fast_fit_results initial guess from fast fit
 ...
 *
 * @param[in] hits matrix of hit coordinates
 * @param[out] fast_fit_results fitted parameters
 
 
  * @brief Performs circle fit on the given hits
 *
 * @param[in] hits matrix of hit coordinates
 ...
 * @param[out] circle_fit_results fitted parameters and chi2 value
 
 
  * @brief Performs line fit on the given hits
 *
 * @param[in] hits matrix of hit coordinates
 * @param[in] hits_ge matrix of hit covariance matrices
 * @param[in] fast_fit_results initial guess from fast fit
 * @param[in] B magnetic field strength
 * @param[in] data prepared broken line data
 * @param[out] line_fit_results fitted parameters and chi2 value
 */void testFit() {
