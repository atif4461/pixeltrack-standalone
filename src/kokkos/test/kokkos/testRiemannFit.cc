...
/**
 * @brief Fill hits and hits covariance matrices
 * 
 * This function fills the hits matrix and the corresponding covariance matrix
 * with predefined values depending on the number of columns in the hits matrix.
 *
 * @param hits reference to the hits matrix
 * @param hits_ge reference to the hits covariance matrix
 */ 
...
// The following comment is generated by an LLM. 
/**
 * @brief Tests the fitting functionality of the program.
 *
 * This function generates hits and covariance matrices, performs fast fit, 
 * circle fit, and line fit, and prints out the fitted values and their 
 * corresponding chi-squared values and covariance matrices.
 */ 
void testFit() {
