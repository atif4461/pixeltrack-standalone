 ...
 *
 * This function performs matrix multiplication on host and device,
 ...
 * @brief Tests the inversion of a 3x3 matrix
  ...
  * @brief Computes the inverse of a matrix on the host
  * @brief Copies data from the host to the device
  * @brief Launches a parallel kernel to compute the inverse of a matrix on the device
...
// Not present in this snippet, but presumably defined elsewhere.
 * @brief Computes the inverse of a 4x4 matrix on the host.
 *
 * @param[in]  m    Input matrix.
 * @return     Inverse of the input matrix.
 
// Not present in this snippet, but presumably defined elsewhere as part of the Matrix4d class.
 * @brief Kernel function to compute the inverse of a 4x4 matrix on the device.
 *
 * @param[out] mret  Output matrix containing the inverse.
 * @param[in]  m    Input matrix.
 
// The lambda function passed to Kokkos parallel_for is: * @brief Kernel function to compute the inverse of a 4x4 matrix on the device.
 *
 * @param[in]  i    Thread index (not used).
 */ 
void testInverse4x4() {
 ...
 * 
 * @param[in]  d_m    Input matrix.
 * @param[out] d_mret Inverse of input matrix.
 */ 
void testInverse5x5() {
 ...
 *
 * Initializes Kokkos scope guard and executes various tests
 *
