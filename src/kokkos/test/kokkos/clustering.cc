...
### void test() * @brief Tests the functionality of various clustering algorithms.
 *
 * This function initializes several arrays and views, launches kernels for counting modules,
 * finding clusters, and applying charge cuts. It also performs assertions and prints results for verification.
 */void test() {
