...
/**
 * @brief Test function for clustering algorithm
 *
 * This function tests the clustering algorithm by generating clusters, launching kernels, 
 * and verifying the results.
 
void test()
 * @brief Lambda function to generate clusters
 *
 * This lambda function generates clusters based on the input parameter kn.
 *
 * @param kn Input parameter to control cluster generation
 
auto generateClusters = [&](int kn)
 * @brief Kernel launch for counting modules
 *
 * This kernel launches the countModules function on the device.
 *
 ...
 * @brief Kernel launch for finding clusters
 *
 * This kernel launches the findClus function on the device.
 *
 * @param i Thread index
 ...
 * @brief Function to perform charge cut
 *
 * This function performs the charge cut operation on the clusters.
 *
 * @param d_id View of cluster IDs
 * @param d_adc View of ADC values
 * @param d_moduleStart View of module start indices
 * @param d_clusInModule View of cluster sizes in modules
