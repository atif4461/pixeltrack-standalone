...
1. `test` * @brief Tests the functionality of various clustering algorithms.
 *
 * This function initializes variables, generates clusters, launches kernels, 
 * and verifies the results.
  


2. `generateClusters` * @brief Generates clusters based on input parameters.
 *
 * This function creates artificial data points that form clusters, including 
 * big noise, isolated points, and complex patterns.
 *
 * @param kn Input parameter controlling cluster generation.
  


3. `countModules` * @brief Counts modules in the given data.
 *
 * This function iterates over the input data and counts the number of modules.
 *
 * @param d_id Module IDs.
 * @param d_moduleStart Starting indices of modules.
 * @param d_clus Cluster assignments.
 * @param n Total number of elements.
 * @param i Index of current element.
  


4. `findClus` * @brief Finds clusters in the given data.
 *
 * This function uses parallel processing to identify clusters in the input data.
 *
 * @param d_id Module IDs.
 * @param d_x X-coordinates.
 * @param d_y Y-coordinates.
 * @param d_moduleStart Starting indices of modules.
 * @param d_clusInModule Number of clusters per module.
 * @param d_moduleId Module IDs.
 * @param d_clus Cluster assignments.
 * @param n Total number of elements.
...
5. `clusterChargeCut` * @brief Applies charge cuts to the clusters.
 *
 * This function filters out low-charge clusters from the input data.
 *
 * @param d_id Module IDs.
 * @param d_adc ADC values.
 * @param d_moduleStart Starting indices of modules.
 * @param d_clusInModule Number of clusters per module.
 * @param d_moduleId Module IDs.
 * @param d_clus Cluster assignments.
