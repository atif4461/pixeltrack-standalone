...
/**
 * @brief Loads a covariance matrix from a vector of standard deviations.
 *
 * @param[in] e Vector of standard deviations.
 * @return Diagonalized covariance matrix with off-diagonal elements calculated based on input vector.
 */ 
 ...
 * @param vts View of tensor states in the Kokkos execution space
 * @param i Index of the tensor state to be tested
 */ 
