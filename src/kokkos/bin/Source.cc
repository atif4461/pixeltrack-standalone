 ...
 * @return Collection of FED raw data objects populated with data from the stream
 */
 ...
 * @param runForMinutes duration to run in minutes
 * @param reg ProductRegistry reference
