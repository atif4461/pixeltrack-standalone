...
class Source {
   ...
   *
   * Initializes the source with the specified parameters.
   * @param maxEvents The maximum number of events to process.
   * @param runForMinutes The duration in minutes for which the processing should run.
   ...
   * @param reg The product registry.
   * @return A unique pointer to the produced event.
