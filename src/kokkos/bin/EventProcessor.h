 ...
 *
 * It provides methods for running the event processing to completion and ending the job.
 *
 * The class takes in various parameters such as maximum number of events, run time, 
 * number of streams, file paths, ES producers, and data directory during construction.
