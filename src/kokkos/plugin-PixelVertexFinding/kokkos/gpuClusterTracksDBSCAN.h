 ...
 * 
 * This function performs density-based spatial clustering of applications with noise 
 * on a set of tracks. It takes into account various parameters such as minimum number 
 * of neighbors, maximum absolute distance, maximum error, and maximum normalized distance.
 * 
 * @param vdata View of track data
 * @param vws View of workspace data
 * @param minT Minimum number of neighbors required for a point to be considered a core point
 * @param eps Maximum absolute distance between points in a cluster
 * @param errmax Maximum error allowed for a point to be considered a core point
 * @param chi2max Maximum normalized distance between points in a cluster
...
/**
 * @brief Function to perform DBSCAN clustering on tracks in host memory
 * 
 * @param vdata View of ZVertices in memory space with restrict unmanaged memory
 * @param vws View of WorkSpace in memory space with restrict unmanaged memory
