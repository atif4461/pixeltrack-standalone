...
/**
 * @brief Clusters tracks using the DBSCAN algorithm
 *
 * This function takes in input data and parameters for the DBSCAN algorithm and
 * outputs clustered tracks. It utilizes Kokkos for parallelization and
 * executes on the specified execution space.
 *
 * @param vdata Input data containing track information
 * @param vws Workspace containing additional track data
 ...
 * @param team_member Team member object providing access to shared memory and team information
...
/**
 * @brief Clusters tracks using DBSCAN algorithm on the host
 * 
 * @param vdata input vertices data
 * @param vws input workspace data
 * @param minT minimum number of neighbors to be considered a seed point
 * @param eps maximum absolute distance to cluster
 * @param errmax maximum error to be considered a seed point
