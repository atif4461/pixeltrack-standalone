 ...
 *
 * This function takes in several parameters including vertex data, workspace, maximum Chi2 value, 
 * and team member information. It iterates over each vertex, checks certain conditions, 
 * and splits the vertex into two new ones if necessary.
 *
...
/**
 * Brief description of function splitVerticesKernel 
 * Detailed description of function splitVerticesKernel 
 * @param vdata 
 * @param vws 
 * @param maxChi2 
 * @param team_member 
