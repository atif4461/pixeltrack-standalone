...
/**
 * @brief Function to cluster tracks by density
 * 
 * This function takes in several parameters including vertex data, workspace, minimum number of neighbors, 
 * maximum absolute distance to cluster, maximum error to be a seed, and maximum normalized distance to cluster.
 * It uses Kokkos parallelization to efficiently cluster tracks based on their density.
 * 
 * @param vdata Vertex data
 * @param vws Workspace
 * @param minT Minimum number of neighbors to be a seed
 * @param eps Maximum absolute distance to cluster
 * @param errmax Maximum error to be a seed
 * @param chi2max Maximum normalized distance to cluster
 * @param team_member Team member for Kokkos parallelization
...
/**
 * Brief description of function clusterTracksByDensityKernel 
 * Detailed description of function clusterTracksByDensityKernel 
 * @param[in] vdata 
 * @param[in] vws 
 * @param[in] minT 
 * @param[in] eps 
 ...
 * 
 * This function clusters tracks by density using the DBSCAN algorithm
 * 
