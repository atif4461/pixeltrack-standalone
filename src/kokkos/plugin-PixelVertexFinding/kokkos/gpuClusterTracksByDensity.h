 ...
 *
 * This function takes in various parameters such as vertex data, workspace, minimum number of neighbors,
 * maximum absolute distance to cluster, maximum error to be considered a seed, and maximum normalized distance to cluster.
 * It uses Kokkos parallelization to efficiently process the data and perform clustering.
 *
 * @param vdata Vertex data
 * @param vws Workspace
 * @param minT Minimum number of neighbors to be considered a seed
 * @param eps Maximum absolute distance to cluster
 * @param errmax Maximum error to be considered a seed
 ...
 * 
 * This function performs track clustering based on density
 * 
 * @param vdata input vertices data
 * @param vws input workspace data
 * @param minT minimum number of neighbors required for seeding
