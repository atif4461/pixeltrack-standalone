...
/**
 * Loads tracks into workspace based on certain conditions.
 * @param[in] tracks Container of tracks in Structure of Arrays format
 * @param[in] soa Vertex data in Structure of Arrays format
 * @param[out] ws Workspace containing loaded track data
 * @param[in] ptMin Minimum transverse momentum required for loading
 * @param[in] idx Index of the track to be loaded
 */ 
 ...
 * @param[out] hdata host-side output data
 ...
 * @param[in] vdata input data containing vertices
 * @param[in] vws workspace for the algorithm
 * @param[in] minT minimum number of neighbors required to seed a cluster
 * @param[in] eps maximum absolute distance to consider two points part of the same cluster
 * @param[in] errmax maximum error allowed for a point to be considered part of a cluster
 * @param[in] chi2max maximum normalized distance for a point to be considered part of a cluster
 * @param[in] execSpace execution space for parallel operations
 * @param[in] teamPolicy policy for team-based parallel execution
 */ 
...
// The following comment is generated by an LLM. 
/**
 * @brief Performs parallel computation on GPU to find vertices
 * @param[in] vdata Input data for vertex finding
 * @param[in] vws Workspace for vertex finding
 * @param[out] hdata Output data for vertex finding
 * @param[in] execSpace Execution space for parallel computation
 * @param[in] teamPolicy Team policy for parallel computation
 */ 
 ...
 * 
 * @param[in] tksoa_ptr pointer to TrackSoA object
 * @param[in] ptMin minimum transverse momentum
 * @param[in] execSpace execution space
 * 
 * @return shared pointer to ZVertexSoA object
 */ 
