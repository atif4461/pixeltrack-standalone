 ...
 * @param[in] soa Vertex information in Structure of Arrays format
 * @param[out] ws Workspace containing loaded track information
 * @param[in] ptMin Minimum transverse momentum required for loading tracks
 * @param[in] idx Index of the track being processed
 ...
 * @param[in] errmax maximum error to consider a seed point
 ...
 * @param[out] hdata host data for sorting
 * @param[in] execSpace execution space for parallel operation
 * @param[in] teamPolicy team policy for parallel operation
 ...
 * 
 * @param[in] tksoa_ptr pointer to TrackSoA data structure
 * @param[in] ptMin minimum transverse momentum
 * @param[in] execSpace execution space
 * 
 * @return pointer to produced ZVertexSoA data structure
