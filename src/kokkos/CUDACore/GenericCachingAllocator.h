 ...
 * of varying sizes it provides methods for allocating and deallocating
 * memory blocks and caches recently deallocated blocks to improve performance
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Comparison function for two block descriptors based on their pointers.
 *
 * @param a First block descriptor to compare.
 * @param b Second block descriptor to compare.
 * @return True if the pointer of a is less than the pointer of b, false otherwise.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Attempts to reuse a cached block that matches the specified search key.
 *
 * @param searchKey The descriptor of the block to search for.
 * @return A pointer to the reused block, or nullptr if no matching block was found.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Frees cached memory blocks associated with a specific device.
 *
 * This function releases memory allocated for cached blocks on a specified device,
 * ensuring that the corresponding events are also properly destroyed.
 *
 * @details Iterates over the cache, identifies blocks belonging to the target device,
 * and frees their memory while updating internal tracking metrics.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Frees all cached memory blocks.
 *
 * This function releases all cached memory blocks, freeing their associated memory and destroying their ready events.
 * It also updates the cache statistics accordingly.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
  void freeAllCached() {
    std::scoped_lock lock(mutex_);
