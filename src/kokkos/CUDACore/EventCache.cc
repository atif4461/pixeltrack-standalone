 ...
 *
 * @return A shared pointer to an event with completed captured work.
 ...
 * creating one if necessary, with timing disabled for performance optimization */  SharedEventPtr EventCache::makeOrGet(int dev) {
