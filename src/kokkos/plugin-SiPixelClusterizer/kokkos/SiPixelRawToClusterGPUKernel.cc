...
// The following comment is generated by an LLM. 
/**
 * Returns raw detector identifier based on fed, link and roc from the cabling map
...
// The following comment is generated by an LLM. 
/**
 * @brief Returns error type based on status and optional debug output
 * @param[in] fedId Front end id
 * @param[in] status Status code indicating error type
 * @param[in] debug Optional flag for debug output
...
// The following comment is generated by an LLM. 
/**
 * @brief Checks the type of error in the given error word
 ...
 * @param debug Flag to enable debugging print statements
 ...
 * @param[in] cablingMap A mapping of pixel Fed cabling.
...
// The following comment is generated by an LLM. 
/**
 * Fills the hits per module start array with cumulative sum of cluster starts.
 *
 * @param[in]     cluStart         Array of cluster starts.
 * @param[out]    moduleStart     Array to store cumulative sum of cluster starts.
