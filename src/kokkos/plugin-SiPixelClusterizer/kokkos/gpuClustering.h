...
/**
 * Counts modules in a given range and updates module start indices accordingly.
 *
 * @param id View of module identifiers
 * @param moduleStart View of module start indices
 * @param clusterId View of cluster identifiers
