...
/**
 * Counts modules in a given range.
 *
 * @param[in] id View of module identifiers
 * @param[out] moduleStart View of starting indices of modules
 * @param[out] clusterId View of cluster identifiers
 * @param[in] numElements Number of elements to process
 * @param[in] index Current processing index
