 ...
 *
 * This function takes in various views of pixel data, such as module ids, adcs, and cluster ids,
 * and performs a charge cut on the clusters. It uses Kokkos parallelization and shared memory
 * to efficiently process the data.
 *
 * @param id View of module ids for each pixel
 * @param adc View of local coordinates of each pixel
 * @param moduleStart View of indices of the first pixel of each module
