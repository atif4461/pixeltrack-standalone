...
/**
 * @brief Function to perform cluster charge cut on pixel data
 * 
 * This function takes in various views of pixel data, such as module ids, 
 * adcs, and cluster ids, and performs a charge cut on the clusters.
 * It uses Kokkos parallelization to speed up the computation.
 * 
 * @param id View of module ids of each pixel
 * @param adc View of local coordinates of each pixel
 * @param moduleStart View of index of the first pixel of each module
 * @param nClustersInModule View of number of clusters found in each module
 * @param moduleId View of module id of each module
 * @param clusterId View of cluster id of each pixel
 * @param numElements Total number of elements
 * @param teamPolicy Team policy for Kokkos parallelization
 * @param execSpace Execution space for Kokkos parallelization
