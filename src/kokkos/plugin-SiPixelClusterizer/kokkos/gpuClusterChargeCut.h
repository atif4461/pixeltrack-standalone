...
/**
 * @brief Function to perform cluster charge cut on GPU
 *
 * This function takes in various views and parameters related to clustering and performs
 * charge cutting on the GPU. It uses Kokkos parallelization and shared memory to achieve
 * high performance.
 *
 * @param id View containing module IDs of each pixel
 * @param adc View containing local coordinates of each pixel
 * @param moduleStart View containing index of the first pixel of each module
 * @param nClustersInModule View to store the number of clusters found in each module
 * @param moduleId View to store the module ID of each module
 * @param clusterId View to store the cluster ID of each pixel
 * @param numElements Total number of elements to process
 * @param teamPolicy Team policy for Kokkos parallelization
