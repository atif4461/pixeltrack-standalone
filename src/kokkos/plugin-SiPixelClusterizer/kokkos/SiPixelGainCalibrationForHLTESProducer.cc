...
/**
 * @brief Produces SiPixelGainCalibration data for HLT ES producer
 *
 * Reads binary file containing gain calibration data,
 * decodes and copies it into device memory views,
 * and stores the result in the EventSetup.
