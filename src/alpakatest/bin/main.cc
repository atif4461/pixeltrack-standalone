 ...
 * and stores it in the provided variable, exiting with error message if argument is missing */ 
 ...
 * @param numStreams Number of concurrent event streams
 * @param alternates Alternating event processing configuration
 * @param esmodules Vector of ES module names
 * @param dataDir Path to data directory
 * @param useEmpty Whether to use empty events
