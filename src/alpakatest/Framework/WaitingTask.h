#ifndef Framework_WaitingTask_h
#define Framework_WaitingTask_h
// -*- C++ -*-
//
// Package:     Concurrency
// Class  :     WaitingTask
...
/**
 * Class representing a waiting task that depends on another task.
 * Provides functionality for handling exceptions thrown by the dependent task.
...
*/ 
  ...
  */
  ...
  template <typename F>
/**
 * @brief Functor waiting task class
 * @details This class represents a functor waiting task which executes a given function
 * @note The function is executed with an exception pointer as argument
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
