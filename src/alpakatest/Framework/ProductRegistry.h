...
namespace edm {
  ...
  public:
    ...
    template <typename T>
/**
 * Produces a token for a given product type and registers it in the internal map.
 *
 * @return A unique token identifier for the produced product type.
 *
 * @throws std::runtime_error If a product of the same type already exists.
