 ...
 * @param[in] task    the task associated with the node
 ...
 * If the wait has already completed due to an exception, notifies the task immediately.
 * Otherwise, adds the task to the linked list of waiting tasks and potentially announces the completion of the wait.
