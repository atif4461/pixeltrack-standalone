...
namespace edm {
/**
 * Brief description of WaitingTaskList class.
 *
 * Detailed description of WaitingTaskList class.
 * The WaitingTaskList is responsible for managing a list of tasks that are waiting to be executed.
 * It provides methods to add tasks to the waiting list, signal that the resource is available and tasks should be spawned,
 * and reset access to the resource so that added tasks will wait.
