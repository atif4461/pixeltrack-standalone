...
/**
 * Retrieves an event from the specified device, waiting for completion if necessary.
 *
 * @param dev Device to retrieve the event from
 * @return Shared pointer to the retrieved event
