 ...
 *
 * This class represents a container for storing and managing raw data from various Front End Devices (FEDs).
 * It provides methods for accessing and manipulating the data, as well as swapping the contents with another instance.
