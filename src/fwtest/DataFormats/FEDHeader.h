...
/**
 * @class FEDHeader
 * @brief Represents an FED header containing event metadata
 * @details Provides accessors for various event attributes such as trigger type, level-1 ID, 
 *          bunch crossing ID, source ID, and version, as well as methods for checking 
