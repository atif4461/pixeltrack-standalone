 ...
 * If an exception has occurred, notifies the task immediately.
 * Otherwise, inserts the task at the front of the wait list.
 */
// The above comment was written by an LLM. 
...
/**
 * Announces all waiting tasks in the list and executes them accordingly.
 */
// The above comment was written by an LLM. 
