 ...
 * creating one if it does not exist, with nonblocking behavior enabled.*/
// The above comment was written by an LLM. 
...
/**
 * Resets the contents of the caches while keeping a holder alive for each device
 */
// The above comment was written by an LLM. 
...
/**
 * Returns the stream cache instance providing thread safe access 
 */
// The above comment was written by an LLM. 
