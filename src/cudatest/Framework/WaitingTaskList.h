 ...
 * Constructor for WaitingTaskList setting the initial size of the cache.
 ...
 * @param iPtr Exception pointer in case a task failed, null otherwise.
 
 * Resets access to the resource so added tasks will wait again.
 
 * Private method handling the spawning of tasks, safe for multi-threaded access.
 
 * Struct representing a node in the waiting list, containing a task and its associated task group.
  
 * Method creating a new node for the waiting list.
 * @param iGroup Task group associated with the task.
 * @param iTask Task to be contained in the new node.
 * @return Pointer to the newly created node.
  
 * Sets the next node in the linked list.
 * @param iNext Node to be set as the next one.
