...
*/ 
    ...
    template <typename F>
/**
 * Brief description of the function makeOrGet
 *
 * Detailed description of the function makeOrGet which creates or retrieves 
 * a shared pointer of type T using the provided function iFunc until it succeeds
 *
 * @param iFunc input function used to create a unique instance of type T
 ...
 * The maker function is used to create a new instance when none exists
 * The clear function is used to reset the retrieved instance
 *
 * @param iMakeFunc The function used to create a new instance
 * @param iClearFunc The function used to clear the contents of the retrieved instance
 * @return A shared pointer to the retrieved or created instance
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
