 ...
 *
 * Detailed description of function makeOrGetAndClear which creates 
 * or retrieves and clears a shared pointer of type T
 *
 * @param iMakeFunc Function to create unique instance of type T
