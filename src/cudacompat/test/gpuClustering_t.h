...
```cpp * @brief Main function that tests the clustering algorithm.
 *
 * This function generates test data, runs the clustering algorithm, and verifies the results.
 
int main(void)
 * @brief Lambda function to generate clusters.
 *
 * This function generates test clusters with varying characteristics.
 *
 * @param kn The type of cluster to generate.
 
auto generateClusters = [&](int kn) 
 * @brief Function to count modules.
 *
 * This function counts the number of modules in the input data.
 *
 * @param id The input data.
 * @param moduleStart The output module start indices.
 * @param clus The output cluster assignments.
 * @param n The number of elements in the input data.
 
void countModules(h_id.get(), h_moduleStart.get(), h_clus.get(), n);
 * @brief Function to find clusters.
 *
 * This function finds clusters in the input data.
 *
 * @param id The input data.
 * @param x The x-coordinates of the input data.
 * @param y The y-coordinates of the input data.
 * @param moduleStart The module start indices.
 * @param clusInModule The output cluster sizes per module.
 * @param moduleId The output module IDs.
 * @param clus The output cluster assignments.
 * @param n The number of elements in the input data.
 
void findClus(h_id.get(), h_x.get(), h_y.get(), h_moduleStart.get(), h_clusInModule.get(), h_moduleId.get(), h_clus.get(), n);
 * @brief Function to apply a charge cut to the clusters.
 *
 * This function applies a charge cut to the clusters and updates the cluster assignments.
 *
 * @param id The input data.
 * @param adc The ADC values of the input data.
 * @param moduleStart The module start indices.
 * @param clusInModule The cluster sizes per module.
 * @param moduleId The module IDs.
 * @param clus The output cluster assignments.
 * @param n The number of elements in the input data.
