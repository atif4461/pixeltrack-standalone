 ...
 * @brief A wrapper class for managing GPU memory and providing async access to cabling map data.
 
class CablingWrapper {
  //...
};
 * @class gpuClustering
 * @brief A namespace containing functions for clustering algorithms on the GPU.
 
namespace gpuClustering {
  //...
};
 * @class cms
 * @brief A namespace containing classes and functions for CMS-related functionality.
 
namespace cms {
     * @class cudatest
   * @brief A class containing utility functions for CUDA testing.
  ...
  namespace cudatest {
     ...
     * @class cuda
   * @brief A namespace containing classes and functions for CUDA-specific functionality.
