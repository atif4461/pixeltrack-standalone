 ...
 * @param[in] triggerType type of trigger that occurred
 * @param[in] lvl1ID level one identifier
 * @param[in] bxID bunch crossing identifier
 * @param[in] sourceID source identifier
 * @param[in] version version number
 * @param[in] moreHeaders flag indicating whether there are more headers to follow
 */
