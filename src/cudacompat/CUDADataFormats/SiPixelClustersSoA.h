...
/**
 * @brief Class representing a Structure of Arrays for silicon pixel clusters.
 *
 * This class provides a container for storing and managing silicon pixel cluster data,
 * including module start indices, cluster counts, module IDs, and cluster start indices.
 * It offers various getter methods for accessing the stored data and a setter method for setting the number of clusters.
