 ...
 *
 * This class provides methods for managing and accessing silicon pixel cluster data,
 * including setting and retrieving the number of clusters, and getting pointers to
 * various arrays containing cluster information.
