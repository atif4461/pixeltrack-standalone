...
template <typename Traits>
/**
 * Constructor for TrackingRecHit2DHeterogeneous class.
 * Initializes member variables with input parameters and creates unique pointers for views and average geometry store.
 * If number of hits is zero, copies or moves view to device memory depending on traits type.
 *
 * @param nHits Number of hits
 * @param cpeParams Parameters for pixelCPEforGPU
 * @param hitsModuleStart Array of hit module starts
