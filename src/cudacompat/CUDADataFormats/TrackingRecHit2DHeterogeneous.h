 ...
 *
 * Initializes the object with the specified number of hits, 
 * parameters for pixel CPE, and start indices of hits per module.
 *
 * @param nHits The total number of hits.
 * @param cpeParams Parameters for pixel CPE on the GPU.
 * @param hitsModuleStart Start indices of hits per module.
