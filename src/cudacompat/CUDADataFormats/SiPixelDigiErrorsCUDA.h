...
/**
 * @brief Class representing digital errors in the SiPixel digitization process on CUDA devices.
 *
 * This class provides functionality for handling digital errors during the SiPixel digitization process,
 * utilizing CUDA devices for efficient computation. It offers methods for accessing error data,
 * transferring error data between host and device, and managing memory resources.
