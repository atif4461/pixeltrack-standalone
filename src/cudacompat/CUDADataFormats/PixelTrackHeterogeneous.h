...
/**
 * @class TrackSoAT
 * @brief Structure of Array implementation for tracking data
 * @details This class represents a collection of tracking data 
 *          stored in a Structure of Arrays format, optimized for 
 *          efficient memory access and computation on GPUs.
