...
/**
 * Constructor initializing data structures with specified maximum number of FED words.
 * @param maxFedWords Maximum number of FED words to allocate memory for.
 */
