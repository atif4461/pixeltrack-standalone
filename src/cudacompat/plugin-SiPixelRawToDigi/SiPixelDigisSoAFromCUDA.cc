...
/**
 * Acquires data from CUDA for the specified event and setup.
 *
 * @param iEvent the event to acquire data for
 * @param iSetup the event setup to use
 * @param waitingTaskHolder the waiting task holder to manage the acquisition process
 */ 
