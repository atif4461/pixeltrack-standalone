 ...
 *
 * @param src The source 1x1 matrix to invert.
 * @param dst The destination 1x1 matrix to store the inverted result.
...
*/ 
    ...
    template <typename M1, typename M2>
/**
 * Inverts a 3x3 matrix using LU decomposition.
 *
 * @param src The input 3x3 matrix to be inverted.
 * @param dst The output 3x3 matrix containing the inverse of src.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    ...
    template <typename M1, typename M2>
/**
 * Inverts a 4x4 matrix using LU decomposition.
 *
 * @param src The input 4x4 matrix to be inverted.
 * @param dst The output 4x4 matrix containing the inverse of src.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    ...
    template <typename M1, typename M2>
/**
 * Inverts a 5x5 matrix using LU decomposition.
 *
 * @param src The input matrix to be inverted.
 * @param dst The output inverted matrix.
 
inline constexpr void invert55(M1 const& src, M2& dst) {...}* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    ...
    template <typename M1, typename M2>
/**
 * Inverts a 6x6 matrix using LU decomposition.
 *
 * @param src The input matrix to be inverted.
 * @param dst The output inverted matrix.
 
inline __attribute__((always_inline)) constexpr void invert66(M1 const& src, M2& dst)* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    ...
    template <typename M>
/**
 * Symmetrizes a 3x3 matrix.
 *
 * @param dst the input matrix to be symmetrized
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    ...
    template <typename M>
/**
 * Symmetrizes a 4x4 matrix.
 *
 * This function takes a 4x4 matrix M as input and modifies it in place to make it symmetric.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    ...
    template <typename M>
/**
 * Brief description of symmetrize55 function
 *
 * This function takes a matrix M as input and performs symmetrization operation
 * It first calls the symmetrize44 function and then updates specific elements
 * to ensure symmetry
 *
 * @param[in,out] dst The input matrix to be symmetrized
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
    ...
    template <typename M>
/**
 * Symmetrizes a 6x6 matrix by copying elements from the lower triangle to the upper triangle
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Brief description: Evaluates the input matrix and produces output
 * Detailed description: This function takes two matrices as input, 
 * performs inversion and symmetrization operations on them and stores 
 * the result in the destination matrix.
 *
 * Parameters:
 *   src - The source matrix to be evaluated
 *   dst - The destination matrix where the result is stored
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Brief description: Evaluates the input matrix src and stores the result in dst.
 *
 * Detailed description: This function takes a constant reference to a matrix M1 as input,
 * performs inversion and symmetrization operations on it, and stores the resulting matrix in M2.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
      static constexpr void eval(M1 const& src, M2& dst) {
        invert33(src, dst);
 ...
 * Brief description: Evaluates the input matrix src and stores the result in dst.
 *
 * Detailed description: This function takes two matrices as input, src and dst. It first inverts the matrix src and stores the result in dst. Then it symmetrizes the resulting matrix stored in dst.
 *
 * Parameters:
 *   src - The input matrix to be evaluated.
 *   dst - The output matrix where the result is stored.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
      static constexpr void eval(M1 const& src, M2& dst) {
        invert44(src, dst);
...
/**
 * Brief description of function eval 
 * Detailed description of function eval 
 * Evaluates the input src and stores result in dst after applying transformations
 * Parameters:
 * src Input value of type M1
 * dst Output value of type M2
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
      static constexpr void eval(M1 const& src, M2& dst) {
        invert55(src, dst);
...
/**
 * Brief description: Evaluates and transforms input data
 *
 * Detailed description: This function takes two matrices as input, 
 * applies inversion and symmetrization operations to produce output
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
      static constexpr void eval(M1 const& src, M2& dst) {
        invert66(src, dst);
...
/**
 * Brief description: Function to invert a dense base matrix
 *
 * Detailed description: This function takes two dense base matrices as input,
 * src and dst, where src is the source matrix to be inverted and dst is the destination
 * matrix to store the result. It uses the Inverter class to perform the inversion.
 *
 * Parameters:
