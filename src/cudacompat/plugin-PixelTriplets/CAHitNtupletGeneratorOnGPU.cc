 ...
 *
 * Initializes member variables and allocates memory for counters based on whether 
 * the generator is running on GPU or not.
 *
...
// The following comment is generated by an LLM. 
/**
 * Destructor for the class, responsible for freeing allocated resources.
 * If running on GPU, frees counters memory and prints statistics if required.
 * If running on CPU, deletes counters object and prints statistics if required.
 */ 
...
// The following comment is generated by an LLM. 
/**
 * Generates tuples asynchronously on the GPU.
 *
...
// The following comment is generated by an LLM. 
/**
 * @brief Generates tuples of tracking hits on the GPU.
 *
 * @param hits_d The input tracking hits on the CPU.
 * @param bfield The magnetic field strength.
 * @return A unique pointer to the generated pixel tracks.
 */ 
