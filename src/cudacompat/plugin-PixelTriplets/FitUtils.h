 ...
 * @param prefix an optional string to prepend to each output line
...
/**
 * Loads covariance from general error matrix into hits covariance matrix.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * Detailed description: This function transforms input vector ip and covariance matrix icov
 *                   from one plane to the perigee plane and stores the result in output vector op and
 *                   covariance matrix ocov.
 *
 * Parameters:
 *   ip  - Input vector to be transformed
 *   icov - Input covariance matrix to be transformed
 *   op  - Output vector after transformation
 *   ocov - Output covariance matrix after transformation
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
