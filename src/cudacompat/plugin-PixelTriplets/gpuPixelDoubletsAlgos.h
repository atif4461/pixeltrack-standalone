 ...
 * cell neighbors, cell tracks, tracking rec hit data, and several boolean flags.
 ...
 * @param isOuterHitOfCell Data to store outer hits of cells.
 * @param phicuts Phi cuts data.
 * @param minz Minimum z values.
 * @param maxz Maximum z values.
 * @param maxr Maximum radius values.
 * @param idealCond Boolean flag for ideal condition.
 * @param doClusterCut Boolean flag to apply cluster cut.
 * @param doZ0Cut Boolean flag to apply z0 cut.
 * @param doPtCut Boolean flag to apply pt cut.
