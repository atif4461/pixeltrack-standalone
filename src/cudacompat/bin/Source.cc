 ...
 * @param nfeds Number of FEDs in input stream
 ...
 * @param reg product registry instance
 ...
 * @param maxEvents maximum number of events allowed
...
/**
 * Starts the processing of the source data when run duration is specified
 */
// The above comment was written by an LLM. 
