 ...
 * It allows for configuration of event production parameters such as maximum number of events,
 * running time, and output directories. Additionally, it offers methods for starting and stopping
 * event processing, as well as querying the number of processed events.
