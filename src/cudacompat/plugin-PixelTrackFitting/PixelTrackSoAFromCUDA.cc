...
/**
 * Acquires pixel track data from CUDA event and sets up the necessary context.
 *
 ...
 *
 * @param iEvent The event object where the produced data will be stored.
 * @param iSetup The event setup object containing configuration information.
 */ 
