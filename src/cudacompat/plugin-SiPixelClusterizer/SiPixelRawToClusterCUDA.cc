 ...
 * data, performs error checking, and produces pixel clusters using the GPU
 * algorithm. The resulting clusters and digis are stored in the event.
 *
 * @param iEvent The event containing the raw data.
 * @param iSetup The event setup providing additional information.
