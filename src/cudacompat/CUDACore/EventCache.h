...
/**
 * @class EventCache
 * @brief Manages a cache of CUDA events for efficient reuse across different devices.
 *
 * Provides thread-safe access to cached CUDA events, ensuring that each event is properly cleaned up after use.
