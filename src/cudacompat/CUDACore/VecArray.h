...
/**
 * Class Vector 
 * Brief description A dynamic array like class with a fixed maximum size 
 * Detailed description This class provides methods to add elements at the end of the vector 
 ...
 * without performing any checks, potentially leading to undefined behavior if the container is already full
 *
 * @param args Variable number of arguments to be forwarded to the constructor of the element type
