 ...
 *
 * This class provides a way to launch a kernel on a GPU.
 
class KernelLauncher {
   * @brief Launches a kernel on a GPU.
 *
 ...
 * @param config The launch parameters.
 * @param args The kernel arguments.
 
launch(std::enable_if_t<std::is_invocable_r<void, F, Args&&...>::value>); 
 ...
 *
 * This function launches a cooperative kernel on the GPU, allowing for more flexible and efficient execution of kernels.
 *
 * @tparam F The type of the kernel function to launch.
 * @tparam Args The types of the arguments to pass to the kernel function.
 *
 * @param kernel The pointer to the kernel function to launch.
