...
/**
 * @brief Launches a CUDA kernel with the specified configuration and arguments.
 *
 * This function launches a CUDA kernel with the specified launch parameters and arguments.
 * It uses SFINAE to enable the function only if the kernel function is invocable with the given argument types.
 *
 ...
 *
 * This function launches a cooperative kernel on the GPU, allowing for more flexible and efficient execution of parallel tasks.
 *
 * @tparam F The type of the kernel function to be launched.
 * @tparam Args The types of the arguments to be passed to the kernel function.
 *
 * @param kernel A pointer to the kernel function to be launched.
 * @param config The launch parameters for the kernel.
