...
*/ 
    ...
    template <typename T>
/**
 * @brief Creates a unique selector for unbounded array on host memory.
 *
 * This function allocates memory on the host using cudaHostAlloc and returns a unique selector
 * for an unbounded array of the specified type. It ensures that the allocated memory has trivial
 * constructors to prevent issues with non-trivial construction on pinned host memory.
 *
