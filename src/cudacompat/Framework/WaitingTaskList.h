 ...
 * Private helper method to spawn waiting tasks, safe to call from multiple threads.
 ...
 * Creates a new node in the linked list with the given task group and task.
 
 * Data members of the WaitingTaskList, including the head of the linked list,
 * a cache of nodes, an exception pointer, and flags to track the state of the list.
