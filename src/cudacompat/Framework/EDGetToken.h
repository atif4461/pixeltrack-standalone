 ...
 *
 * This class provides a way to access event data through a unique token.
 * It offers functionality to check if the token is uninitialized and to retrieve its index.
