...
/**
 * @class PixelCPEFast
 * @brief A class providing functionality for fast pixel CPE calculations on GPU.
 * @details This class manages the data and parameters required for pixel CPE calculations,
 *          allowing for asynchronous access to the results on both the host and device.
