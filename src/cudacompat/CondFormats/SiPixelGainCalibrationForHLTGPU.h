...
/**
 * @brief Class representing silicon pixel gain calibration for High-Level Trigger on GPU
 * @details Provides functionality for managing gain calibration data on both host and GPU
