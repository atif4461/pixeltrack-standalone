...
/**
 * Brief description: Kernel function for clustering tracks by density.
 *
 * Detailed description: This kernel function wraps the clusterTracksByDensity 
 * function to operate on the GPU, taking in vertex data, workspace, and parameters 
 * for minimum neighbors, maximum absolute distance, maximum error, and maximum 
 * normalized distance to cluster.
 *
 * Parameters:
 *   pdata - pointer to vertex data
 *   pws - pointer to workspace data
 *   minT - minimum number of neighbors required to be a seed
 *   eps - maximum absolute distance to cluster
 *   errmax - maximum error allowed to be a seed
