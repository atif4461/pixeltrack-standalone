...
class gpuVertexFinder {
     ...
     * @brief Structure to hold ZVertices data.
...
class ClusterGenerator {
     ...
     * @param nav Number of average vertices.
   * @param arg Second argument for cluster generation.
...
class Event {
     ...
     * @brief Vector to store z-track data.
   
  std::vector<float> ztrack;
  
     * @brief Vector to store ez-track data.
   
  std::vector<float> eztrack;
  
     * @brief Vector to store pt-track data.
   
  std::vector<float> pttrack;
  
     * @brief Vector to store z-vertex data.
...
class CablingWrapper {
     ...
     * @param cablingMap Reference to the SiPixelFedCablingMapGPU object.
   
  explicit CablingWrapper(const SiPixelFedCablingMapGPU& cablingMap);
