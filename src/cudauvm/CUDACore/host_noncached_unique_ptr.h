...
namespace cms {
   ...
   */
    template <typename T>
/**
 * @brief Creates a unique selector for allocating non-cached host memory.
 *
 ...
 *
 * This function allocates memory on the host using cudaHostAlloc and returns 
 * a unique selector for an unbounded array of type T.
 *
