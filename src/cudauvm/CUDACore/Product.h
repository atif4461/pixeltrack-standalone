...
/**
 * @class Product
 * @brief Represents a product entity with associated data and context
 * @details This class provides a constructor for creating products and manages the underlying data
 * @note This class has deleted copy constructor and assignment operator to prevent copying
