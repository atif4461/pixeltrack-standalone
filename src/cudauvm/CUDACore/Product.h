...
/**
 * @class Product
 * @brief Represents a product entity with associated data and metadata
  
 * @class CablingWrapper
 * @brief Manages the memory and data transfer for SiPixelFedCablingMapGPU objects
  
 * @class PortableCollections
 * @brief Handles buffer allocation and layout initialization for data storage and transfer
