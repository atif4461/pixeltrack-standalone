 ...
 *
 * Provides a thread-safe interface for obtaining and releasing CUDA events,
 * ensuring that events are properly cleaned up when no longer needed.
  
 * @class Deleter
 * @brief Custom deleter for CUDA events.
 *
 * Responsible for freeing CUDA event resources when they are removed from the cache.
