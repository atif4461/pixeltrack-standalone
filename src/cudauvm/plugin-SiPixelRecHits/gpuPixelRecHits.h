 ...
 * @brief Class containing parameters and methods for pixel CPE on GPU
  
 * @class BeamSpotPOD
 * @brief Class representing beam spot parameters
 
 * @class SiPixelDigisCUDA
 * @brief Class handling silicon pixel digitizer data on CUDA devices
 
 * @class SiPixelClustersCUDA
 * @brief Class handling silicon pixel cluster data on CUDA devices
 
 * @class TrackingRecHit2DSOAView
 * @brief Class providing a view of 2D tracking rec hit data in Structure-of-Arrays format
  
 * @struct ClusParams
 * @brief Struct holding cluster parameters
