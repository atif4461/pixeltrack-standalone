...
/**
 * Constructor initializing the wrapper with a cabling map and a vector of unsigned chars.
 * Allocates managed memory for the cabling map and the vector, copies the input data into it,
 * and advises the devices to set the allocated memory as read mostly.
 * Additionally, prefetches the allocated memory asynchronously for each device.
 */ 
 ...
 * Releases allocated memory on the GPU
 */ 
