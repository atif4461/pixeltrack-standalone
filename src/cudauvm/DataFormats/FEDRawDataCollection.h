 ...
 *
 * This class represents a container for storing and managing raw data from different Front End Devices (FEDs).
 * It provides methods for accessing and manipulating the data for each FED.
