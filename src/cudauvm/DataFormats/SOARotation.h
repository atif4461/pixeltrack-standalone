...
public:
  ...
  template <typename U>
/**
 * Constructor for SOARotation class 
 * Creates a rotation from a given TkRotation object
 * @param a TkRotation object to initialize from
 ...
 *
 * @param vx Local x coordinate
 * @param vy Local y coordinate
 * @param vz Local z coordinate
 * @param ux Global x coordinate output
 * @param uy Global y coordinate output
 * @param uz Global z coordinate output
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * @param vx Local x coordinate
 * @param vy Local y coordinate
 * @param ux Global x coordinate
 * @param uy Global y coordinate
 * @param uz Global z coordinate
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Function to transform a tensor from local coordinates to global coordinates
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Brief description: Transforms a global tensor to local coordinates.
 *
 * Detailed description:
 * This function transforms a global tensor represented by the input parameters
 * into local coordinates. It uses rotation matrix operations to achieve this.
 *
 * Parameters:
 *   ge - Global tensor components
 *   lxx - Local xx component
 *   lxy - Local xy component
 *   lyx - Not used in calculation but present for symmetry
 *   lyy - Local yy component
 *
 * Returns: None
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
