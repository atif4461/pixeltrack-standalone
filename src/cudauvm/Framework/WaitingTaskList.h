 ...
 * Provides methods for adding tasks to the list, signaling that the resource is available,
 * and resetting the list to make tasks wait again.
  
 * Constructor for WaitingTaskList, initializing the list with a specified initial size.
 * @param iInitialSize Initial size of the cache used to hold waiting tasks.
 ...
 * Alternative method for adding a task to the waiting list.
 * @param iTaskHolder Holder containing the task to be added.
 
 * Signals that the resource is now available and tasks should be spawned,
 * allowing waiting tasks to access the resource.
 * @param iPtr Exception pointer indicating whether an error occurred.
 
 * Resets access to the resource, making added tasks wait again.
 
 * Private method for handling the spawning of tasks, safe to call from multiple threads.
 
 * Struct representing a node in the waiting list, containing a task and its associated task group.
 * Provides methods for setting and getting the next node in the list.
