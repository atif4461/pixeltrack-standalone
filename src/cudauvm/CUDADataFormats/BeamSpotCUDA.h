 ...
 *
 * It offers constructors for creating instances with or without specifying
 * a CUDA stream, as well as methods for accessing the underlying data.
 *
 * The class also supports moving and assigning instances, but copying is deleted.
