 ...
 *
 * This class provides access to the data members of the 2D tracking rec hits
 * with SoA (Structure of Arrays) storage. It offers various getter methods
 * to retrieve the hit data, such as local and global coordinates, errors,
 * charges, cluster sizes, and detector indices.
