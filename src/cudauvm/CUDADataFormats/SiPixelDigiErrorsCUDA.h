...
/**
 * @brief Class representing silicon pixel digitization errors in CUDA.
 *
 * This class provides functionality for handling silicon pixel digitization errors
 * in a CUDA environment. It includes methods for accessing error data,
 * copying error data to host memory, and prefetching error data asynchronously.
