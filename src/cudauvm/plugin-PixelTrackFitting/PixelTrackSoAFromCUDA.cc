...
/**
 * Acquires pixel track data from CUDA event.
 *
 * @param iEvent EDM event object
 * @param iSetup EDM event setup object
 * @param waitingTaskHolder Waiting task holder for asynchronous operations
 */ 
