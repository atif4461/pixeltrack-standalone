 ...
 * @brief Class representing a structure of arrays.
 *
 * This class provides a way to manage and access data stored in structures of arrays.
 
class SoA {
};
 * @brief Class representing a track.
 *
 * This class encapsulates the data and functionality related to tracks.
 
class TkSoA {
};
 * @brief Class representing a vertex.
 *
 * This class encapsulates the data and functionality related to vertices.
 
class ZVertexSoA {
};
 * @brief Class representing a heterogeneous collection of vertices.
 *
 * This class provides a way to manage and access collections of vertices.
