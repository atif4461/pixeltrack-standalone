...
/**
 * @brief Loads tracks into the SoA data structure.
 *
 * This function takes in a pointer to an array of tracks, a pointer to an SoA,
 * a workspace pointer, and a minimum transverse momentum threshold.
 * It iterates over the tracks, filters out those with insufficient hits or quality,
 * and loads the remaining tracks into the SoA data structure.
 *
 * @param ptracks Pointer to an array of tracks.
 * @param soa Pointer to the SoA data structure.
