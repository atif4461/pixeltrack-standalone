 ...
 * @param reg Reference to edm ProductRegistry for consuming and producing data products
 */ 
 ...
 * @param iSetup The event setup providing access to various configurations and data.
