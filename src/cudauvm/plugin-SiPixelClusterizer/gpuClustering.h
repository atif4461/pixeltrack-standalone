...
/**
 * Counts modules in an array of IDs and updates module start indices accordingly.
 *
 * @param id input array of IDs
 ...
 *
 * This kernel function takes in various arrays of input data, including module ids, 
 * local coordinates, and indices of the first pixel of each module. It outputs the 
 * number of clusters found in each module, the module id of each module, and the 
 * cluster id of each pixel.
 *
 * The function iterates over each pixel in the module, skipping invalid pixels, 
 * and finds the nearest neighbors to each pixel. It then assigns a cluster id to 
 * each pixel based on its nearest neighbors and propagates this id to all pixels 
 * in the same cluster.
 *
