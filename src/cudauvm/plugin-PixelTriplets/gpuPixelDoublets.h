...
/**
 * Initializes the doubles data structures on the GPU.
 *
 ...
 * @param cellNeighborsContainer pointer to cell neighbors container
 * @param cellTracks pointer to cell tracks vector
 * @param cellTracksContainer pointer to cell tracks container
