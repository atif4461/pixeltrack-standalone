 ...
 * @param rad_lengths output array of radiation lengths
...
/**
 * Brief description: Computes scatter covariance line for tracking algorithm.
 *
 * Detailed description:
 *   This function calculates the scatter covariance line used in particle tracking algorithms.
 *   It takes several parameters including covariance matrices, fit values, arc lengths, 
 *   and material properties, and returns the computed covariance matrix.
 *
 * Parameters:
 *   cov_sz     - Array of 2D matrices representing covariance at each point
 *   fast_fit   - 4-element vector containing fit results
 *   s_arcs     - Vector of arc length values
 *   z_values   - Vector of z-values
 *   theta     - Rotation angle
 *   B         - Magnetic field strength
 *   ret       - Output covariance matrix
 *
 * Returns:
 *   None, output is stored in ret parameter
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * Parameters:
 *   hits - input 3D hits
 *   result - output 4D vector containing fit results
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
