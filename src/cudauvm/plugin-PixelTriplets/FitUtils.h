...
/**
 * Loads 2D covariance from input matrix ge into output matrix hits_cov.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Brief description: Loads covariance into hits_cov matrix.
 *
 * Detailed description: This function takes two matrices as input, ge and hits_cov.
 * It maps the elements from ge to hits_cov according to specific rules defined by indices i, j, and l.
 * The resulting hits_cov matrix contains the loaded covariance values.
 *
 * Parameters:
 *   ge - Input matrix containing covariance values.
 *   hits_cov - Output matrix where covariance values will be loaded.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * to the perigee plane and stores the result in op and ocov. It uses trigonometric
 * calculations to compute the transformation.
 *
 * Parameters:
 *   ip - Input vector
