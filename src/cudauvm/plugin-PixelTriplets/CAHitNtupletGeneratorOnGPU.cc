 ...
 * Allocates memory for counters based on whether processing is done on GPU or not
 */
// The above comment was written by an LLM. 
...
/**
 * Destructor freeing resources allocated for hit ntuplet generation 
 */
// The above comment was written by an LLM. 
 ...
 * @param hits_d Tracking Rec Hit 2D data on device
