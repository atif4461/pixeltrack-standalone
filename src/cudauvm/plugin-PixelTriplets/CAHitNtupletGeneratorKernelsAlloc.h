 ...
 * during the hit ntuplet generation process, including cell neighbors,
 * cell tracks, hit to tuple mapping, tuple multiplicity, and storage
 * for atomic pair counters.
 *
 * @param stream The CUDA stream on which the allocation is performed.
