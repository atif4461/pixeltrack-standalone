 ...
 * including cell neighbors, cell tracks, hit to tuple mapping, tuple multiplicity,
 * and storage for atomic pair counters.
  
 * Brief description of CAHitNtupletGeneratorKernelsCPU class
 *
 * This class provides an alternative implementation for CPU-based allocation
 * of intermediate results when GPU acceleration is not available.
