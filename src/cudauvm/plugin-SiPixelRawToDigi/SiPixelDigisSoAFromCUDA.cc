...
/**
 * Acquires digitization data from CUDA and stores it in member variables.
 *
 * @param iEvent Event object containing information about the event being processed.
 * @param iSetup Event setup object providing configuration details.
 * @param waitingTaskHolder Waiting task holder for managing concurrent tasks.
 */ 
 ...
 *
 * @param iEvent The event to store the produced digis in.
