 ...
 * the file name, line number, CUDA command, error message, and optional
 * description. It also provides the current stack trace before throwing a 
...
/**
 * Checks the result of a CUDA operation and aborts with an error message if it fails.
 *
...
/**
 * Checks the result of a CUDA operation and aborts on error.
 *
 * @param file         The source file where the check was performed.
 * @param line         The line number in the source file.
 * @param cmd          The command that triggered the check.
 * @param result       The result of the CUDA operation.
