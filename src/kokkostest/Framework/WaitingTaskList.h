 ...
 * Provides methods for adding tasks to the waiting list, signaling that the resource is available,
 * and resetting access to the resource.
  
 * Class representing a node in the waiting list, containing a task and its associated task group.
 * Allows for efficient management of tasks in the waiting list.
 
 * Class representing a holder for waiting tasks, allowing for concurrent additions to the waiting list.
  
 * Exception pointer used to handle failures in tasks, ensuring proper error handling and propagation.
  
 * Policy for managing the waiting list, including adding tasks, signaling resource availability, and resetting access.
  
 * Interface for interacting with the waiting list, providing methods for adding tasks and managing resource access.
  
 * Implementation of the waiting list, responsible for spawning tasks when the resource becomes available.
  
 * Cache for nodes in the waiting list, optimizing performance by reducing dynamic memory allocation.
  
 * Index tracking the last assigned cache position, enabling efficient cache management.
  
 * Flag indicating whether the waiting list is currently waiting for the resource to become available.
