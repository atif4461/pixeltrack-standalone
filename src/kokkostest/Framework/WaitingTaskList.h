 ...
 * Constructor for WaitingTaskList, initializes the list with an optional initial size.
 ...
 * @param iTask task to be added to the list.
 ...
 * @param iPtr pointer to an exception that occurred while waiting for the resource.
