...
/**
 * @class FEDRawData
 * @brief Represents raw data from a Front End Device (FED)
 *
 * This class provides a container for storing and manipulating raw data
 * from a Front End Device. It includes functionality for accessing and
 * modifying the data, as well as resizing the data buffer.
