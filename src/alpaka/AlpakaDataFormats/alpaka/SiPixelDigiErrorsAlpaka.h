...
/**
 * Brief description: Class representing digital errors in the SiPixel module using Alpaka.
 *
 * Detailed description: This class manages digital errors in the SiPixel module,
 * providing functionality for handling and storing error data on both host and device.
 * It utilizes Alpaka's buffer management capabilities to efficiently manage memory.
