...
/**
 * Brief description of SiPixelDigiErrorsAlpaka class 
   * Detailed description of SiPixelDigiErrorsAlpaka class 
 * This class represents a digital error handler for pixel digis using Alpaka.
 * It manages device and host buffers for storing pixel error compact data,
 * provides methods for accessing and manipulating the error data,
 * and supports asynchronous data transfer between device and host.
