 ...
 * @param queue The queue used for allocating device memory.
  * Move constructor.
  * Deleted copy constructor to prevent copying.
  * Move assignment operator.
  * Deleted copy assignment operator to prevent copying.
  * Returns a pointer to the beam spot data.
 * @return Pointer to the beam spot data.
  * Returns a constant pointer to the beam spot data.
 * @return Constant pointer to the beam spot data.
  * Returns a reference to the device buffer.
 * @return Reference to the device buffer.
  * Returns a constant reference to the device buffer.
 * @return Constant reference to the device buffer.
  * Device buffer storing the beam spot data.
