 ...
 * @brief Manages Alpaka buffers for storing silicon pixel cluster data.
 *
 * This class provides an interface for working with Alpaka buffers that store
 * silicon pixel cluster data. It includes methods for setting and getting the
 * number of clusters, accessing the buffer data, and creating a device const view.
