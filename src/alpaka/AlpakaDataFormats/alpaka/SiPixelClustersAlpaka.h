 ...
 * @brief Manages pixel cluster data on Alpaka devices
 *
 * This class provides an interface to manage pixel cluster data on Alpaka devices.
 * It includes methods to set and retrieve the number of clusters, access module start,
 * cluster counts, module IDs, and cluster module starts.
