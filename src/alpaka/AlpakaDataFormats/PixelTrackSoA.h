...
/**
 * @class TrackSoAT
 * @brief Structure of Array implementation for track data
 * @details Provides storage and accessor methods for track-related data,
 * including quality, chi2 values, trajectory states, and hit indices.
 * @note Designed for efficient memory access and manipulation on GPUs.
