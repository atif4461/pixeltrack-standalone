 ...
 *
 * This class provides an interface to access and manipulate tracking rec hit data
 * in a Structure of Arrays format, optimized for GPU acceleration.
 *
 * It includes methods for accessing local and global coordinates, errors,
 * cluster properties, and supporting objects such as average geometry and
 * CPE parameters.
