 ...
 * @brief Provides a Structure-of-Arrays view for tracking rec hits in 2D
 *
 * This class provides an interface for accessing and manipulating tracking rec hit data
 * in a Structure-of-Arrays format, optimized for GPU acceleration.
 *
 * It includes methods for accessing local and global coordinates, errors, charges,
 * cluster sizes, detector indices, and other related data.
 *
 * Additionally, it provides access to supporting objects such as average geometry and
 * histogram data.
