 ...
 * @param minT minimum number of neighbors required to seed
 ...
 *
 * This function takes in track data, a minimum transverse momentum threshold, and a queue as input.
 * It initializes device buffers for vertices and workspace, sets up work divisions for various tasks,
 * and enqueues kernel launches for loading tracks, finding and sorting vertices, splitting and fitting vertices,
 * and sorting by pT.
 *
