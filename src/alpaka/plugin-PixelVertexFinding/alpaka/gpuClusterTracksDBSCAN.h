...
/**
 * @brief This is a functor that implements the DBSCAN clustering algorithm.
 
class DBScanFunctor {
     * @brief Operator that performs the DBSCAN clustering.
   *
   * @param acc Accelerator object
   * @param pdata Pointer to vertex data
   * @param pws Pointer to workspace data
   * @param minT Minimum number of neighbors to consider a point as a core point
  ...
  void operator()(const TAcc& acc, ZVertices* pdata, WorkSpace* pws, int minT, float eps, float errmax, float chi2max) const;
