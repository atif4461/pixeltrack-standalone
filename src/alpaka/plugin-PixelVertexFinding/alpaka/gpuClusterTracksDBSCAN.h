...
/**
 * @brief Operator function for performing clustering operations on input data.
 *
 ...
 * and maximum normalized distance to cluster. It performs various operations
 * such as filling histograms, counting neighbors, finding nearest points,
 * consolidating graphs, and propagating cluster IDs.
 *
 * @param acc Accelerator object
 * @param pdata Pointer to vertex data
 * @param pws Pointer to workspace data
 * @param minT Minimum number of neighbors to be considered a core point
