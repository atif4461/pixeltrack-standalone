...
/**
 * @brief Class representing the DBSCAN clustering algorithm implementation on GPU.
 *
 * This class contains the main function that performs the DBSCAN clustering algorithm
 * on the GPU. It takes into account various parameters such as minimum number of neighbors,
 * maximum absolute distance to cluster, maximum error to be seed, and maximum normalized
 * distance to cluster.
