...
/**
 * @brief Class representing a clustering algorithm for vertex finding.
 *
 * This class contains the implementation of the DBSCAN clustering algorithm
 * for identifying vertex candidates in a set of tracks.
 ...
 * the cabling map data, which is essential for the vertex finding process.
