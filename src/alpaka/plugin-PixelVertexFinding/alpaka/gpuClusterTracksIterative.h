...
/**
 * @brief Class representing the DBSCAN clustering algorithm implementation.
 *
 * This class contains the implementation of the DBSCAN clustering algorithm, 
 * which groups a set of points into clusters based on their density and proximity.
