...
void printHelp(stdString arg0)
 * @brief Get optional command line argument
 *
...
void getOptionalArgument(stdVectorStdString args, stdVectorStdStringIterator i, float& weight)
 * @brief Get required command line argument
 *
 * @param args Vector of command line argument strings
 * @param i Iterator to current argument
 * @param value Reference to store parsed value
 
void getArgument(stdVectorStdString args, stdVectorStdStringIterator i, int& value)
 ...
 * @param runForMinutes Running time in minutes
 ...
 * @param validation Enable validation flag
 
edmEventProcessor::EventProcessor(int warmupEvents, int maxEvents, int runForMinutes, int numberOfStreams, stdMovealternatives, stdMovelstOfEsModules, stdFileSystemPath datadir, bool validation)
 * @brief Warm up the event processor
 
void edmEventProcessoreventProcessorwarmUp()
 * @brief Run the event processor to completion
 
void edmEventProcessoreventProcessorrunToCompletion()
 * @brief End the event processor job
 
void edmEventProcessoreventProcessorEndJob()
 * @brief Get the number of processed events
 *
 * @return Number of processed events
 
int edmEventProcessorgetProcessedEvents()
 * @brief Get the list of backends and their corresponding stream counts
 *
 * @return Map of backends to stream counts
 
stdMapBackendInt edmEventProcessorgetBackends()*/ 
int main(int argc, char** argv) {
