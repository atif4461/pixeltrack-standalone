 ...
 * @param numberOfStreams Total number of data streams to be used for event processing
 * @param alternatives List of alternative configurations with their respective weights
 * @param esproducers Vector of strings representing names of event setup producers
 * @param datadir File system path where data is stored
 * @param validation Flag indicating whether validation mode is enabled
