...
/**
 * @brief Function object for histogram accumulation
 *
 * This function object accumulates values into a histogram
 * It takes an accelerator, a histogram, number of bins, values and offsets as input
 * and performs the accumulation operation
