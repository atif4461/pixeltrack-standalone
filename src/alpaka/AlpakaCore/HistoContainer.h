...
/**
 * @brief Functor for accumulating histogram data from input values.
 *
 * This functor is designed to work with the Alpaka accelerator model,
 * providing a way to accumulate histogram data from input values.
