...
/**
 * Brief description of the class Product
 *
 * Detailed description of the class Product
 
class Product  * @brief Constructor for Product
 * @details Default constructor for Product
  * @brief Copy constructor for Product
 * @details Deleted copy constructor for Product to prevent copying
  * @brief Move constructor for Product
 * @details Default move constructor for Product
  * @brief Assignment operator for Product
 * @details Deleted assignment operator for Product to prevent copying
  * @brief Move assignment operator for Product
 * @details Default move assignment operator for Product
  * @var data_
 * @brief Data member variable of type T
