...
/**
 * Constructor for initializing the PixelTrackSoAFromAlpaka class
 * Initializes the device token and host token for consuming and producing data
 * Creates a host buffer for storing track data in StructureOfArrays format
 */ 
 ...
 * @param waitingTaskHolder Waiting task holder for asynchronous operation
 */ 
