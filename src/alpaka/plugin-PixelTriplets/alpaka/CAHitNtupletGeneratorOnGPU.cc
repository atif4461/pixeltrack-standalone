 ...
 * @param hits_d input collection of 2D tracking rec hits
 * @param bfield magnetic field strength
 * @param queue execution queue for asynchronous operations
 * @return generated pixel track data structure
