...
/**
 * @brief Operator function for fitting broken lines to sets of hits
 *
 * This function takes in various parameters related to the hits and their properties,
 * and performs a fit to determine the best broken line that represents the set of hits.
 *
 ...
 * @param hhp Object containing hit properties
 * @param phits Array of doubles for storing hit information
 * @param phits_ge Array of floats for storing geometric error information
 * @param pfast_fit Array of doubles for storing fast fit results
...
*/ 
  ...
  struct kernelBLFit {
    template <typename TAcc>
/**
 * Brief description: Operator function for fitting broken lines.
 *
 * Detailed description: This function performs a fit of broken lines to a set of hits
 *                       in a detector. It takes into account the multiplicity of the hits,
 *                       the magnetic field strength, and the output container for the results.
 *
 * Parameters:
 *   acc             - Accelerator object
 *   tupleMultiplicity - Tuple multiplicity array
 *   B                - Magnetic field strength
 *   results         - Output container for the fit results
 *   phits           - Array of hits
 *   phits_ge        - Array of geometric hits
 *   pfast_fit       - Array of fast fit parameters
