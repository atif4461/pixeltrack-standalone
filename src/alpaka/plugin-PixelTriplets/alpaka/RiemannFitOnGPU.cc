...
/**
 * Launches Riemann kernels on the GPU for helix fit calculation.
 *
 * @param hv              Hits view object containing hit data
 * @param nhits           Number of hits to process
 * @param maxNumberOfTuples Maximum number of tuples to process concurrently
 * @param queue           Queue object for executing tasks on the GPU
 */ 
