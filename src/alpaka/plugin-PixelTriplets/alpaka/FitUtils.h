...
/**
 * Loads the covariance matrix from the input ge matrix.
 *
 * @param ge Input matrix containing the covariance elements.
 * @param hits_cov Output matrix to store the loaded covariance.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *                          following specific indexing rules defined within the comments above.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * This function transforms the input parameters to the perigee plane.
 * It calculates the output parameters op and ocov based on the input parameters ip and icov.
 * The transformation involves trigonometric calculations and matrix operations.
 *
 * Parameters:
