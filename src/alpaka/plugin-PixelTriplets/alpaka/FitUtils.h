 ...
 * @param prefix optional string to prefix each output line
...
/**
 * Brief description: Loads covariance into 2D format
 * Detailed description: This function takes a 6xN float matrix and an NxN diagonal matrix,
 *                  loads the covariance from the input matrix into the output diagonal matrix.
 * Parameters:
 *   ge - Input 6xN float matrix containing covariance information
 *   hits_cov - Output NxN diagonal matrix to store loaded covariance
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Brief description: Loads covariance from input matrix ge into output matrix hits_cov.
 *
 * Detailed description: This function maps the input matrix ge onto the output matrix hits_cov,
 *                          performing necessary index calculations to ensure correct placement of values.
 *
 * Parameters:
 *   ge - Input matrix containing covariance values.
 *   hits_cov - Output matrix to store loaded covariance values.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 *                     and stores the result in op and ocov. It calculates the sine and cosine of theta
 *                     from the input parameter ip and uses them to compute the output parameters.
 *
 * Parameters:
 *   ip  - Input vector
