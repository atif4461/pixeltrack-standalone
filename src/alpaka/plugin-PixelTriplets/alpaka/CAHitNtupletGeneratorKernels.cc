 ...
 * @param[in]  hv              constant reference to hits view
 * @param[out] tracks_d         pointer to track data structure
 * @param      queue           command queue for task execution
 */ 
 ...
 * and an OpenCL queue. It launches several kernels to perform tasks such as:
 * - Zeroing tuples
 * - Connecting hits
 * - Finding n-tuplets
 * - Removing duplicates
 * - Counting multiplicities
 * - Finalizing bulk data
 *
 * The function also performs some error checking and debugging operations.
 *
 ...
 * @param[out] queue             Command queue for GPU operations
 */ 
 ...
 *
 * @param[in] hh                Container of hits on CPU
 * @param[out] tracks_d         Array of track data structures on GPU
