...
/**
 * Brief description: Operator function for calculating outer hits of cells
 * Detailed description: This function calculates the outer hits of cells 
 *                 in a grid and stores them in the isOuterHitOfCell array. It also 
 *                 constructs and initializes cell neighbors and tracks data structures.
 * Parameters:
 *   acc - The accelerator object
 *   isOuterHitOfCell - Array to store outer hit information
 *   nHits - Number of hits
 *   cellNeighbors - Vector of cell neighbor data
 *   cellNeighborsContainer - Container for cell neighbor data
 *   cellTracks - Vector of cell track data
 *   cellTracksContainer - Container for cell track data
...
*/ 
  ...
  __launch_bounds__(getDoubletsFromHistoMaxBlockSize, getDoubletsFromHistoMinBlocksPerMP)
    ...
    struct getDoubletsFromHisto {
      template <typename TAcc>
/**
 * @brief Function object for accumulating data from histogram hits
 *
 * This function object accumulates data from histogram hits and generates
 * doublets based on certain conditions such as cluster cut, Z0 cut, and Pt cut.
 *
 * @param acc Accumulator object
 * @param cells Array of GPU CA cells
 * @param nCells Number of cells
 * @param cellNeighbors Vector of neighboring cells
 * @param cellTracks Vector of tracks associated with cells
 * @param hhp Pointer to tracking rec hit 2D SoA view
 * @param isOuterHitOfCell Outer hit status of each cell
 * @param nActualPairs Actual number of pairs
 * @param ideal_cond Flag indicating ideal condition
 ...
 * @param maxNumOfDoublets Maximum number of doublets allowed
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
      ALPAKA_FN_ACC void operator()(const TAcc& acc,
                                    GPUCACell* cells,
