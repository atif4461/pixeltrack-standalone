 ...
 *                 in a grid-strided manner and resets the corresponding 
 *                 cell neighbors and tracks containers.
 * Parameters:
 *   acc - The accelerator object
 *   isOuterHitOfCell - Array of outer hit flags for each cell
 *   nHits - Number of hits
 *   cellNeighbors - Container for storing neighboring cells
 *   cellNeighborsContainer - Underlying container for cell neighbors
 *   cellTracks - Container for storing track information
 *   cellTracksContainer - Underlying container for cell tracks
 ...
 * @param cellTracks 
 * @param hhp 
 * @param isOuterHitOfCell 
 * @param nActualPairs 
 * @param ideal_cond 
 * @param doClusterCut 
 * @param doZ0Cut 
 * @param doPtCut 
 * @param maxNumOfDoublets 
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
      ALPAKA_FN_ACC void operator()(const TAcc& acc,
                                    GPUCACell* cells,
