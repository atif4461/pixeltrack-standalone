...
/**
 * @brief Operator function for handling GPU cell data
 *
 * This function operates on the input data structures and performs various operations
 * such as checking track validity, calculating distances, and identifying doublets
 *
 * @param acc Accelerator object
 * @param hhp Pointer to hit data
 * @param cells Array of cell objects
 * @param nCells Number of cells
 * @param isOuterHitOfCell Array indicating outer hit status
