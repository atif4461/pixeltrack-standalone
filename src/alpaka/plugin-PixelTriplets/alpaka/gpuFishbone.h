...
/**
 * @brief Functor for handling GPU cell operations
 *
 * This functor provides an interface for performing various operations on GPU cells,
 * including data access and manipulation. It serves as a key component in the
 * overall architecture of the system, enabling efficient processing and analysis
 * of cell data on the GPU.
