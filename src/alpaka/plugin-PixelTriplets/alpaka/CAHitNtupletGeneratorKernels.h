...
namespace cAHitNtupletGenerator {
  ...
  struct Params {
/**
 * Constructor for configuring track reconstruction parameters
 * @param onGPU whether to run on GPU
 * @param minHitsPerNtuplet minimum hits per ntuplet
 * @param maxNumberOfDoublets maximum number of doublets
 * @param useRiemannFit whether to use Riemann fit
 * @param fit5as4 whether to fit 5 as 4
 * @param includeJumpingForwardDoublets whether to include jumping forward doublets
 * @param earlyFishbone whether to apply early fishbone
 * @param lateFishbone whether to apply late fishbone
 * @param idealConditions whether to use ideal conditions
 * @param doStats whether to perform statistics
 * @param doClusterCut whether to apply cluster cut
 * @param doZ0Cut whether to apply z0 cut
 * @param doPtCut whether to apply pt cut
 * @param ptmin minimum pt value
 * @param CAThetaCutBarrel barrel cut value for CA theta
 * @param CAThetaCutForward forward cut value for CA theta
 * @param hardCurvCut hard curvature cut value
 * @param dcaCutInnerTriplet inner triplet cut value for DCA
 * @param dcaCutOuterTriplet outer triplet cut value for DCA
 * @param cuts quality cuts object
...
/**
 * @brief Class representing the generator of hit n-tuplets kernels.
 *
 * This class is responsible for generating hit n-tuplets kernels.
 * It allocates memory for intermediate results and initializes them.
 
 
 * @brief Constructor for the CAHitNtupletGeneratorKernels class.
 *
 * Initializes the object with the given parameters, number of hits, and queue.
 * Allocates memory for intermediate results and initializes them.
 *
 * @param params Parameters for the generator.
 * @param nhits Number of hits.
 * @param queue Queue for executing operations.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
