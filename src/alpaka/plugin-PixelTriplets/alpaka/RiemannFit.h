...
/**
 * Computes the covariance matrix of scattered particles along a line.
 *
...
/**
 * Computes the covariance matrix of scattering radii due to material effects.
 *
 * @param p2D input 2D points
 * @param fast_fit fit parameters
 * @param rad vector of radii
 * @param B magnetic field strength
...
class CircleFitResult {
  ...
  const Vector3d& getParameters() const;
  ...
  const Matrix3d& getCovarianceMatrix() const;

 private:
  Vector3d parameters_; ///< Fitted circle parameters
  int charge_; ///< Charge of the circle
  double chiSquared_; ///< Chi-squared value of the fit
  Matrix3d covarianceMatrix_; ///< Covariance matrix of the circle parameters
}; 
