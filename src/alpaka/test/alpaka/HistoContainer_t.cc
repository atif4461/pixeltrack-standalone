...
/**
 * @brief Function to perform various operations on host and device buffers
 * 
 ...
 * @brief Lambda function to increment a value modulo the number of bins
 * 
 * @param k The value to be incremented
 * @return The incremented value
 
auto incr = [](auto& k) { return k = (k + 1) % Hist::nbins(); }

 * @brief Lambda function to verify certain conditions
 * 
 * @param i The first index
 * @param k The second index
 * @param t1 The third index
 * @param t2 The fourth index
 
auto verify = [&](uint32_t i, uint32_t k, uint32_t t1, uint32_t t2)

 * @brief Function to fill many values from a vector
 * 
 * @tparam Acc1D The type of accumulator
 * @param h_d The destination buffer
 * @param nParts The number of parts
 * @param v_d The source buffer
 * @param offsets_d The offset buffer
 ...
 *
 * Initializes the system, selects the first available device,
 * creates a command queue, and executes kernels for int16_t and int8_t types.
 *
