...
/**
 * @brief Function to perform operations on a device queue
 * 
 ...
 *
 * @param device Device associated with the command queue
  
 * @brief Performs operation on host data of type T using the specified device and queue
 *
 * @tparam T Type of data being processed
 * @param host Host data to be processed
 * @param device Device used for processing
 * @param queue Command queue used for processing
 */int main() {
  initialise();
