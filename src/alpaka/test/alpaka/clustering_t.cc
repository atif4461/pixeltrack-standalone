...
void initialise()
 * @brief Gets the device at the specified index.
 *
 * @param index Index of the device to retrieve.
 * @return The device at the specified index.
 
const Device device = devices<Platform>().at(0)
 * @brief Creates a queue for the specified device.
 *
 * @param device The device for which to create the queue.
 
Queue queue(device)
 * @brief Generates clusters based on the input parameters.
 *
 * @param kn Input parameter influencing cluster generation.
 
auto generateClusters = [&](int kn)
 * @brief Copies data from the source buffer to the destination buffer.
 *
 * @param queue The queue handling the memory transfer.
 * @param src The source buffer.
 * @param dst The destination buffer.
 * @param numElements The number of elements to transfer.
 
alpaka::memcpy(queue, d_moduleStart, nModules, 1u)
 * @brief Launches the CUDA/HIP kernel for counting modules.
 *
 * @param queue The queue handling the kernel launch.
 * @param workDivCountModules The work division for the kernel.
 * @param gpuClustering_countModules The kernel function to launch.
 * @param d_id The ID buffer.
 * @param d_moduleStart The module start buffer.
 * @param d_clus The cluster buffer.
 ...
 * @brief Finds clusters based on the input parameters.
 *
 * @param queue The queue handling the kernel launch.
 * @param workDivMaxNumModules The work division for the kernel.
 * @param gpuClustering_findClus The kernel function to launch.
 * @param d_id The ID buffer.
 * @param d_x The X-coordinate buffer.
 * @param d_y The Y-coordinate buffer.
 * @param d_moduleStart The module start buffer.
 * @param d_clusInModule The cluster-in-module buffer.
 * @param d_moduleId The module ID buffer.
 * @param d_clus The cluster buffer.
 * @param n The number of elements.
...
alpaka::enqueue(queue,
                alpaka::createTaskKernel<Acc1D>(workDivMaxNumModules,
                                                ...
                                                d_clus.data(),
                                                n))
 * @brief Applies the charge cut to the clusters.
 *
 * @param queue The queue handling the kernel launch.
 * @param workDivMaxNumModules The work division for the kernel.
 * @param gpuClustering_clusterChargeCut The kernel function to launch.
 * @param d_id The ID buffer.
 * @param d_adc The ADC buffer.
 * @param d_moduleStart The module start buffer.
 * @param d_clusInModule The cluster-in-module buffer.
 * @param d_moduleId The module ID buffer.
 * @param d_clus The cluster buffer.
