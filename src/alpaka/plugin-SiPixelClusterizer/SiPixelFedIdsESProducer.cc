...
/**
 * Produces SiPixelFedIds object from binary file and stores it in EventSetup.
 *
 * @param eventSetup reference to EventSetup object where produced data will be stored
 */ 
