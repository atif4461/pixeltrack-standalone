...
/**
 * Operator function for clustering pixels in a module.
 *
 * This function takes in various parameters such as module IDs, ADC values, 
 * and cluster IDs, and performs operations to identify and separate clusters 
 * within a module. It utilizes Alpaka acceleration and shared memory to 
