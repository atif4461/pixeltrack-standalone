...
/**
 * @brief Operator function for clusterization
 *
 * This function performs clusterization operations on the input data
 * It takes in various parameters such as module id, adc values, module start indices,
 * and cluster ids, and modifies them accordingly
 *
