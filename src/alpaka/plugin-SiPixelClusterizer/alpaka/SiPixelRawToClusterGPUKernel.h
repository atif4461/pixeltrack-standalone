...
/**
 * Packs row column and adc values into a single uint32_t according to the current packing configuration
 *
...
/**
 * Returns a pair containing the digitization results and cluster results.
 *
