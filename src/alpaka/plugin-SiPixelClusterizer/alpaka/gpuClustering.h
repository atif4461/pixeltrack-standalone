 ...
 *
 * This function takes in several arrays of data related to pixel information,
 * including module IDs, local coordinates, and more. It outputs the number of
 * clusters found in each module, the module ID of each module, and the cluster
 * ID of each pixel.
 *
