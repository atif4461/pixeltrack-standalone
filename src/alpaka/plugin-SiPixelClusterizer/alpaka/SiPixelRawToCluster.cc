 ...
 * @param reg Product registry for consuming and producing data
 */ 
 ...
 * @param iSetup The event setup providing access to various configurations and calibration data.
