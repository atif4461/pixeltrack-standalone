...
/**
 * @brief Class representing digital cluster count data structure
 *
 * This class encapsulates the number of modules, digits, and clusters in a digital cluster count object
