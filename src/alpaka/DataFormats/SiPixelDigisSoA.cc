 ...
 * @param pdigi pointer to digi values array
 * @param rawIdArr pointer to raw identifier array
 * @param adc pointer to analog digital converter values array
 * @param clus pointer to cluster values array
 */
