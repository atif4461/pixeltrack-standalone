...
/**
 * Performs calculation of layer start indices from module start indices.
 *
 * @param acc             Accelerator object
 * @param hitsModuleStart Array of module start indices
 * @param cpeParams       Parameters for pixel CPE on GPU
 * @param hitsLayerStart  Output array of layer start indices
 */ 
...
// The following comment is generated by an LLM. 
/**
 * Creates tracking rec hits asynchronously.
 *
 ...
 * @param[out] queue         reference to the queue for asynchronous operations
 *
