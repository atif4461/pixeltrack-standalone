 ...
 * @brief Structure to hold tracking rec hit 2D SoA view data
 ...
 * @class ClusParams
 * @brief Parameters for clustering
 
 * @class BeamSpotPOD
 * @brief Class representing beam spot point of delivery
 
 * @class SiPixelDigisAlpaka
 * @brief Class representing silicon pixel digis Alpaka
 
 * @class SiPixelClustersAlpaka
 * @brief Class representing silicon pixel clusters Alpaka
