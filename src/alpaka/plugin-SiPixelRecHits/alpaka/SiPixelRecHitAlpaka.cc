...
/**
 * Constructor for the SiPixelRecHitAlpaka class 
 * Initializes member variables with product registry consumes and produces
 */ 
 ...
 * @param es the event setup providing access to PixelCPEFast configuration
 */ 
