...
/**
 * Constructor initializing error data with 32bit error word, type and FED identifier
 * @param errorWord32 32 bit error word value
 * @param errorType type of error occurred
 * @param fedId FED identifier associated with error
 */
...
/**
 * Constructor initializing error data with 64bit error word, type and FED identifier
