 ...
 * Tests binary find functionality with sample datasets.
  * Finds the first occurrence of a specified value in a sorted range using binary search algorithm.
 *
 ...
 * @return iterator pointing to the first occurrence of the value if found, otherwise end of the range
  * Finds the last occurrence of a specified value in a sorted range using binary search algorithm.
 *
 * @param first beginning of the sorted range
 * @param last end of the sorted range
 * @param val value to be searched
 * @return iterator pointing beyond the last occurrence of the value
  * Searches for a specific value in a sorted range using binary search algorithm.
 *
 * @param first beginning of the sorted range
 * @param last end of the sorted range
 * @param val value to be searched
