 ...
 * including digi cluster counts, track counts, and vertex counts.
 * It calculates differences between actual and expected values,
 * and reports discrepancies that exceed specified tolerances.
 *
