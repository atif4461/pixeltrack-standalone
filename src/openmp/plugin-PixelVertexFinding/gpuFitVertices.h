 ...
 *
 * This function takes in ZVertices and WorkSpace pointers, along with a maximum chi2 value for outlier rejection.
 * It performs various computations to fit the vertices, including zeroing arrays, computing cluster locations,
 * and calculating chi2 values.
 *
 * @param pdata Pointer to ZVertices data
 * @param pws Pointer to WorkSpace data
 * @param chi2Max Maximum chi2 value for outlier rejection
