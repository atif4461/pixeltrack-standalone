...
/**
 * Constructor initializing pixel digi errors with specified maximum number of FED words and error formatting options
 * @param maxFedWords Maximum number of FED words
 * @param errors Pixel formatter errors object
 */
