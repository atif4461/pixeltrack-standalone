 ...
 * @brief Provides a structured view of 2D tracking rec hits with SoA storage
 *
 * This class offers an interface to access and manipulate 2D tracking rec hit data,
 * including local and global coordinates, cluster properties, and associated metadata.
