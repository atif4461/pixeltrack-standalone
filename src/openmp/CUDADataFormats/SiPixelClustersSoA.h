 ...
 * @brief Structure of Arrays representation of silicon pixel clusters
 * @details This class represents a collection of silicon pixel clusters in a Structure of Arrays format
  
 * @class DeviceConstView
 * @brief Constant view of device data for silicon pixel clusters
 * @details This nested class provides a constant view of the device data for silicon pixel clusters, allowing for efficient access to the data without modifying it
