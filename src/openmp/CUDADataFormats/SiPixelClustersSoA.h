 ...
 * @brief Structure of Arrays implementation for silicon pixel clusters
 * @details This class provides a SoA representation for silicon pixel clusters,
 *          including methods for accessing and manipulating cluster data.
  
 * @class DeviceConstView
 * @brief Constant view of device data for silicon pixel clusters
 * @details This nested class provides a constant view of the device data,
 *          allowing for safe and efficient access to cluster information.
