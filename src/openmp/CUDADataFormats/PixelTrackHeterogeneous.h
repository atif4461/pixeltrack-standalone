...
/**
 * @class TrackSoAT
 * @brief Structure of array class representing track data
 * @details This class provides a structure of arrays to store track data,
 *          including quality, chi2, trajectory states, and hit indices.
 * @note The class uses SoA (Structure of Arrays) design pattern for efficient memory access.
