...
/**
 * @brief Class representing digital errors in silicon pixels.
 *
 * This class provides functionality for handling digital errors in silicon pixels,
 * including construction, access to error data, and management of internal state.
