...
/**
 * @brief Class representing a collection of digital errors in the silicon pixel detector
 * @details Provides methods for accessing and manipulating the error data
 * @author Unknown
