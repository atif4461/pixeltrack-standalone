 ...
 * @brief Represents a 2D hit view for tracking reconstruction.
 
 
 * @class SiPixelDigisSoA
 * @brief Represents a digitized signal for silicon pixels.
 
 
 * @class SiPixelClustersSoA
 * @brief Represents clustered signals for silicon pixels.
 
 
 * @class BeamSpotPOD
 * @brief Represents a particle beam spot.
 
 
 * @class pixelCPEforGPU
 * @brief Provides parameters and functionality for pixel-based clustering and error estimation on the GPU.
