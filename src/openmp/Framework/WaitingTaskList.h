 ...
 * If an exception occurred, it can be passed to this method to notify waiting tasks.
 ...
 * This method is not thread-safe and should only be called when no tasks are currently using the resource.
