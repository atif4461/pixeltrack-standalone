 ...
 * @throws stdlogicerror If a plugin with the same name already exists in the registry.*/      void Registry::add(std::string const& name, std::unique_ptr<MakerBase> maker) {
