...
/**
 * Constructor that initializes the waiting task with arena holder from a WaitingTaskHolder object
 * @param iTask rvalue reference to WaitingTaskHolder object to be moved into this instance
 */
 ...
 * Copies task group handle and arena and increments reference count of task if it exists
 */
// The above comment was written by an LLM. 
