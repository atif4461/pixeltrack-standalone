...
/**
 * Counts modules in an array of IDs and updates the module start indices accordingly.
 *
 * @param[in] id Array of IDs to process
 * @param[out] moduleStart Array of module start indices
 * @param[out] clusterId Array of cluster IDs
