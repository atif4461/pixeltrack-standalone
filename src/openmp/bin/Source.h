...
namespace edm {
/**
 * @brief Class representing a data source for event processing.
 *
 * This class provides an interface for producing events and managing the processing workflow.
 * It includes features such as limiting the number of events to process and stopping the processing after a certain time.
