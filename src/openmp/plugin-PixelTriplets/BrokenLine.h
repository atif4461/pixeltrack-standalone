 ...
 *
 * This function takes in hit data, a fast fit result, a magnetic field strength,
 * and prepares the necessary data structures for calculating various properties
 * of the broken line, such as its curvature and scattering angles.
 *
...
/**
 * Brief description: Fits a helix to a set of 3D points.
 *
 * Detailed description: This function takes a set of 3D points and returns a vector 
 * representing the fitted helix. It uses various geometric calculations to determine 
 * the parameters of the helix.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Function to perform a circle fit on a set of points.
 *
 * This function takes in a set of hits, their geometric uncertainties, an initial estimate of the circle,
 * and various other parameters, and outputs the results of the circle fit, including the center, radius,
 * and covariance matrix of the fit parameters.
 *
 * @param hits A matrix containing the coordinates of the hits to be fitted.
 * @param hits_ge A matrix containing the geometric uncertainties of the hits.
 * @param fast_fit An initial estimate of the circle parameters.
 * @param B A parameter related to the multiple scattering.
 * @param data A struct containing various intermediate results.
 * @param circle_results A struct to store the output results of the circle fit.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Function to perform a linear fit on a set of points in 3D space.
 *
 * This function takes in a set of 3D points, an initial estimate of the line direction,
 * and various other parameters, and returns the best-fit line parameters and their
 * uncertainties.
 *
 * @param hits_ge Set of 3D points to fit
 * @param fast_fit Initial estimate of the line direction
 * @param B Magnetic field strength
 * @param data Additional data required for the fit
 * @param line_results Structure to store the fit results
...
/**
 * @class helix_fit
 * @brief Represents a helical fit result
  
 * @class Vector4d
 * @brief Represents a 4D vector
 
 * @class Matrix3xNd
 * @brief Represents a 3xN matrix
 
 * @class Matrix3d
 * @brief Represents a 3x3 matrix
 
 * @class PreparedBrokenLineData
 * @brief Represents prepared broken line data
 
 * @class karimaki_circle_fit
 * @brief Represents a circle fit result
 
 * @class line_fit
 * @brief Represents a line fit result
