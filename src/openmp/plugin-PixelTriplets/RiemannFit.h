 ...
 * assuming a uniform material distribution. It uses the input length
 * values to determine the radiation lengths at each point.
 *
 ...
 * @param rad radii of the material
 * @param B magnetic field strength
 ...
 *
 * @param p2D transformation matrix from radial to cartesian coordinates
 * @param cov_rad covariance matrix in radial coordinates
...
*/
  template <typename M2xN, int N>
/**
 * Calculates the covariance of radial measurements from Cartesian coordinates.
 *
 * @param p2D input 2D points
 * @param cov_cart covariance matrix in Cartesian coordinates
 * @param rad radii of the points
 * @return covariance of radial measurements
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * @param p2D 2D coordinates of two points defining the plane
 * @param par_uvr 3D vector representing the point to calculate charge for
 * @return integer indicating the charge, either -1 or 1
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
CircleFitResult circle_fit(const M2xN& hits2D, 
                        const Matrix2Nd<N>& hits_cov2D, 
                        const V4& fast_fit, 
                        const VectorNd<N>& rad, 
                        const double B, 
                        const bool error);* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Line fit function
 *
 * This function performs a line fit on a set of points in 3D space.
 * It takes into account the uncertainties of the points and returns
 * the best fit line parameters along with their covariance matrix.
 *
 * @param hits 3D points to perform the fit on
 * @param hits_ge covariance matrices of the points
 * @param circle initial guess for the circle
 * @param fast_fit fast fit parameters
 * @param B magnetic field strength
 * @param error flag to compute error propagation
 * @return line fit result containing parameters and covariance matrix
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
*/
  ...
  template <int N>
/**
 * @brief Class representing a helical fit result
 *
 * This class encapsulates the results of a helical fit, including parameters,
 * covariance matrix, quality factor, and chi-squared values for both circle
 * and line fits.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
