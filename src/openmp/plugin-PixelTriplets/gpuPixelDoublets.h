...
/**
 * Initializes the doubles data structures for the GPU CA algorithm.
 *
 * @param isOuterHitOfCell pointer to an array of OuterHitOfCell objects
 * @param nHits number of hits to process
 * @param cellNeighbors pointer to a vector of CellNeighbors objects
 * @param cellNeighborsContainer container for CellNeighbors objects
 * @param cellTracks pointer to a vector of CellTracks objects
 * @param cellTracksContainer container for CellTracks objects
 ...
 *
 * @param[in] cells pointer to array of GPU CA cells
 ...
 * @param[in] hhp pointer to tracking rec hit 2D SOA view
 * @param[in] isOuterHitOfCell outer hit status of each cell
 * @param[in] nActualPairs number of actual pairs
 * @param[in] ideal_cond flag indicating ideal conditions
 * @param[in] doClusterCut flag enabling cluster cut
 * @param[in] doZ0Cut flag enabling z0 cut
 * @param[in] doPtCut flag enabling pt cut
