 ...
 * cells, cell neighbors, cell tracks, tracking rec hit 2D SOA view, 
 * outer hit of cell, phi cuts, minimum and maximum z values, maximum r value, 
 * flags for ideal condition, cluster cut, z0 cut, and pt cut, and maximum number of doublets.
 * 
 * It performs various calculations and checks to determine valid doublets and stores them in the cells array.
 * 
 ...
 * @param cellNeighbors Cell neighbors
 * @param cellTracks Cell tracks
 * @param hh Tracking rec hit 2D SOA view
 * @param isOuterHitOfCell Outer hit of cell
 * @param phicuts Phi cuts
 * @param minz Minimum z values
 * @param maxz Maximum z values
 * @param maxr Maximum r value
 * @param ideal_cond Flag for ideal condition
