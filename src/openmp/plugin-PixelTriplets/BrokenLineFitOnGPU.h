 ...
 * It iterates over the hits and prepares the data structures for the fitting process.
 *
 * @param foundNtuplets Tuple container
 ...
 * @param pfast_fit Pointer to fast fit array
 ...
 * @param results Output structured array for storing fit results
 ...
 * @class OutputSoA 
 * @brief Structured array for outputting fit results
