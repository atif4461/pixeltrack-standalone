...
namespace edm {
/**
 * @brief Class representing a source of data for event processing.
 *
 * This class provides an interface for configuring and controlling the data source,
 * as well as producing events for further processing.
 
class Source {
     * @brief Constructor for the Source class.
   *
   * Initializes the source with the specified maximum number of events, runtime in minutes,
   ...
   *
   * Updates the maximum number of events and runtime in minutes.
   *
   * @param maxEvents New maximum number of events.
   * @param runForMinutes New runtime in minutes.
   
     * @brief Starts the event processing.
   
     * @brief Returns the maximum number of events.
   *
   ...
   *
   * Thread-safe method for generating events.
   *
