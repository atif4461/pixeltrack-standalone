 ...
 * @brief Perform a range query on the histogram
 *
 * This function performs a range query on the histogram, retrieving all
 * elements within a specified range.
 *
 * @param h Histogram object
 * @param val Value to query
 * @param width Width of the query range
 * @param func Callback function to apply to each retrieved element
