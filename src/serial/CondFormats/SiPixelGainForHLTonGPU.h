...
/**
 * Returns the pedestal and gain for a given module, column, and row.
 *
 * @param moduleInd Index of the module.
 * @param col Column number.
 * @param row Row number.
 * @param isDeadColumn Output flag indicating if the column is dead.
 * @param isNoisyColumn Output flag indicating if the column is noisy.
