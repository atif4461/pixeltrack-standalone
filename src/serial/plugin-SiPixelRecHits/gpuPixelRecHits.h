 ...
 * @brief Class representing silicon pixel digis in structure of arrays format
 
  * @class SiPixelClustersSoA
 * @brief Class representing silicon pixel clusters in structure of arrays format
 
  * @class TrackingRecHit2DSOAView
 * @brief Class representing tracking rec hit 2D SOA view
