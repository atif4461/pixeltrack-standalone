 ...
 * @brief Represents a 2D hit in the tracker with SoA storage.
 
 
  * @class SiPixelDigisSoA
 * @brief Represents a digital signal in the silicon pixel detector with SoA storage.
 
  * @class SiPixelClustersSoA
 * @brief Represents a cluster of pixels in the silicon pixel detector with SoA storage.
 
  * @class pixelCPEforGPU
 * @brief Provides parameters and functionality for pixel CPE on the GPU.
