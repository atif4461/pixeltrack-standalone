 ...
 * If the condition is met, it proceeds to calculate new vertex positions using an iterative method.
 * The new vertices are then checked for quality cuts and if they pass, a new global vertex is assigned.
 * 
 ...
 * @param maxChi2 Maximum allowed chi2 value
