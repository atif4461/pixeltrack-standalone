...
/**
 * @brief Function to split vertices based on chi2 values
 * 
 * This function takes in ZVertices and WorkSpace pointers, along with a maximum chi2 value.
 * It iterates over each vertex, checks if the chi2 value is greater than the product of maxChi2 and the number of degrees of freedom.
 * If the condition is met, it proceeds to split the vertex into two new vertices.
 * The splitting process involves calculating the weighted average of z positions and updating the weights accordingly.
 * 
 ...
 * @param maxChi2 Maximum allowed chi2 value for splitting
  
 * @class ZVertices
 * 
 * This class represents a collection of vertices with associated data such as z positions, weights, and chi2 values.
 * It provides methods to access and modify these data members.
  
 * @class WorkSpace
 * 
 * This class represents a workspace that contains data necessary for vertex splitting, including intermediate vertex count and indices.
 * It provides methods to access and modify these data members.
