...
/**
 * @brief Function to split vertices based on chi2 value
 * 
 * This function takes in ZVertices and WorkSpace pointers along with a maximum chi2 value.
 * It iterates over each vertex, checks if the chi2 value is greater than the specified maxChi2,
 * and splits the vertex into two if necessary.
 * 
 * @param pdata pointer to ZVertices struct
 * @param pws pointer to WorkSpace struct
 ...
 * 
 * Contains members such as zv, wv, chi2, ndof, nvFinal
 
class ZVertices

 * @class WorkSpace
 * 
 * Struct to hold workspace data
 * 
 * Contains members such as nt, zt, ezt2, iv, nvIntermediate
