 ...
 *
 * This function performs vertex fitting on a set of tracks and computes the 
 * corresponding chi-squared values. It takes as input a pointer to ZVertices 
 * data, a pointer to workspace data, and a maximum chi-squared value for 
 * outlier rejection. The function modifies the input data structures 
 * accordingly.
