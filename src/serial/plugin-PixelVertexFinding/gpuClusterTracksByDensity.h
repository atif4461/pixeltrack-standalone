 ...
 *
 * Detailed description: This kernel function clusters tracks based on their density.
 * It takes into account the minimum number of neighbors required to be considered a seed,
 * the maximum absolute distance to cluster, the maximum error to be considered a seed,
 * and the maximum normalized distance to cluster.
 *
 * Parameters:
 *   pdata - pointer to vertex data
 *   pws - pointer to workspace data
 *   minT - minimum number of neighbors to be considered a seed
 *   eps - maximum absolute distance to cluster
 *   errmax - maximum error to be considered a seed
