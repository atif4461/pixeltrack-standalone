 ...
 * @details Provides array like access to scalar data with compile time checks for alignment and sizing
 * @tparam T scalar type used in the SoA
 * @tparam S size of the SoA
 ...
 * @details Provides a SoA layout for matrices with compile-time checks for alignment and stride
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
