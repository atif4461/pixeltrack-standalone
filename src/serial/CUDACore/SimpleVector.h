...
*/ 
      ...
      template <class... Ts>
/**
 * Emplaces an element at the end of the container without performing safety checks
 * @param args Arguments to forward to the constructor of the element type
 * @return The index where the new element was inserted if successful, -1 otherwise
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * @return the new size if successful otherwise -1
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
