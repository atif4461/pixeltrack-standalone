...
/**
 * Class representing an asynchronous work executor.
  
 * Class providing a holder for waiting tasks.
 
 * Class responsible for managing producers and handling exceptions.
 
 * Abstract base class for waiting tasks with arena management.
  
 * Class implementing a holder for waiting tasks with a group association.
  
 * Interface defining methods for producing data asynchronously.
  
 * Exception handler class for catching and storing exceptions.
  
 * Synchronization primitive for thread-safe flag manipulation.
  
 * Task manager class for scheduling and executing tasks asynchronously.
  
 * Prefetcher class for optimizing data access patterns.
  
 * Event setup configuration class for customizing event processing.
  
 * Group management class for organizing related tasks and resources.
  
 * Arena management class for optimizing memory allocation and deallocation.
  
 * Holder class for storing and retrieving exception pointers.
  
 * Base class for creating and managing waiting tasks.
