...
/**
 * @class FEDNumbering
 * @brief Provides a set of constants defining the numbering scheme for FED IDs.
 *
 * This class contains an enumeration of constants that define the range of valid FED IDs
 * for various detector components, such as silicon pixels, strips, and trigger systems.
