 ...
 * @brief Represents a 2D tracking rec hit with structure-of-arrays view
 *
 * This class provides an interface to access and manipulate 2D tracking rec hit data
 * stored in a structure-of-arrays format. It offers various methods to retrieve and modify
 * local and global coordinates, cluster properties, and supporting objects.
