...
template <typename Traits>
/**
 * Constructor for TrackingRecHit2DHeterogeneous class template.
 *
 * @param nHits number of hits
 * @param cpeParams pointer to pixelCPEforGPU parameters on GPU
 * @param hitsModuleStart pointer to hits module start indices
