 ...
 *
 * @param hits Input 3xN matrix containing the 3D space points
 * @param result Output 4-element vector containing the fitted helix parameters
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * @param hits_ge Input array of hit uncertainties
