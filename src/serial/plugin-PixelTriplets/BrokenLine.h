...
/**
 * Prepare broken line data from a set of hits and a fast fit result.
 *
 * This function takes in a set of hits, a fast fit result, and a magnetic field strength,
 * and prepares the data for a broken line fit. It calculates various quantities such
 * as the charge, radii, and s values, and stores them in the results struct.
 *
 * @param hits A matrix containing the hit positions
 * @param fast_fit A vector containing the fast fit result
 * @param B The magnetic field strength
 * @param results A struct to store the prepared broken line data
...
*/ 
  ...
  */
  template <int N>
/**
 * Calculates the matrix C_U based on input vectors w, S, and VarBeta.
 *
...
/**
 * Brief description of BLFastFit class
 *
 * Detailed description of BLFastFit class
 
class BL_Fast_fit {
     * @brief Fits a line to a set of 3D points using a fast algorithm
   * @param hits A 3xN matrix containing the hit points
   * @param result A 4-element vector containing the fitted line parameters
...
/**
 * @brief Function to perform a circle fit using Karimaki's algorithm
 *
 * @param hits Input matrix containing hit points
 * @param hits_ge Input matrix containing error estimates for hit points
 * @param fast_fit Input vector containing initial fit parameters
 * @param B Input parameter representing magnetic field strength
 * @param data Reference to prepared broken line data
 * @param circle_results Output object to store circle fit results
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Performs a linear fit on a set of points in 3D space using the broken line algorithm.
 *
...
/**
 * @class HelixFit
 * @brief Represents a helix fit result
 ...
 * @brief Represents a karimaki circle fit result
