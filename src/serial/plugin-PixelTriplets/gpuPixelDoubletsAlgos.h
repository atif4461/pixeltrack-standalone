 ...
 * cell neighbors, cell tracks, tracking rec hit 2D SOA view, and more. It uses these 
 * parameters to calculate and store doublets in the cells array.
 * 
 * @param layerPairs Array of layer pairs
 * @param nPairs Number of layer pairs
 * @param cells Array to store generated doublets
 * @param nCells Pointer to store number of doublets
 ...
 * @param doClusterCut Cluster cut flag
 * @param doZ0Cut Z0 cut flag
 * @param doPtCut Pt cut flag
