 ...
 *
 * @param foundNtuplets Input array of tuples containing hit information.
 * @param tupleMultiplicity Array of multiplicities for each tuple.
 * @param hhp Object containing hit parameters.
 * @param phits Output array for storing fitted hit positions.
 * @param phits_ge Output array for storing error estimates of fitted hit positions.
 * @param pfast_fit Output array for storing fast fit results.
 * @param nHits Number of hits to consider for fitting.
 * @param offset Offset value for indexing tuples.
...
template <int N>
/**
 * @brief Function to perform broken line fit on given data points
 *
 * This function takes in various parameters such as tuple multiplicity, 
 * magnetic field strength, output SoA, hits, fast fit values, number of hits, 
 * and an offset value. It performs a broken line fit on the given data points 
 * and stores the results in the output SoA.
 *
 * @param tupleMultiplicity Tuple multiplicity array
 * @param B Magnetic field strength
 * @param results Output SoA to store the results
 * @param phits Hits array
 * @param phits_ge Geometric hits array
 * @param pfast_fit Fast fit values array
