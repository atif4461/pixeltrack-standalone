...
/**
 * Initializes the doublets data structures.
 *
 * @param[in] isOuterHitOfCell array of outer hits of cells
 * @param[in] nHits number of hits
 * @param[out] cellNeighbors vector of cell neighbors
 * @param[in,out] cellNeighborsContainer container for cell neighbors
 * @param[out] cellTracks vector of cell tracks
 * @param[in,out] cellTracksContainer container for cell tracks
 ...
 * @param[in] nActualPairs actual number of layer pairs
 ...
 * @param[in] maxNumOfDoublets maximum number of doublets allowed
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
