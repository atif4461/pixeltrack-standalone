...
/**
 * Compute radiation lengths in a uniform material.
 *
 * This function calculates the radiation lengths of a pixel detector
 * assuming a uniform material distribution. It takes as input a vector
 * of length values and returns a vector of corresponding radiation lengths.
...
/**
 * Computes the covariance matrix of scattered points along a line.
 *
 * @param cov_sz input covariance matrices
 * @param fast_fit input fit parameters
 * @param s_arcs input arc lengths
 * @param z_values input z values
 * @param theta input angle
 * @param B input magnetic field strength
...
/**
 * @brief Computes the scattering covariance matrix due to radiation effects.
 *
 * This function calculates the scattering covariance matrix that arises from
 * radiation effects in a tracking system. It takes into account the 
 * properties of the track fit, such as its curvature and the material it 
 * traverses.
 *
 * @param p2D A 2xN matrix containing the coordinates of the track at different points.
 * @param fast_fit A vector of length 4 representing the track fit parameters.
 * @param rad A vector of length N representing the radial distances of the track.
 * @param B A double value representing a scaling factor.
 *
 * @return A NxN matrix representing the scattering covariance matrix.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
*/
  template <typename M2xN, int N>
/**
 * Calculates the covariance matrix in radial coordinates from cartesian coordinates.
 *
 * @param p2D input 2D points
 * @param cov_cart input covariance matrix in cartesian coordinates
 * @param rad input radii
 * @return covariance matrix in radial coordinates
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
*/
  template <typename M2xN, typename V4, int N>
/**
 * Calculates the covariance matrix in radial direction from cartesian coordinates.
 *
 * @param p2D input 2D points
 * @param cov_cart input cartesian covariance matrix
 * @param fast_fit fitted parameters
 * @param rad input radii
 * @return covariance matrix in radial direction
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * Calculates the charge of a point with respect to a 2D polygon.
 *
 * @param p2D 2D polygon points
 * @param par_uvr 3D vector
 * @return charge value
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Fast fit function to calculate circle and line fits
 *
 * This function takes a set of 3D hits and calculates the best fit circle and line
 * parameters. It uses various mathematical operations such as vector calculations,
 * dot products, and trigonometric functions to determine the circle center,
 * radius, and line direction.
 *
 * @param hits A 3xN matrix containing the input hits
 * @param result A 4-element vector to store the output fit results
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
class CircleFitResult {
     * @brief Constructor for CircleFitResult.
   * @param par Parameters of the fitted circle.
   * @param q Charge of the fitted circle.
   * @param chi2 Chi-squared value of the fit.
   * @param cov Covariance matrix of the fitted parameters.
   
  public:
  CircleFitResult(Vector3d par, double q, double chi2, Matrix3d cov)
    : par_(par), q_(q), chi2_(chi2), cov_(cov) {}

     * @brief Get the parameters of the fitted circle.
   * @return Vector3d containing the parameters.
   
  Vector3d getParameters() const { return par_; }

     * @brief Get the charge of the fitted circle.
   * @return Double containing the charge.
   
  double getCharge() const { return q_; }

     * @brief Get the chi-squared value of the fit.
   * @return Double containing the chi-squared value.
   
  double getChiSquared() const { return chi2_; }

     * @brief Get the covariance matrix of the fitted parameters.
   * @return Matrix3d containing the covariance matrix.
   
  Matrix3d getCovariance() const { return cov_; }

 private:
  Vector3d par_; ///< Parameters of the fitted circle.
  double q_; ///< Charge of the fitted circle.
  double chi2_; ///< Chi-squared value of the fit.
  Matrix3d cov_; ///< Covariance matrix of the fitted parameters.
}; 
 * @brief Function to perform a circle fit on a set of 2D hits.
 * @param hits2D Set of 2D hits.
 * @param hits_cov2D Covariance matrices of the hits.
 * @param fast_fit Initial guess for the fit.
 * @param rad Radii of the hits.
 * @param B Magnetic field strength.
 * @param error Flag to enable error propagation.
 * @return CircleFitResult object containing the fit results.
 
CircleFitResult circle_fit(const M2xN& hits2D, const Matrix2Nd<N>& hits_cov2D, const V4& fast_fit, const VectorNd<N>& rad, const double B, const bool error);* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
/**
 * @brief Function to perform a line fit on a set of 3D points.
 *
 * This function takes in a set of 3D points, their corresponding covariance matrices,
 * a circle fit object, a fast fit vector, a magnetic field strength, and an error flag.
 * It returns a line fit object containing the fitted parameters and their covariance matrix.
 *
 * @param hits A matrix of 3D points.
 * @param hits_ge A matrix of covariance matrices for the 3D points.
 * @param circle A circle fit object.
 * @param fast_fit A fast fit vector.
 * @param B The magnetic field strength.
 * @param error A flag indicating whether to compute errors.
 * @return A line fit object containing the fitted parameters and their covariance matrix.
 
inline line_fit Line_fit(const M3xN& hits,...)* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
...
*/
  ...
  template <int N>
/**
 * @brief Class representing a helix fit result
 *
 * This class encapsulates the results of a helix fit operation, including the parameters,
 * covariance matrix, quality factor, and chi-squared values for both circle and line fits.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
