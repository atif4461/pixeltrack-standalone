...
/**
 * Compute radiation lengths of a pixel detector under uniform material assumption.
 *
 ...
 *
 * @param cov_sz input array of 2x2 covariance matrices
 * @param fast_fit input vector of fit parameters
 * @param s_arcs input vector of arc lengths
 * @param z_values input vector of z values
 * @param theta input angle parameter
 ...
 *
 * This function calculates the scattering covariance matrix resulting from
 * radiation effects in a tracking system. It takes into account the 
 * particle's trajectory, material properties, and other relevant parameters.
 *
 * @param p2D A 2xN matrix containing the particle's 2D coordinates at each layer.
 * @param fast_fit A vector of length 4 representing the particle's fit parameters.
 * @param rad A vector of length N representing the radial distance at each layer.
 * @param B Magnetic field strength.
 * @return A NxN matrix representing the scattering covariance due to radiation.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Calculates the covariance matrix in cartesian coordinates from the given radial covariance matrix and radius vector.
 *
 * @param p2D input 2xN matrix
 * @param cov_rad input NxN radial covariance matrix
 * @param rad input Nx1 radius vector
...
*/
  template <typename M2xN, int N>
/**
 * Calculates the covariance matrix of radial coordinates from cartesian coordinates.
 *
...
*/
  template <typename M2xN, typename V4, int N>
/**
 * Calculates the covariance matrix of radial errors from Cartesian coordinates.
 *
 * @param p2D input 2D points
 ...
 * @return covariance matrix of radial errors
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @class CircleFit
 * @brief Fits a circle to a set of 2D points using a weighted least squares method.
 *
 * @param hits2D Input 2D points to fit the circle to.
 * @param hits_cov2D Covariance matrices of the input points.
 * @param fast_fit Initial guess for the circle parameters.
 * @param rad Radii of the circles.
 * @param B Parameter controlling the weighting of the points.
 * @param error Flag indicating whether to propagate errors.
 * @return Fitted circle parameters.
 
inline Circle_fit Circle_fit(...) {...}* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Line fit function to calculate the line parameters from a set of hits.
 *
 * @param hits 3D coordinates of the hits
 * @param hits_ge Geometrical uncertainties of the hits
 ...
 * @return Line fit object containing the fitted line parameters and their covariance matrix
 
inline line_fit Line_fit(const M3xN& hits,...)* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
*/
  ...
  template <int N>
/**
 * @brief Helix fit function
 *
 * This function performs a helix fit on a set of input data points
 * and returns the fitted parameters and their associated uncertainties
 *
 * @param hits Input data points
 * @param hits_ge Geometric input data points
 * @param B Magnetic field strength
 * @param error Flag indicating whether to compute errors
 * @return Fitted helix parameters and uncertainties
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
