 ...
 * theInnerHitId theOuterHitId theDoubletId theLayerPairId and theUsed.
...
/**
 * Checks if two points are aligned within a certain threshold in the rz plane.
 *
 * @param r1 radial position of first point
 * @param z1 z position of first point
 * @param ri radial position of second point
 * @param zi z position of second point
 * @param ro radial offset
 * @param zo z offset
 * @param ptmin minimum transverse momentum
 ...
 * @param innerCell Inner cell of the GPUCACell object
 ...
 *
 * This function recursively builds tracks by exploring neighboring cells
 * and adding them to a temporary tuple until a stopping condition is met.
 * It saves the resulting n-tuplets if they meet certain conditions.
 *
 * @param hh input hits
 ...
 * @param tmpNtuplet temporary tuple of n-tuplet
