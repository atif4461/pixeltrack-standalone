 ...
 * @param[in] length number of words to copy from the source
 ...
 * @return DetIdGPU object containing raw id, roc in det and module id */  pixelgpudetails::DetIdGPU getRawId(const SiPixelFedCablingMapGPU *cablingMap,
                                     uint8_t fed,
                                     uint32_t link,
                                     uint32_t roc) {
 ...
 * @param[in] status The status indicating the type of error
 * @param[in] debug Flag to enable or disable debugging messages
 * @return Error type corresponding to the input status
 ...
 * @param cablingMap The mapping of FED IDs to links and ROCs
 ...
 * @param[in] debug An optional flag to enable debugging output.
 *
