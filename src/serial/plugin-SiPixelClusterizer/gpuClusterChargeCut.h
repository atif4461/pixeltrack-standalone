 ...
 * This function takes as input arrays representing module ids, charges, 
 * module starts, number of clusters per module, and cluster ids. It applies 
 * a charge cut to each cluster in every module, removing clusters with 
 * charge below a certain threshold. The function modifies the input 
 * arrays to reflect the updated cluster assignments.
 *
 * Parameters:
 *   id - array of module ids for each pixel
 *   adc - array of charges for each pixel
 *   moduleStart - array of starting indices for each module
 *   nClustersInModule - array of number of clusters per module
 *   moduleId - array of module ids
 *   clusterId - array of cluster ids for each pixel
