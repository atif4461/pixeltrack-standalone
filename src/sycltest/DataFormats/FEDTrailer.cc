...
/**
 * Sets the trailer data with the given parameters.
 * @param trailer pointer to the trailer data
 * @param lenght length of the event data
 * @param crc checksum of the event data
 * @param evtStatus status of the event
 * @param ttsBits time trigger bits
