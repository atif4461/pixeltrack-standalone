 ...
 *
 * This class provides methods for warming up the system, running the event processing to completion, 
 * and ending the job. It also allows access to the maximum number of events and the number of processed events.
