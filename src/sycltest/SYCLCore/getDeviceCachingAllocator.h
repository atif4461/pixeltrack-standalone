...
namespace cms::sycltools {
  ...
  namespace detail {
/**
 * Allocates device allocators for multiple devices.
 *
 * This function creates a caching allocator for each device and stores them in a contiguous block of memory.
 * It uses a custom deleter to ensure proper cleanup when the allocators are no longer needed.
 *
