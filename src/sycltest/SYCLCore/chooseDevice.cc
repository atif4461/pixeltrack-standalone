 ...
 * @param verbose If true prints the number and details of found devices to standard error stream
 * @return A constant reference to a vector of discovered SYCL devices
 ...
 * @return The selected SYCL device object
