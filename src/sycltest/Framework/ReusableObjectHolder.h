 ...
 *
 * @param iMakeFunc FM function to create a new object
 * @param iClearFunc FC function to clear the created object
 ...
 * @param ptr raw pointer to be wrapped in a unique pointer
