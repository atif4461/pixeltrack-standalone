 ...
 * which is essentially an index into the event data storage.
 ...
 * @note This class has friends classes ProductRegistry and EDGetToken for accessing its private members.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
  class EDGetTokenT {
    friend class ProductRegistry;
