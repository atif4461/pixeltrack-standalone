 ...
 * The WaitingTaskList class represents a list of tasks that are waiting to be executed.
 * It provides methods to add tasks to the list, signal that the resource is available, 
 * and reset the list to make tasks wait again.
