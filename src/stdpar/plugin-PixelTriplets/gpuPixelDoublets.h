...
/**
 * Initializes data structures for tracking algorithm.
 *
 * @param isOuterHitOfCell array of outer hits of cells
 * @param nHits number of hits
 * @param cellNeighbors vector of neighboring cells
 * @param cellNeighborsContainer container for neighboring cells
 * @param cellTracks vector of tracks within cells
 * @param cellTracksContainer container for tracks within cells
 ...
 *
 * This function takes in various parameters such as cell neighbors, cell tracks, 
 * tracking rec hit data, and flags for different cuts, and generates doublets 
 ...
 * @param nPairs Number of pairs of layers.
 * @param idealCond Flag indicating whether to apply ideal conditions.
