 ...
 * @param[in,out] cellNeighborsContainer underlying storage for cell neighbors
 * @param[out] cellTracks container for tracks
 * @param[in,out] cellTracksContainer underlying storage for cell tracks
...
/**
 * @brief Function to generate doublets from histogram data
 *
 * This function takes in various parameters such as cell data, neighbor and track information,
 * histogram data, and cutoff values, and generates doublets based on certain conditions.
 *
 * @param cells Pointer to an array of GPUCACell objects
 * @param nCells Pointer to the number of cells
 * @param cellNeighbors Pointer to a CellNeighborsVector object
 * @param cellTracks Pointer to a CellTracksVector object
 * @param hhp Pointer to a TrackingRecHit2DSOAView object
 * @param isOuterHitOfCell Array to store indices of outer hits for each cell
 * @param nPairs Number of pairs to consider
 * @param ideal_cond Flag indicating whether to apply ideal conditions
 * @param doClusterCut Flag indicating whether to apply cluster cut
 * @param doZ0Cut Flag indicating whether to apply z0 cut
 * @param doPtCut Flag indicating whether to apply pt cut
