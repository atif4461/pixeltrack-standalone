 ...
 *
 * This function performs a fast fit of broken lines to a set of hits on a detector.
 * It takes as input a list of tuples, each representing a set of hits, along with their multiplicities,
 * and outputs the fitted parameters of the broken line.
 *
 * @param foundNtuplets List of tuples, where each tuple represents a set of hits
 * @param tupleMultiplicity Multiplicities of the tuples
 * @param hhp Hits on the GPU
 * @param phits Array to store the hits
...
template <int N>
/**
 * @brief Kernel function for broken line fit calculation
 *
 * This function performs a broken line fit calculation on a set of hits and returns the results
 *
 * @param tupleMultiplicity Tuple multiplicity array
 * @param B Magnetic field strength
 * @param results Output struct of arrays to store the results
