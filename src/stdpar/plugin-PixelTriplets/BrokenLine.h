...
/**
 * Prepares broken line data for further processing.
 *
 * This function takes in hit data, a fast fit result, and a magnetic field strength,
 * and produces prepared broken line data including q, radii, s, S, Z, and VarBeta values.
 *
...
*/ 
  ...
  */
  template <int N>
/**
 * Calculates the matrix C_U given vectors w, S, and VarBeta.
 *
...
/**
 * Brief description of BL_Fast_fit function
 *
 * Detailed description of BL_Fast_fit function
 * This function calculates the helix fit parameters from a set of 3D hit points.
 * It uses various mathematical operations such as vector calculations and cross products.
 * The function returns the calculated parameters in the result variable.
 *
 * @param hits A 3xN matrix containing the hit points
 * @param result A 4-element vector containing the calculated helix fit parameters
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Function to perform a circle fit using Karimaki algorithm
 *
 * @param hits input array of hits
 * @param hits_ge input array of geometric errors
 ...
 * @brief Class representing the result of a Karimaki circle fit
 *
 * @var q charge of the particle
 * @var par vector of circle parameters
 * @var cov covariance matrix of the circle parameters
 * @var chi2 chi-squared value of the fit
  
class karimaki_circle_fit 
 * @class PreparedBrokenLineData
 * @brief Class representing prepared data for broken line fits
 *
 * @var q charge of the particle
 * @var radii radius vectors
 * @var s arc lengths
 * @var S cumulative arc lengths
 * @var Z differences between measured and expected distances
 * @var VarBeta variance of the beta function
  
class PreparedBrokenLineData 
 * @fn TranslateKarimaki
 * @brief Function to translate a Karimaki circle fit result
 *
 * @param circle_results input/output circle fit result
 ...
 * @fn MultScatt
 * @brief Function to calculate multiple scattering contribution
 *
 * @param ds arc length
 * @param B magnetic field strength
 * @param r radius
 * @param order order of the scattering process
 * @param slope slope of the trajectory
 * @return multiple scattering contribution
  
double MultScatt(double ds, double B, double r, int order, double slope)* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
  inline void BL_Circle_fit(const M3xN& hits,
                            const M6xN& hits_ge,
                            const V4& fast_fit,
...
/**
 * @brief Performs a linear fit on a set of points in 3D space using a broken line model.
 *
 * @param hits_ge Input points in global coordinates.
 * @param fast_fit Initial estimate of the line direction.
 * @param B Magnetic field strength.
 * @param data Precomputed data for the broken line fit.
 * @param line_results Output container for the fitted line parameters and their uncertainties.
...
*/ 
  ...
  */
  template <int N>
/**
 * @brief Fits a helix to a set of 3D points using a combination of circle and line fits
 * @param hits 3xN matrix of hit points
 * @param hits_ge 6x4 matrix of geometric parameters
 * @param B magnetic field strength
 * @return fitted helix parameters
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
