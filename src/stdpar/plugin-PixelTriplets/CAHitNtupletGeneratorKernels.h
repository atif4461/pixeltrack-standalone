 ...
 * @param useRiemannFit Use Riemann fit.
 * @param fit5as4 Fit 5 as 4.
 * @param includeJumpingForwardDoublets Include jumping forward doublets.
 * @param earlyFishbone Early fishbone.
 * @param lateFishbone Late fishbone.
 * @param idealConditions Ideal conditions.
 * @param doStats Perform statistics.
 * @param doClusterCut Apply cluster cut.
 * @param doZ0Cut Apply z0 cut.
 * @param doPtCut Apply pt cut.
 * @param ptmin Pt minimum value.
 * @param CAThetaCutBarrel Cut value for catheta barrel.
 * @param CAThetaCutForward Cut value for catheta forward.
 * @param hardCurvCut Hard curvature cut.
 * @param dcaCutInnerTriplet DCA cut inner triplet.
 * @param dcaCutOuterTriplet DCA cut outer triplet.
