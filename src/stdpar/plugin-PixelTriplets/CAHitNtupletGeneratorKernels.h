 ...
 * @param doStats Do statistics
 * @param doClusterCut Do cluster cut
 * @param doZ0Cut Do z0 cut
 * @param doPtCut Do pt cut
 * @param ptmin Pt minimum
 * @param CAThetaCutBarrel CA theta cut barrel
 * @param CAThetaCutForward CA theta cut forward
