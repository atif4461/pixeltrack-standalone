...
/**
 * Brief description: Function to perform fishbone operation on GPU
 * Detailed description: This function takes in several parameters including 
 * hits, cells, number of cells, outer hit of cell information, total hits and a boolean flag.
 * It performs various operations such as calculating distances, checking track information 
 * and updating cell properties.
