 ...
 *
 * @param cov_sz   array of 2x2 matrices representing the covariance of each point
 ...
 *
 * This function calculates the scattering covariance matrix for a given set of points,
 * taking into account the radiation effects. It uses the input parameters such as
 * the 2D points, the fast fit values, the radial distances, and the magnetic field strength.
 *
 * @param p2D The 2D points.
 * @param fast_fit The fast fit values.
 * @param rad The radial distances.
 * @param B The magnetic field strength.
 * @return The computed scattering covariance matrix.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * @param fast_fit input fast fit parameters
 * @param rad input radii
...
/**
 * @brief Fast fit algorithm implementation
 *
 * This function performs a fast fit calculation on a set of input hits and returns the result.
 *
 * @param hits Input hits as a 3xN matrix
 * @param result Output vector containing the fitted values
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * This function performs a weighted fit of a circle to a set of 2D points with
 * associated covariance matrices. It computes the parameters of the circle,
 * including its center, radius, and charge, as well as the covariance matrix
 * of these parameters.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * @param hits 3xN matrix containing the hit points
 * @param hits_ge 6xN matrix containing the covariance of the hit points
 * @param circle Circle fit object
 * @param fast_fit Fast fit vector
 * @param B Magnetic field strength
 * @param error Flag to compute error
 * @return Line fit object containing the fitted line parameters and covariance
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * @param hits Input points
 * @param hits_ge Geometric input points
 * @param B Magnetic field strength
