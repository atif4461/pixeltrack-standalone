 ...
 * parameters. It uses various vector calculations and geometric transformations
 * to determine the center and radius of the circle, as well as the direction and
 * pitch of the line.
 *
...
class CircleFitResult {
  ...
  Matrix3d getCovarianceMatrix() const { return cov_; }
