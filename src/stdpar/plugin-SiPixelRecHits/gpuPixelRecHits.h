 ...
 * @brief Provides functionality for pixel CPE calculations on the GPU
 
 
 * @class ClusParams
 * @brief Parameters for cluster processing
 
 
 * @class BeamSpotPOD
 * @brief Represents a beam spot position and direction
 
 
 * @class SiPixelDigis
 * @brief Represents silicon pixel digitizations
 
 
 * @class SiPixelClusters
 * @brief Represents silicon pixel clusters
