 ...
 * @param[out] errors reference to the error collection
...
/**
 * @brief Checks the validity of a header in the event data stream
 * @param[out] errorsInEvent flag indicating whether an error occurred during checking
 * @param[in] fedId identifier of the FED being checked
 * @param[in] header pointer to the header bytes
 * @param[out] errors collection of errors encountered during processing
...
/**
 * @brief Checks the event trailer for errors
