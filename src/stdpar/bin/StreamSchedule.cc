 ...
 * @param source pointer to Source instance
 * @param eventSetup constant pointer to EventSetup instance
 * @param streamId integer identifier of the stream
 * @param path constant vector of string representing module paths
 */
...
/**
 * @brief Process one asynchronous event from the stream schedule.
 *
