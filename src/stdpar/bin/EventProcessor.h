 ...
 *
 * This class provides functionality for running event processing to completion,
 * managing plugins, product registries, sources, event setups, and stream schedules.
