...
namespace edm {
/**
 * @brief The Source class represents a data source that generates events for processing.
 *
 * It provides methods to control event production, such as starting processing and producing events,
 * while also tracking the number of events produced and providing access to various event-related data.
