...
/**
 * @class FEDRawDataCollection
 * @brief A collection of raw data for multiple Front End Devices (FEDs)
 *
 * This class manages a set of raw data associated with different FEDs,
 * providing methods to access and manipulate this data.
