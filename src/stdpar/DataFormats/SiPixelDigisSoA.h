 ...
 * @brief Structure of Array class representing silicon pixel digis
 * @details This class provides a container for storing and accessing silicon pixel digis data
 * @author Unknown
