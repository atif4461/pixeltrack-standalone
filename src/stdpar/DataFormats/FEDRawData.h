 ...
 *
 * This class provides a container for storing and manipulating raw data from a FED.
 * It includes methods for accessing and modifying the data, as well as resizing the data buffer.
