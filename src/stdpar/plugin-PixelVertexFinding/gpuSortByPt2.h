...
/**
 * Brief description: Sorts vertices by Pt2 values
 *
 * Detailed description: This function sorts an array of vertices based on their corresponding Pt2 values.
 * It first fills the indexing array, then calculates the cumulative sum of Pt2 values,
 * and finally sorts the indices based on the calculated Pt2 values.
 *
 * Parameters:
