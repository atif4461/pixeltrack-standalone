 ...
 * It utilizes parallel execution and atomic operations to efficiently update the sorting indices.
 *
 * @param pdata Pointer to the vertex data structure
 * @param pws Pointer to the workspace structure containing auxiliary data
 
 
  * @class ZVertices
 * @brief Represents a collection of vertices with associated data
 *
 * This class encapsulates the data and functionality related to vertices, including their sorting and indexing.
 
 
 * @class WorkSpace
 * @brief Provides auxiliary data and storage for computational workflows
 *
 * This class serves as a container for intermediate results and indices used during computations, facilitating efficient data management and reuse.
