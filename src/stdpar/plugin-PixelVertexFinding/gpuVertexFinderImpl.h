 ...
 *
 * Loads tracks from input pointer into output SoA structure
 * 
 * @param[in] ptracks Input pointer to tracks
 * @param[out] soa Output SoA structure
 * @param[in,out] pws Workspace object
...
/**
 * Produces vertices asynchronously from track data stored in a Structure Of Arrays format.
 *
 * @param tksoa pointer to the input track data in SoA format
