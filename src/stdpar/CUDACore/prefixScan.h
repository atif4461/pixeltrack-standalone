 ...
 *
 * This function calculates the cumulative sum of elements in a array
 * up to the current index and stores the result back into the array.
 *
 * @param ci input array
 * @param co output array
 * @param i index of the element being processed
 * @param mask synchronization mask for threads in the warp
 ...
 * and a pointer to a block counter as inputs. It performs a prefix scan
