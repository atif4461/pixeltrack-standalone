 ...
 * @brief Provides a structured view of 2D tracking rec hits in SOA format
 *
 * This class offers an interface to access various properties of 2D tracking rec hits,
