 ...
 * @brief Provides a structured view of 2D tracking rec hits in an SOA layout.
 *
 * This class offers a range of methods to access various properties of the tracking rec hits,
 * including local and global coordinates, cluster properties, and associated data structures.
