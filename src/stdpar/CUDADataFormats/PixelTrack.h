...
/**
 * @class TrackSoAT
 * @brief Structure of array representation for track data
 * @details This class provides a structure of arrays for storing track data,
 *          including quality, chi2, trajectory states, and hit indices.
 * @note The class uses various types such as Quality, hindex_type, and HitContainer
 *       to represent different aspects of track data.
