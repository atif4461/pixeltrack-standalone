 ...
 * @brief Represents a collection of silicon pixel clusters.
 *
 * This class provides an interface for managing and accessing silicon pixel cluster data.
 * It includes methods for setting and retrieving the number of clusters, as well as accessing various data arrays related to the clusters.
