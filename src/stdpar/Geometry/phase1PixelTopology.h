...
/**
 * Helper function to convert a mapping function to an array
 * @param f Function to apply to each index
 * @return Array containing results of applying function to each index
...
/**
 * Calculates the maximum stride between modules in a layer.
 *
 * This function iteratively checks for the largest power of 2 that divides all layer starts,
 * returning the largest such value as the maximum module stride.
 *
 * @return The maximum stride between modules in a layer.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Finds the layer corresponding to a given detector ID
 *
 * This function iterates through the layer start indices to determine the layer
 * associated with a specific detector ID.
 *
 * @param detId The detector ID to find the layer for
 * @return The layer number corresponding to the detector ID
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Calculates the layer from a compact detector ID.
 *
 * @param detId The compact detector ID.
 * @return The calculated layer as an unsigned 8-bit integer.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Checks if layer indices are valid for all modules.
 *
 * @return True if all layer indices are valid, false otherwise.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Calculates the remainder of the division of py by 52.
 *
 * @param py input value
 * @return the remainder of py divided by 52
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Checks if pixel Y position corresponds to big pixel row
 *
 * @param py Y position of the pixel
 * @return true if pixel Y position is at big pixel row boundary
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Calculates the local X coordinate within a ROC
 *
 * @param px global X coordinate
...
/**
 * Calculates the local Y coordinate within a ROC
 *
 * @param py global Y coordinate
