 ...
 * Class containing functionality for handling a node in the waiting task list.
 * Each node represents a task waiting for the resource and contains pointers
 * to the task and its associated task group, as well as a pointer to the next node.
