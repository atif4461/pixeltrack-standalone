 ...
 * Constructor for WaitingTaskList, initializing the list with an optional initial size.
 * @param iInitialSize Initial size of the cache used to hold waiting tasks.
  
 * Adds a task to the waiting list, potentially spawning it if the resource is available.
 * @param iGroup Task group associated with the task.
 * @param iTask Task to be added to the waiting list.
 
 * Adds a task holder to the waiting list, potentially spawning it if the resource is available.
 * @param WaitingTaskHolder Task holder to be added to the waiting list.
 
 * Signals that the resource is now available, allowing waiting tasks to access it.
 * @param iPtr Exception pointer indicating whether an error occurred.
 
 * Resets access to the resource, causing newly added tasks to wait.
 ...
 * Creates a new node in the waiting list.
 * @param iGroup Task group associated with the task.
 * @param iTask Task to be added to the waiting list.
 * @return Newly created node.
  
 * Sets the next node in the linked list.
 * @param iNext Node to be set as the next node.
