 ...
 * If retrieval fails, it creates a new instance using the provided function and adds it to the storage.
 *
 * Parameters:
 ...
 *
 * This function attempts to retrieve a shared pointer from a pool or creates one if it does not exist
 * It takes two parameters a maker function and a clear function
 * The maker function is used to create a new object when none exists in the pool
 * The clear function is used to reset the state of the retrieved object
 *
 * @param iMakeFunc Function used to create a new object
 * @param iClearFunc Function used to clear the state of the retrieved object
 * @return A shared pointer to the retrieved or created object
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
  ...
  private:
/**
 * Generates a unique pointer from a raw pointer.
 *
 * @tparam T Type of object being managed
 * @param ptr Raw pointer to manage
 * @return Unique pointer managing the object
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
