 ...
 * @param assoc output multiplicities
...
/**
 * Verifies two multiplicity objects by comparing their offset values in parallel.
 *
...
/**
 * Brief description of function to perform counting operation
 *
 * Detailed description of function to perform counting operation
 * 
...
/**
 * @brief Fills bulk data in parallel using atomic pair counter and association.
 *
...
template <typename Assoc>
/**
 * @brief Verifies the bulk data integrity of an association object.
 *
 * This function checks for potential overflows and ensures that the size of the association
