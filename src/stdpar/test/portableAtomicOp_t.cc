 ...
 *
 * This function demonstrates the usage of parallel and sequential algorithms
 * for finding the minimum value in a large dataset generated using Poisson distribution.
 *
 * It measures the execution time of both parallel and sequential approaches
 * and verifies the correctness of the results by comparing them with the expected output.
 */ 
int main() {
