 ...
 * including Fast Fit, Circle Fit and Line Fit on generated hits.
 *
 * @return void
 
 
  * @brief Prepare broken line data from hits and initial fit results
 *
 * Prepares the necessary data for the broken line algorithm
 * using the input hits and initial fit results.
 *
 * @param hits Input hits matrix
 * @param fast_fit_results Initial fit results
 ...
 * @brief Perform fast fit on input hits
 *
 * Performs a fast fit on the input hits to obtain initial parameters.
 *
 * @param hits Input hits matrix
 * @param[out] fast_fit_results Output fit results
 *
 * @return void
 

 * @brief Perform circle fit on input hits
 *
 * Performs a circle fit on the input hits to obtain fitted parameters.
 *
 * @param hits Input hits matrix
 * @param hits_ge Input covariance matrix
 * @param fast_fit_results Initial fit results
 * @param B Magnetic field strength
 * @param data Prepared broken line data
 * @param[out] circle_fit_results Output fit results
 *
 * @return void
 

 * @brief Perform line fit on input hits
 *
 * Performs a line fit on the input hits to obtain fitted parameters.
 *
 * @param hits Input hits matrix
 * @param hits_ge Input covariance matrix
 * @param circle_fit_results Circle fit results
 * @param fast_fit_results Initial fit results
 * @param B Magnetic field strength
 * @param[out] line_fit_results Output fit results
 *
 * @return void
 */void testFit() {
