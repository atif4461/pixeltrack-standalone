 ...
 *
 * @param[in] hits matrix of hit coordinates
 * @param[in] fast_fit_results vector of initial fit parameters
 * @param[in] B curvature parameter
 * @param[out] data prepared broken line data structure
 
void prepareBrokenLineData();
...
void Fast_fit();
 * @brief Performs circle fit on hits
 *
 * @param[in] hits matrix of hit coordinates
 * @param[in] hits_ge matrix of hit covariance matrices
 * @param[in] fast_fit_results vector of initial fit parameters
 * @param[in] B curvature parameter
 * @param[in] data prepared broken line data structure
 * @param[out] circle_fit_results circle fit result structure
 
void BL_Circle_fit();
 * @brief Performs line fit on hits
 *
 * @param[in] hits matrix of hit coordinates
 * @param[in] hits_ge matrix of hit covariance matrices
 * @param[in] fast_fit_results vector of initial fit parameters
 * @param[in] B curvature parameter
 * @param[in] data prepared broken line data structure
 * @param[out] line_fit_results line fit result structure
 
void BL_Line_fit();
 * @brief Loads 2D covariance matrix from hits and covariance matrix
 *
 * @param[in] hits_ge matrix of hit covariance matrices
 * @param[out] hits_cov 2D covariance matrix
 
void loadCovariance2D();
 * @brief Performs circle fit on hits
 *
 * @param[in] hits matrix of hit coordinates
 ...
 * @param[in] B curvature parameter
 * @param[in] use_robust flag indicating robust fit
 * @return circle fit result structure
 
RfitCircle_fit Circle_fit();
 * @brief Performs line fit on hits
 *
 * @param[in] hits matrix of hit coordinates
 * @param[in] hits_ge matrix of hit covariance matrices
 * @param[in] circle_fit_results circle fit result structure
 * @param[in] fast_fit_results vector of initial fit parameters
 * @param[in] B curvature parameter
 * @param[in] use_robust flag indicating robust fit
 * @return line fit result structure
 
RfitLine_fit Line_fit();*/ 
void testFit() {
