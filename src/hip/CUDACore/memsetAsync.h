 ...
 * It uses the HIP runtime library to perform the operation asynchronously on the specified stream.
 *
 * @param ptr Device pointer to set.
 * @param value Value to set the pointer to.
