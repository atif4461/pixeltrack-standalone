 ...
 *
 * Detailed description: This function generates an error message including file and line number,
 *                           CUDA command, error message, and optional description.
 *                           It also provides the current stack trace and throws a runtime error.
 *
 * Parameters:
 *   file         - File where the error occurred
 *   line         - Line number in the file where the error occurred
 *   cmd          - CUDA command that caused the error
 *   error        - Error message returned by CUDA
 *   message      - Additional error message
 *   description - Optional additional description of the error
...
/**
 * @brief Checks the result of a HIP operation and aborts with an error message if it fails.
 *
