 ...
 *
 * This class provides functionality to launch kernels on a GPU.
 ...
 *
 * This class provides information about the type of a function.
 
class FunctionType {
  
};
 * @brief Class representing launch parameters.
 *
 * This class holds configuration data for launching a kernel.
 
class LaunchParameters {
  
};
 * @brief Class representing an argument tuple.
 *
 * This class represents a collection of arguments passed to a kernel.
 
class ArgumentTuple {
  
};
 * @brief Class representing a pointer setter.
 *
 * This class sets up pointers for kernel launch.
...
#if __cplusplus >= 201703L
/**
 * @brief Launches a cooperative kernel on a GPU.
 *
 * This function launches a cooperative kernel on a GPU with the specified configuration and arguments.
 *
 * @tparam F The type of the kernel function.
 * @tparam Args The types of the kernel arguments.
 * @param kernel A pointer to the kernel function.
