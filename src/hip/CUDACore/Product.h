...
namespace cms {
  namespace hip {
    ...
    template <typename T>
/**
 * @brief Class representing a product with additional data.
 *
 * This class inherits from ProductBase and adds a data member variable.
 * It provides constructors for creating products with different types of data.
 * The class also declares several special member functions,
 * including deleted copy constructor and assignment operator,
 * as well as defaulted move constructor and move assignment operator.
 *
 * @tparam T The type of data stored in the product.
