...
/**
 * Class Vector 
 * Brief description A dynamic array like class with a unsafe push back operation 
 * Detailed description This class provides an interface similar to stdvector but with added functionality 
 *               for handling memory reallocation during pushback operations 
...
*/ 
      ...
      template <class... Ts>
/**
 * Emplaces an element at the end of the container if space is available.
 *
