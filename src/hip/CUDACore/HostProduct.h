...
template <typename T>
/**
 * @brief Class representing a product stored on the host.
 *
 * Provides a wrapper around unique pointers to manage ownership and access to the product.
...
public:
  ...
  explicit HostProduct(cms::hip::host::unique_ptr<T>&& p) : hm_ptr(std::move(p)) {}
