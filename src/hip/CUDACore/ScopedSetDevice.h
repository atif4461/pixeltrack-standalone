...
namespace cms {
  namespace hip {
/**
 * @brief Class representing a scope-based setter for CUDA devices.
 *
 * This class provides a way to temporarily change the current CUDA device
 * within a specific scope, ensuring that the original device is restored
 * when the scope ends.
