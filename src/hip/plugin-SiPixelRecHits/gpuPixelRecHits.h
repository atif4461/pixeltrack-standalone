...
/**
 * @brief Function to calculate hits for pixel clusters
 *
 * This function takes parameters such as pixelCPEforGPU, BeamSpotPOD, SiPixelDigisCUDA, 
 * SiPixelClustersCUDA, and TrackingRecHit2DSOAView, and calculates hits for pixel clusters.
 *
 * @param cpeParams Parameters for pixel CPE
 * @param bs Beam spot parameters
 * @param pdigis Pixel digis
 * @param numElements Number of elements
 * @param pclusters Pixel clusters
 * @param phits Hits for tracking rec
  
 * @class pixelCPEforGPU
 * @brief Class for pixel CPE on GPU
  
 * @class BeamSpotPOD
 * @brief Class for beam spot parameters
  
 * @class SiPixelDigisCUDA
 * @brief Class for silicon pixel digis on CUDA
  
 * @class SiPixelClustersCUDA
 * @brief Class for silicon pixel clusters on CUDA
  
 * @class TrackingRecHit2DSOAView
 * @brief Class for tracking rec hit 2D SOA view
  
 * @struct ClusParams
 * @brief Struct for cluster parameters
  
 * @var InvId
 * @brief Invalid ID
  
 * @var MaxHitsInIter
 * @brief Maximum hits in iteration
  
 * @var MaxNumModules
 * @brief Maximum number of modules
  
 * @var pixmx
 * @brief Pixel maximum value
