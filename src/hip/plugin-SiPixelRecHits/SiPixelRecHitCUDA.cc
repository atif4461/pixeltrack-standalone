...
/**
 * Constructor initializing the object with necessary product registry dependencies
 */ 
 ...
 * @param es the event setup providing access to the detector configuration
 */ 
