 ...
 * Parameters:
 *   prod A unique pointer to the product being added
 * Returns:
 *   None
 * Throws:
 *   std::runtime_error if a product of the same type already exists
...
*/ 
    ...
    template <typename T>
/**
 * Returns a constant reference to the product of type T.
 *
