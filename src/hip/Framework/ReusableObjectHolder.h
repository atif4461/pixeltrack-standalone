 ...
 * and clears a shared pointer
 *
 * @param iMakeFunc function to create unique object
 * @param iClearFunc function to clear the created object
 * @return shared pointer to the created or retrieved object
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * @param ptr Raw pointer to be converted to a unique pointer.
 * @return A unique pointer managing the object pointed to by ptr.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
