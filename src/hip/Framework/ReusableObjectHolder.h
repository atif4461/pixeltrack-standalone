...
*/ 
    ...
    template <typename F>
/**
 * Brief description of makeOrGet function
 *
 * Detailed description of makeOrGet function which creates or retrieves 
 * a shared pointer to an object of type T using the provided function iFunc
 *
 * @param iFunc input function used to create unique object
 * @return shared pointer to object of type T
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * It takes two parameters iMakeFunc and iClearFunc which are used for making unique instances and clearing them respectively
 * The function returns a shared pointer to the retrieved or created instance
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
