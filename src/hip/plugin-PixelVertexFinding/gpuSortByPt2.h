 ...
 * It uses a combination of parallel and synchronous operations to achieve high performance.
 *
 * @param pdata Pointer to the vertex data structure.
 * @param pws Pointer to the workspace structure containing necessary indices and temporary storage.
