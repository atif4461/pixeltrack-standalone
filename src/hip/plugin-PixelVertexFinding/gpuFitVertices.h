 ...
 * computes the best fit vertex for each point. It also calculates the chi-squared
 * value for each vertex and rejects outliers based on a maximum allowed chi-squared value.
 *
 * Parameters:
 *   pdata - pointer to the input data structure containing the points and their weights
...
/**
 * Brief description of function fitVerticesKernel 
 * Detailed description of function fitVerticesKernel 
 * Parameters:
 *   pdata 
 *   pws 
 *   chi2Max 
