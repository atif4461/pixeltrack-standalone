 ...
 *
 * This function splits vertices into two intermediate vertices based on track association.
 * It iterates over all vertices, checks if a vertex has at least 4 tracks associated with it,
 * and if the chi-squared value of the vertex is greater than a certain threshold.
 * If these conditions are met, it performs an iterative process to assign tracks to either of the two new vertices.
 *
