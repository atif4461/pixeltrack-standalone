 ...
 *   eps - maximum absolute distance to consider points as part of the same cluster
 *   errmax - maximum error allowed for points to be considered as seeds
 *   chi2max - maximum normalized distance for points to be included in a cluster
