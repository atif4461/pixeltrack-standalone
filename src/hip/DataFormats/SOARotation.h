...
public:
  ...
  template <typename U>
/**
 * Constructor for SOARotation from TkRotation
 *
...
/**
 * Function to transform a tensor from local to global coordinates
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
 ...
 * This function transforms a tensor from global coordinates to local coordinates.
 * It takes a tensor in global coordinates and rotation matrix as input,
 * and outputs the corresponding tensor in local coordinates.
 *
 * Parameters:
 * ge - Input tensor in global coordinates
 * lxx - Output xx component of the tensor in local coordinates
 * lxy - Output xy component of the tensor in local coordinates
 * lyy - Output yy component of the tensor in local coordinates
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
