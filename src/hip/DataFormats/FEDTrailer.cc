...
/**
 * Sets the FED trailer with the given parameters.
 * @param[in] trailer  pointer to the trailer data
 * @param[in] lenght   length of the event
 * @param[in] crc     cyclic redundancy check value
 * @param[in] evtStatus event status
 * @param[in] ttsBits  TTS bits
 * @param[in] moreTrailers flag indicating whether there are more trailers
 */
