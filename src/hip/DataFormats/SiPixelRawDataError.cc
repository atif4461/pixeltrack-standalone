 ...
 * @param fedId Front End Driver ID associated with error
 */
...
/**
 * Constructor initializing error data with 64bit error word, type and FED ID
 * @param errorWord64 64 bit error word value
 * @param errorType Type of error occurred
 * @param fedId Front End Driver ID associated with error
 */
// The above comment was written by an LLM. 
