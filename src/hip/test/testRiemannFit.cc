...
void testFit();
 * @brief Fills hits and hits covariance matrix
 *
 ...
 * @brief Prepares broken line data for fits
 *
 * @param[in] hits matrix of hits
 * @param[in] fast_fit_results vector of fast fit results
 ...
 * @brief Performs fast fit
 *
 * @param[in] hits matrix of hits
 * @param[out] fast_fit_results vector of fast fit results
 
void Fast_fit(const Rfit::Matrix3xNd<N>& hits, Vector4d& fast_fit_results);
 * @brief Performs circle fit
 *
 * @param[in] hits matrix of hits
 ...
 * @param[out] circle_fit_results structure containing circle fit results
 ...
 * @param[in] B curvature parameter
 * @param[in] data prepared broken line data
 * @param[out] line_fit_results structure containing line fit results
 ...
 * @param[in] fast_fit_results vector of fast fit results
 * @param[in] rad radii of hits
 * @param[in] B curvature parameter
 * @param[in] use_fast_start whether to use fast fit as starting point
 * @param[out] circle_fit_results structure containing circle fit results
 
Rfit::circle_fit Circle_fit(const Rfit::Matrix2Nd<N>& hits, const Rfit::Matrix2Nd<N>& hits_cov, const Vector4d& fast_fit_results, const Rfit::VectorNd<N>& rad, double B, bool use_fast_start);
 * @brief Performs line fit
 *
 * @param[in] hits matrix of hits
 * @param[in] hits_ge matrix of hits covariance
 * @param[in] circle_fit_results structure containing circle fit results
 * @param[in] fast_fit_results vector of fast fit results
 * @param[in] B curvature parameter
 * @param[in] use_fast_start whether to use fast fit as starting point
 * @param[out] line_fit_results structure containing line fit results
 
Rfit::line_fit Line_fit(const Rfit::Matrix3xNd<N>& hits, const Rfit::Matrix6xNf<N>& hits_ge, const Rfit::circle_fit& circle_fit_results, const Vector4d& fast_fit_results, double B, bool use_fast_start);*/ 
void testFit() {
