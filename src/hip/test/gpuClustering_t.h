...
```cpp * @brief The main function where the program starts execution
 *
 * @param void
 * @return int 
...
void countModules(h_id, h_moduleStart, h_clus, n)
...
void findClus(h_id, h_x, h_y, h_moduleStart, h_clusInModule, h_moduleId, h_clus, n)
 * @brief Function to apply charge cut
 *
 * @param h_id
 * @param h_adc
 * @param h_moduleStart
...
void clusterChargeCut(h_id, h_adc, h_moduleStart, h_clusInModule, h_moduleId, h_clus, n)
