...
/**
 * @brief Class representing an association between two entities.
 
class Assoc

 * @brief Class representing a small association between two entities.
 
class SmallAssoc

 * @brief Class representing a multiplicity counter.
 
class Multiplicity

 * @brief Class representing an atomic pair counter.
 
class AtomicPairCounter

 * @brief Class representing a cabling wrapper.
