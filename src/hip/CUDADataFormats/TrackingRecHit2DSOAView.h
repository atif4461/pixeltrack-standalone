 ...
 * @brief Provides a view of 2D tracking rec hits with SoA storage
 *
 * This class provides an interface to access and manipulate 2D tracking rec hits stored in SoA format.
 * It offers various methods to retrieve hit properties such as local and global coordinates,
 * cluster sizes, charges, and detector indices.
...
public:
  ...
  using Hist = cms::hip::HistoContainer<int16_t, 128, gpuClustering::MaxNumClusters, 8 * sizeof(int16_t), uint16_t, 10>;
