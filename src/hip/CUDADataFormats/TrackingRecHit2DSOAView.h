 ...
 *
 * This class provides an interface to access 2D tracking rec hit data stored in SoA format.
 * It offers various methods to retrieve local and global coordinates, errors, and other properties of the hits.
