...
template <typename T, typename Traits>
/**
 * Returns a host unique pointer to the data asynchronously.
 *
 * @param stream The HIP stream to perform the operation on.
 * @return A host unique pointer to the data.
