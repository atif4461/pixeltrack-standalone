...
/**
 * @class TrackSoAT
 * @brief Structure of Arrays implementation for tracking data
 * @details This class represents a collection of tracking data, including quality, 
 *          chi-squared values, trajectory states, and hit indices.
...
public:
  ...
  using HitContainer = cms::hip::OneToManyAssoc<hindex_type, S, 5 * S>;
