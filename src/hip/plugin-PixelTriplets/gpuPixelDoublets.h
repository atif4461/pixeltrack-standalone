...
/**
 * Initializes the doubles data structures for GPU-based cellular automaton tracking algorithm.
 *
 ...
 * @param[in] isOuterHitOfCell outer hits of cells
 * @param[in] nActualPairs actual number of pairs
 * @param[in] ideal_cond flag for ideal condition
 * @param[in] doClusterCut flag for cluster cut
 * @param[in] doZ0Cut flag for z0 cut
 * @param[in] doPtCut flag for pt cut
