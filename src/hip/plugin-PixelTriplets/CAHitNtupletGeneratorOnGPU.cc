 ...
 * Initializes member variables and allocates memory for counters.
...
// The following comment is generated by an LLM. 
/**
 * Destructor for the class, releases allocated resources on GPU or CPU depending on configuration,
 * and prints statistics counters if enabled.*/ 
