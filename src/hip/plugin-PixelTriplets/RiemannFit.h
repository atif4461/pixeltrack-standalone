 ...
 *
 * @param length_values input array of length values
 * @param rad_lengths output array of computed radiation lengths
 ...
 * @param theta Constant value of theta.
 * @param B Constant value of B.
 ...
 *
 * @param p2D Input 2xN matrix containing partial derivatives.
 ...
 *
 * @param p2D 2xN matrix containing the coordinates of the two points defining the line segment
 ...
 * the result of a fast fit algorithm, which includes circle and line fits.
 *
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
*/
  template <typename M2xN, typename V4, int N>
/**
 * @brief Brief description of the circle fit function
 *
 * The circle_fit function performs a circle fit on a set of 2D points with associated covariance matrices.
 * It computes the circle parameters, charge, and covariance matrix of the fitted circle.
 *
 * @param hits2D Input 2D points
 * @param hits_cov2D Input covariance matrices of the 2D points
 * @param fast_fit Initial estimate of the circle parameters
 * @param rad Radius of the circle
 * @param B Magnetic field strength
 * @param error Flag to activate error propagation
 * @return Fitted circle parameters, charge, and covariance matrix
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief This function performs a line fit on a set of 3D points.
 *
 * @param hits A 3xN matrix containing the 3D coordinates of the points.
 * @param hits_ge A 6xN matrix containing the covariance matrices of the points.
 * @param circle A circle fit object containing information about the fitted circle.
 * @param fast_fit A vector of length 4 containing fast fit parameters.
 * @param B The magnetic field strength.
 * @param error A boolean flag indicating whether to compute errors or not.
 *
 ...
 *
 * This class encapsulates the results of a helical track fit, including parameters,
 * covariance matrix, and chi-squared values for both circle and line fits.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
