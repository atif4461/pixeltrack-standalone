 ...
 * It uses the Rfit library to perform the actual fitting.
 *
 ...
 * @param offset Offset into the arrays.
...
template <int N>
/**
 * Kernel function to perform circle fit on a set of hits
 *
