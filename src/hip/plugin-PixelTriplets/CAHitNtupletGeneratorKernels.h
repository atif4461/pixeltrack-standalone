...
namespace cAHitNtupletGenerator {
  ...
  struct Params {
/**
 * Constructor for configuration parameters
 * 
 ...
 * @param CAThetaCutBarrel       cat theta cut for barrel region
 * @param CAThetaCutForward     cat theta cut for forward region
...
public:
  ...
  void launchKernels(HitsOnCPU const& hh, TkSoA* tuples_d, hipStream_t cudaStream);

  void classifyTuples(HitsOnCPU const& hh, TkSoA* tuples_d, hipStream_t cudaStream);

  void fillHitDetIndices(HitsView const* hv, TkSoA* tuples_d, hipStream_t cudaStream);

  void buildDoublets(HitsOnCPU const& hh, hipStream_t stream);
  void allocateOnGPU(hipStream_t stream);
  void cleanup(hipStream_t cudaStream);
