 ...
 * @param cellNeighbors Neighbor cells
 * @param cellTracks Tracks associated with cells
 * @param hh Histogram object
 * @param isOuterHitOfCell Outer hits of cells
 ...
 * @param maxr Maximum radius for each layer pair
 * @param ideal_cond Ideal condition flag
