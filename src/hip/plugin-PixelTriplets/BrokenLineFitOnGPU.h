 ...
 * output SoA, hits, and fit parameters, and produces results such as state at BS,
 * transverse momentum, eta, and chi2 values.
 *
 ...
 * @param pfast_fit Fast fit parameters array
 * @param nHits Number of hits
 * @param offset Offset value
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
