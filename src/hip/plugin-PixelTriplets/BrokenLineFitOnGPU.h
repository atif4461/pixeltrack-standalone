 ...
 *
 * This function performs a fast fit operation on a set of hits using the BrokenLine algorithm.
 *
 ...
 * @param phits  Array to store the hit positions
 * @param phits_ge  Array to store the global error estimates
 ...
 *
 * This function performs a broken line fit on a set of hits and calculates various parameters such as state at BS, pt, eta, and chi2.
 *
 * @param tupleMultiplicity Tuple multiplicity array
 * @param B Magnetic field strength
 * @param results Output SoA containing the calculated parameters
