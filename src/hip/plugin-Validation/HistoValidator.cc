 ...
 * @param[in,out] waitingTaskHolder the waiting task holder with arena
 ...
 * @brief Finalize job execution
 * @details Writes histogram elements to histograms_cuda.txt file
